...
In addition to local testing on macOS and Windows, these E2E tests are automatically executed on Windows and Linux via GitHub Actions. Please refer to [CONTRIBUTING.md](CONTRIBUTING.md) for details on supported versions and the workflow.
