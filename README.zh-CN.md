...
- **Object History (对象历史)**: **(新功能!)** 右键单击对象即可查看其版本历史记录（网格更改、移动），并通过 Ghost 叠加即时预览过去的状态。
...
11. **Object History (对象历史)**:
    ...
    * 弹出窗口将列出所有检测到的更改：**Created** (创建)、**Moved** (移动)、**Minor** (微小/形状更改) 或 **Major** (主要/顶点数更改)。
    * **点击条目** 以将该特定版本的 Ghost Reference (幽灵参考) 叠加在当前视图中。
