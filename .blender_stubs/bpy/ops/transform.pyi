...
def shear(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, value: float = ..., orient_axis: str = ..., orient_axis_ortho: str = ..., orient_type: str = ..., orient_matrix: float = ..., orient_matrix_type: str = ..., mirror: bool = ..., use_proportional_edit: bool = ..., proportional_edit_falloff: str = ..., proportional_size: float = ..., use_proportional_connected: bool = ..., use_proportional_projected: bool = ..., snap: bool = ..., gpencil_strokes: bool = ..., release_confirm: bool = ..., use_accurate: bool = ...) -> Set[str]:
...
def vert_slide(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, value: float = ..., use_even: bool = ..., flipped: bool = ..., use_clamp: bool = ..., mirror: bool = ..., snap: bool = ..., snap_elements: str = ..., use_snap_project: bool = ..., snap_target: str = ..., use_snap_self: bool = ..., use_snap_edit: bool = ..., use_snap_nonedit: bool = ..., use_snap_selectable: bool = ..., snap_point: float = ..., correct_uv: bool = ..., release_confirm: bool = ..., use_accurate: bool = ...) -> Set[str]:
