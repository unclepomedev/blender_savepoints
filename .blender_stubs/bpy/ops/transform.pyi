...
def vert_slide(override_context: Optional[Union[dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, value: float = ..., use_even: bool = ..., flipped: bool = ..., use_clamp: bool = ..., direction: list[float] = ..., mirror: bool = ..., snap: bool = ..., snap_elements: set[str] = ..., use_snap_project: bool = ..., snap_target: str = ..., use_snap_self: bool = ..., use_snap_edit: bool = ..., use_snap_nonedit: bool = ..., use_snap_selectable: bool = ..., snap_point: list[float] = ..., correct_uv: bool = ..., release_confirm: bool = ..., use_accurate: bool = ...) -> set[str]:
