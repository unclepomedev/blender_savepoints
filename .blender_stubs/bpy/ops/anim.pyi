...
def change_frame(override_context: Optional[Union[dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, frame: float = ..., snap: bool = ..., seq_solo_preview: bool = ..., pass_through_on_strip_handles: bool = ...) -> set[str]:
...
def channels_bake(override_context: Optional[Union[dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, use_scene_range: bool = ..., range: list[int] = ..., step: float = ..., remove_outside_range: bool = ..., interpolation_type: str = ..., bake_modifiers: bool = ...) -> set[str]:
