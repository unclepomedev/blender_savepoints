...
def bisect(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, plane_co: float = ..., plane_no: float = ..., use_fill: bool = ..., clear_inner: bool = ..., clear_outer: bool = ..., threshold: float = ..., xstart: int = ..., xend: int = ..., ystart: int = ..., yend: int = ..., flip: bool = ..., cursor: int = ...) -> Set[str]:
...
def dissolve_limited(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, angle_limit: float = ..., use_dissolve_boundaries: bool = ..., delimit: str = ...) -> Set[str]:
...
def extrude_repeat(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, steps: int = ..., offset: float = ..., scale_offset: float = ...) -> Set[str]:
...
def loopcut(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, number_cuts: int = ..., smoothness: float = ..., falloff: str = ..., object_index: int = ..., edge_index: int = ..., mesh_select_mode_init: bool = ...) -> Set[str]:
...
def point_normals(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, mode: str = ..., invert: bool = ..., align: bool = ..., target_location: float = ..., spherize: bool = ..., spherize_strength: float = ...) -> Set[str]:
...
def primitive_circle_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, vertices: int = ..., radius: float = ..., fill_type: str = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a circle mesh"""
    ...

def primitive_cone_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, vertices: int = ..., radius1: float = ..., radius2: float = ..., depth: float = ..., end_fill_type: str = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a conic mesh"""
    ...

def primitive_cube_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, size: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a cube mesh that consists of six square faces"""
    ...

def primitive_cube_add_gizmo(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ..., matrix: float = ...) -> Set[str]:
    """Construct a cube mesh"""
    ...

def primitive_cylinder_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, vertices: int = ..., radius: float = ..., depth: float = ..., end_fill_type: str = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a cylinder mesh"""
    ...

def primitive_grid_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, x_subdivisions: int = ..., y_subdivisions: int = ..., size: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a subdivided plane mesh"""
    ...

def primitive_ico_sphere_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, subdivisions: int = ..., radius: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a spherical mesh that consists of equally sized triangles"""
    ...

def primitive_monkey_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, size: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a Suzanne mesh"""
    ...

def primitive_plane_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, size: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Construct a filled planar mesh with 4 vertices"""
    ...

def primitive_torus_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, align: str = ..., location: float = ..., rotation: float = ..., major_segments: int = ..., minor_segments: int = ..., mode: str = ..., major_radius: float = ..., minor_radius: float = ..., abso_major_rad: float = ..., abso_minor_rad: float = ..., generate_uvs: bool = ...) -> Set[str]:
    """Construct a torus mesh"""
    ...

def primitive_uv_sphere_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, segments: int = ..., ring_count: int = ..., radius: float = ..., calc_uvs: bool = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def screw(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, steps: int = ..., turns: int = ..., center: float = ..., axis: float = ...) -> Set[str]:
...
def select_linked(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, delimit: str = ...) -> Set[str]:
    """Select all vertices connected to the current selection"""
    ...

def select_linked_pick(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, deselect: bool = ..., delimit: str = ..., object_index: int = ..., index: int = ...) -> Set[str]:
...
def select_mirror(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, axis: str = ..., extend: bool = ...) -> Set[str]:
...
def sort_elements(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., elements: str = ..., reverse: bool = ..., seed: int = ...) -> Set[str]:
    """The order of selected vertices/edges/faces is modified, based on a given method"""
    ...

def spin(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, steps: int = ..., dupli: bool = ..., angle: float = ..., use_auto_merge: bool = ..., use_normal_flip: bool = ..., center: float = ..., axis: float = ...) -> Set[str]:
