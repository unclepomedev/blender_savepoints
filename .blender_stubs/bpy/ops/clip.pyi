...
def add_marker(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: float = ...) -> Set[str]:
...
def dopesheet_select_channel(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: float = ..., extend: bool = ...) -> Set[str]:
...
def graph_select(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: float = ..., extend: bool = ...) -> Set[str]:
    """Select graph curves"""
    ...
...
def select(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, extend: bool = ..., deselect_all: bool = ..., location: float = ...) -> Set[str]:
...
def slide_marker(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, offset: float = ...) -> Set[str]:
    """Slide marker areas"""
    ...
