...
def add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, radius: float = ..., type: str = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def add_named(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, linked: bool = ..., name: str = ..., session_uid: int = ..., matrix: float = ..., drop_x: int = ..., drop_y: int = ...) -> Set[str]:
    """Add named object"""
    ...

def align(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, bb_quality: bool = ..., align_mode: str = ..., relative_to: str = ..., align_axis: str = ...) -> Set[str]:
    """Align objects"""
    ...
...
def armature_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def camera_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def collection_external_asset_drop(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, session_uid: int = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ..., use_instance: bool = ..., drop_x: int = ..., drop_y: int = ..., collection: str = ...) -> Set[str]:
    """Add the dragged collection to the scene"""
    ...

def collection_instance_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, name: str = ..., collection: str = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ..., session_uid: int = ..., drop_x: int = ..., drop_y: int = ...) -> Set[str]:
...
def curves_empty_hair_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add an empty curve object to the scene with the selected mesh as surface"""
    ...

def curves_random_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add a curves object with random curves to the scene"""
    ...

def data_instance_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, name: str = ..., session_uid: int = ..., type: str = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ..., drop_x: int = ..., drop_y: int = ...) -> Set[str]:
...
def effector_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add an empty object with a physics effector to the scene"""
    ...

def empty_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., radius: float = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add an empty object to the scene"""
    ...

def empty_image_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, filepath: str = ..., hide_props_region: bool = ..., check_existing: bool = ..., filter_blender: bool = ..., filter_backup: bool = ..., filter_image: bool = ..., filter_movie: bool = ..., filter_python: bool = ..., filter_font: bool = ..., filter_sound: bool = ..., filter_text: bool = ..., filter_archive: bool = ..., filter_btx: bool = ..., filter_alembic: bool = ..., filter_usd: bool = ..., filter_obj: bool = ..., filter_volume: bool = ..., filter_folder: bool = ..., filter_blenlib: bool = ..., filemode: int = ..., relative_path: bool = ..., show_multiview: bool = ..., use_multiview: bool = ..., display_type: str = ..., sort_method: str = ..., name: str = ..., session_uid: int = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ..., background: bool = ...) -> Set[str]:
...
def lattice_add_to_selected(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, fit_to_selected: bool = ..., radius: float = ..., margin: float = ..., add_modifiers: bool = ..., resolution_u: int = ..., resolution_v: int = ..., resolution_w: int = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add a lattice and use it to deform selected objects"""
    ...

def light_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., radius: float = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def lightprobe_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def metaball_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def mode_set_with_submode(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, mode: str = ..., toggle: bool = ..., mesh_select_mode: str = ...) -> Set[str]:
    """Sets the object interaction mode"""
    ...
...
def pointcloud_random_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def randomize_transform(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, random_seed: int = ..., use_delta: bool = ..., use_loc: bool = ..., loc: float = ..., use_rot: bool = ..., rot: float = ..., use_scale: bool = ..., scale_even: bool = ..., scale: float = ...) -> Set[str]:
...
def speaker_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def text_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
...
def transform_apply(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: bool = ..., rotation: bool = ..., scale: bool = ..., properties: bool = ..., corrective_flip_normals: bool = ..., isolate_users: bool = ...) -> Set[str]:
...
def transform_to_mouse(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, name: str = ..., session_uid: int = ..., matrix: float = ..., drop_x: int = ..., drop_y: int = ...) -> Set[str]:
