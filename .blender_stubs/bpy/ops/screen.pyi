...
def area_join(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, source_xy: int = ..., target_xy: int = ...) -> Set[str]:
    """Join selected areas into new window"""
    ...

def area_move(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, x: int = ..., y: int = ..., delta: int = ..., snap: bool = ...) -> Set[str]:
...
def area_split(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, direction: str = ..., factor: float = ..., cursor: int = ...) -> Set[str]:
    """Split selected area into new windows"""
    ...

def area_swap(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, cursor: int = ...) -> Set[str]:
...
def quadview_size(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None) -> Set[str]:
