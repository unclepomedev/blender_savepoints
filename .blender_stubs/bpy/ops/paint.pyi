...
def add_texture_paint_slot(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, type: str = ..., slot_type: str = ..., name: str = ..., color: float = ..., width: int = ..., height: int = ..., alpha: bool = ..., generated_type: str = ..., float: bool = ..., domain: str = ..., data_type: str = ...) -> Set[str]:
    """Add a paint slot"""
    ...
...
def grab_clone(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, delta: float = ...) -> Set[str]:
...
def sample_color(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: int = ..., merged: bool = ..., palette: bool = ...) -> Set[str]:
...
def vert_select_loop(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, select: bool = ..., extend: bool = ...) -> Set[str]:
