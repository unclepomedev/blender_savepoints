...
def export_layout(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, filepath: str = ..., export_all: bool = ..., export_tiles: str = ..., modified: bool = ..., mode: str = ..., size: int = ..., opacity: float = ..., check_existing: bool = ...) -> Set[str]:
...
def randomize_uv_transform(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, random_seed: int = ..., use_loc: bool = ..., loc: float = ..., use_rot: bool = ..., rot: float = ..., use_scale: bool = ..., scale_even: bool = ..., scale: float = ...) -> Set[str]:
...
def rip(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, mirror: bool = ..., release_confirm: bool = ..., use_accurate: bool = ..., location: float = ...) -> Set[str]:
...
def select_edge_ring(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, extend: bool = ..., location: float = ...) -> Set[str]:
...
def select_linked_pick(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, extend: bool = ..., deselect: bool = ..., location: float = ...) -> Set[str]:
    """Select all UV vertices linked under the mouse"""
    ...

def select_loop(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, extend: bool = ..., location: float = ...) -> Set[str]:
...
def select_tile(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, extend: bool = ..., tile: int = ...) -> Set[str]:
