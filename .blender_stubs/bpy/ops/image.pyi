...
def new(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, name: str = ..., width: int = ..., height: int = ..., color: float = ..., alpha: bool = ..., generated_type: str = ..., float: bool = ..., use_stereo_3d: bool = ..., tiled: bool = ...) -> Set[str]:
    """Create a new image"""
    ...
...
def resize(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, size: int = ..., all_udims: bool = ...) -> Set[str]:
    """Resize the image"""
    ...
...
def tile_add(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, number: int = ..., count: int = ..., label: str = ..., fill: bool = ..., color: float = ..., generated_type: str = ..., width: int = ..., height: int = ..., float: bool = ..., alpha: bool = ...) -> Set[str]:
    """Adds a tile to the image"""
    ...

def tile_fill(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, color: float = ..., generated_type: str = ..., width: int = ..., height: int = ..., float: bool = ..., alpha: bool = ...) -> Set[str]:
...
def view_pan(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, offset: float = ...) -> Set[str]:
    """Pan the view"""
    ...
...
def view_zoom_in(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: float = ...) -> Set[str]:
    """Zoom in the image (centered around 2D cursor)"""
    ...

def view_zoom_out(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, location: float = ...) -> Set[str]:
