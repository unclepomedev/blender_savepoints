...
def add_bezier(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
    """Add new Bézier curve"""
    ...

def add_circle(override_context: Optional[Union[Dict, 'bpy.types.Context']] = None, execution_context: Optional[str] = None, undo: Optional[bool] = None, *, radius: float = ..., enter_editmode: bool = ..., align: str = ..., location: float = ..., rotation: float = ..., scale: float = ...) -> Set[str]:
