...
background = True
binary_path = '/Users/shunsuketsumori/Library/Application Support/blup/versions/5.1.0-alpha-05cfe524a2bf/Blender.app/Contents/MacOS/Blender'
build_branch: Any
build_cflags: Any
...
build_time: Any
build_type: Any
cachedir = '/Users/shunsuketsumori/Library/Caches/Blender/'
def count(value, /) -> Any:
    """
    Online Documentation:
    https://docs.blender.org/api/current/bpy.app.html
...
sdl: Any
tempdir = '/var/folders/zn/vrqg3hq9059c8w8ht1pmpycm0000gn/T/blender_8j3sn7/'
translations: Any
usd: Any
