...
https://docs.blender.org/api/current/bpy.types.NodeSocketCollection.html
"""
...
class NodeSocketCollection(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[Optional['Collection'], "is_animatable=False"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[Optional['Collection'], "is_animatable=False"]) -> None:
        ...
