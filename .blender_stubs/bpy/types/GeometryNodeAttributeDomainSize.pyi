...
class GeometryNodeAttributeDomainSize(GeometryNode):
    ...
    @property
    def component(self) -> Annotated[Literal['MESH', 'POINTCLOUD', 'CURVE', 'INSTANCES', 'GREASEPENCIL'], "is_animatable=False"]:

        ...
    @component.setter
    def component(self, value: Annotated[Literal['MESH', 'POINTCLOUD', 'CURVE', 'INSTANCES', 'GREASEPENCIL'], "is_animatable=False"]) -> None:
        ...
