...
https://docs.blender.org/api/current/bpy.types.GeometryNodeAttributeDomainSize.html
"""
...
class GeometryNodeAttributeDomainSize(GeometryNode):
    ...
    component: Annotated[Literal['MESH', 'POINTCLOUD', 'CURVE', 'INSTANCES', 'GREASEPENCIL'], "is_animatable=False"]
