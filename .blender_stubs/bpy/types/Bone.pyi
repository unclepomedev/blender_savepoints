...
class Bone(bpy_struct, _GenericBone):
    ...
    def bbone_custom_handle_start(self, value: Annotated[Optional['Bone'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bbone_custom_handle_end(self, value: Annotated[Optional['Bone'], "is_animatable=False"]) -> None:
        ...
    @property
