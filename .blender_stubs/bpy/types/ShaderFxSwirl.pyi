...
class ShaderFxSwirl(ShaderFx):
    ...
    def radius(self) -> Annotated[int, "subtype='PIXEL'", "step=1"]:
        ...
        ...
    @radius.setter
    def radius(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    def angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=5.0", "precision=2"]:
        ...
        ...
    @angle.setter
    def angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=5.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def use_transparent(self, value: bool) -> None:
        ...
    @property
