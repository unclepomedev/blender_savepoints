...
class FollowPathConstraint(Constraint):
    ...
    def offset(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def offset_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.009999999776482582", "precision=3"]) -> None:
        ...
    @property
    def forward_axis(self) -> Literal['FORWARD_X', 'FORWARD_Y', 'FORWARD_Z', 'TRACK_NEGATIVE_X', 'TRACK_NEGATIVE_Y', 'TRACK_NEGATIVE_Z']:
        ...
        ...
    @forward_axis.setter
    def forward_axis(self, value: Literal['FORWARD_X', 'FORWARD_Y', 'FORWARD_Z', 'TRACK_NEGATIVE_X', 'TRACK_NEGATIVE_Y', 'TRACK_NEGATIVE_Z']) -> None:
        ...
    @property
    ...
    def use_curve_follow(self, value: bool) -> None:
        ...
    @property
    ...
    def use_fixed_location(self, value: bool) -> None:
        ...
    @property
