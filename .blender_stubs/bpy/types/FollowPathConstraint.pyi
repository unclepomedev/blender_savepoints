...
class FollowPathConstraint(Constraint):
    ...
    """Target Curve object"""
    offset: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]
    """Offset from the position corresponding to the time frame"""
    offset_factor: Annotated[float, "subtype='FACTOR'", "step=0.009999999776482582", "precision=3"]
    """Percentage value defining target position along length of curve"""
    forward_axis: Literal['FORWARD_X', 'FORWARD_Y', 'FORWARD_Z', 'TRACK_NEGATIVE_X', 'TRACK_NEGATIVE_Y', 'TRACK_NEGATIVE_Z']
    """Axis that points forward along the path"""
    up_axis: Literal['UP_X', 'UP_Y', 'UP_Z']
