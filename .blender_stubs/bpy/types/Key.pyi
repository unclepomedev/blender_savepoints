...
class Key(ID):
    ...
    def preview(self) -> Annotated[Optional['ImagePreview'], "is_animatable=False"]:
        ...
        ...
    @property
    def reference_key(self) -> Annotated['ShapeKey', "is_animatable=False"]:

        ...
    @property
    def key_blocks(self) -> Annotated[bpy_prop_collection['ShapeKey'], "is_animatable=False"]:
        """Shape keys"""
        ...
    @property
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    @property
    def user(self) -> Annotated['ID', "is_animatable=False"]:
    ...
    def use_relative(self) -> bool:
        ...
        ...
    @use_relative.setter
    def use_relative(self, value: bool) -> None:
        ...
    @property
