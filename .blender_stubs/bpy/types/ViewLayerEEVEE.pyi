...
class ViewLayerEEVEE(bpy_struct):
    ...
    def use_pass_volume_direct(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_bloom(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_transparent(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def ambient_occlusion_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...