...
class SpeedControlStrip(EffectStrip):
    ...
    speed_control: Annotated[Literal['STRETCH', 'MULTIPLY', 'FRAME_NUMBER', 'LENGTH'], "is_animatable=False"]
    """Speed control method"""
    speed_factor: Annotated[float, "step=10.0", "precision=3"]
    """Multiply the current speed of the strip with this number or remap current frame to this frame"""
    speed_frame_number: Annotated[float, "step=1.0", "precision=-1"]
    """Frame number of input strip"""
    speed_length: Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=-1"]
