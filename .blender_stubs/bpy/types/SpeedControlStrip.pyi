...
https://docs.blender.org/api/current/bpy.types.SpeedControlStrip.html
"""
...
class SpeedControlStrip(EffectStrip):
    ...
    def input_1(self) -> Annotated['Strip', "is_animatable=False"]:
        ...
        ...
    @input_1.setter
    def input_1(self, value: Annotated['Strip', "is_animatable=False"]) -> None:
        ...
    @property
    def speed_control(self) -> Annotated[Literal['STRETCH', 'MULTIPLY', 'FRAME_NUMBER', 'LENGTH'], "is_animatable=False"]:
        """Speed control method"""
        ...
    @speed_control.setter
    def speed_control(self, value: Annotated[Literal['STRETCH', 'MULTIPLY', 'FRAME_NUMBER', 'LENGTH'], "is_animatable=False"]) -> None:
        ...
    @property
    def speed_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Multiply the current speed of the strip with this number or remap current frame to this frame"""
        ...
    @speed_factor.setter
    def speed_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def speed_frame_number(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        """Frame number of input strip"""
        ...
    @speed_frame_number.setter
    def speed_frame_number(self, value: Annotated[float, "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def speed_length(self) -> Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=-1"]:
        """Percentage of input strip length"""
        ...
    @speed_length.setter
    def speed_length(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def use_frame_interpolate(self) -> bool:
        """Do crossfade blending between current and next frame"""
        ...
    @use_frame_interpolate.setter
    def use_frame_interpolate(self, value: bool) -> None:
        ...
