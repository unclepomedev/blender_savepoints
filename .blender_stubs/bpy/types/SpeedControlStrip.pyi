...
class SpeedControlStrip(EffectStrip):
    ...
    def speed_control(self, value: Annotated[Literal['STRETCH', 'MULTIPLY', 'FRAME_NUMBER', 'LENGTH'], "is_animatable=False"]):
        ...
    @property
    def speed_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @speed_factor.setter
    def speed_factor(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def speed_frame_number(self, value: Annotated[float, "step=1.0", "precision=-1"]):
        ...
    @property
    def speed_length(self) -> Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=-1"]:
        ...
        ...
    @speed_length.setter
    def speed_length(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=-1"]):
        ...
    @property
    ...
    def use_frame_interpolate(self, value: bool):
        ...
