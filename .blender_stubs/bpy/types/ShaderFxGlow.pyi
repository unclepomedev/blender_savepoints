...
class ShaderFxGlow(ShaderFx):
    ...
    def glow_color(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @glow_color.setter
    def glow_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def select_color(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @select_color.setter
    def select_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def mode(self) -> Literal['LUMINANCE', 'COLOR']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['LUMINANCE', 'COLOR']):
        ...
    @property
    def threshold(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @threshold.setter
    def threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def use_glow_under(self, value: bool):
        ...
    @property
    ...
    def blend_mode(self) -> Literal['REGULAR', 'ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE']:
        ...
        ...
    @blend_mode.setter
    def blend_mode(self, value: Literal['REGULAR', 'ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE']):
        ...