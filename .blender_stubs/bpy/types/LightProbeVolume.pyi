...
class LightProbeVolume(LightProbe):
    ...
    def resolution_x(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @resolution_x.setter
    def resolution_x(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def resolution_y(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @resolution_y.setter
    def resolution_y(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def resolution_z(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @resolution_z.setter
    def resolution_z(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def capture_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=1"]):
        ...
    @property
    def normal_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]:
        ...
        ...
    @normal_bias.setter
    def normal_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    def view_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]:
        ...
        ...
    @view_bias.setter
    def view_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    def facing_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]:
        ...
        ...
    @facing_bias.setter
    def facing_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    def bake_samples(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @bake_samples.setter
    def bake_samples(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def surface_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @surface_bias.setter
    def surface_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def escape_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @escape_bias.setter
    def escape_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def surfel_density(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def validity_threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def dilation_threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def dilation_radius(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def capture_world(self, value: bool):
        ...
    @property
    ...
    def capture_indirect(self, value: bool):
        ...
    @property
    ...
    def capture_emission(self, value: bool):
        ...
    @property
    def clamp_direct(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @clamp_direct.setter
    def clamp_direct(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def clamp_indirect(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
