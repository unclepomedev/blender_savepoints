...
class LimitRotationConstraint(Constraint):
    ...
    def use_limit_x(self) -> bool:
        ...
        ...
    @use_limit_x.setter
    def use_limit_x(self, value: bool) -> None:
        ...
    @property
    def use_limit_y(self) -> bool:
        ...
        ...
    @use_limit_y.setter
    def use_limit_y(self, value: bool) -> None:
        ...
    @property
    def use_limit_z(self) -> bool:
        ...
        ...
    @use_limit_z.setter
    def use_limit_z(self, value: bool) -> None:
        ...
    @property
    def min_x(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @min_x.setter
    def min_x(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    def min_y(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @min_y.setter
    def min_y(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    def min_z(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @min_z.setter
    def min_z(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    def max_x(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @max_x.setter
    def max_x(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    def max_y(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @max_y.setter
    def max_y(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    def max_z(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @max_z.setter
    def max_z(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    ...
    def use_legacy_behavior(self, value: bool) -> None:
        ...