...
class CompositorNodeDefocus(CompositorNode):
    ...
    def bokeh(self) -> Literal['OCTAGON', 'HEPTAGON', 'HEXAGON', 'PENTAGON', 'SQUARE', 'TRIANGLE', 'CIRCLE']:
        ...
        ...
    @bokeh.setter
    def bokeh(self, value: Literal['OCTAGON', 'HEPTAGON', 'HEXAGON', 'PENTAGON', 'SQUARE', 'TRIANGLE', 'CIRCLE']):
        ...
    @property
    ...
    def f_stop(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @f_stop.setter
    def f_stop(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def blur_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @blur_max.setter
    def blur_max(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def z_scale(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @z_scale.setter
    def z_scale(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
