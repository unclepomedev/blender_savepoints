...
class CompositorNodeDefocus(CompositorNode):
    ...
    def scene(self, value: Annotated[Optional['Scene'], "is_animatable=False"]) -> None:
        ...
    @property
    def bokeh(self) -> Literal['OCTAGON', 'HEPTAGON', 'HEXAGON', 'PENTAGON', 'SQUARE', 'TRIANGLE', 'CIRCLE']:

        ...
    @bokeh.setter
    def bokeh(self, value: Literal['OCTAGON', 'HEPTAGON', 'HEXAGON', 'PENTAGON', 'SQUARE', 'TRIANGLE', 'CIRCLE']) -> None:
        ...
    @property
    ...
    def angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def f_stop(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Amount of focal blur, 128 (infinity) is perfect focus, half the value doubles the blur radius"""
        ...
    @f_stop.setter
    def f_stop(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def blur_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Blur limit, maximum CoC radius"""
        ...
    @blur_max.setter
    def blur_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_zbuffer(self, value: bool) -> None:
        ...
    @property
    def z_scale(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Scale the Z input when not using a z-buffer, controls maximum blur designated by the color white or input value 1"""
        ...
    @z_scale.setter
    def z_scale(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
