...
class FloorConstraint(Constraint):
    ...
    """Armature bone, mesh or lattice vertex group, ..."""
    floor_location: Literal['FLOOR_X', 'FLOOR_Y', 'FLOOR_Z', 'FLOOR_NEGATIVE_X', 'FLOOR_NEGATIVE_Y', 'FLOOR_NEGATIVE_Z']
    """Location of target that object will not pass through"""
    use_rotation: bool
    """Use the target's rotation to determine floor"""
    offset: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=-1"]
