...
class FloorConstraint(Constraint):
    ...
    def floor_location(self, value: Literal['FLOOR_X', 'FLOOR_Y', 'FLOOR_Z', 'FLOOR_NEGATIVE_X', 'FLOOR_NEGATIVE_Y', 'FLOOR_NEGATIVE_Z']) -> None:
        ...
    @property
    ...
    def offset(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=-1"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=-1"]) -> None:
        ...