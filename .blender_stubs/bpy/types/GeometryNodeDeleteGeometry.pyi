...
https://docs.blender.org/api/current/bpy.types.GeometryNodeDeleteGeometry.html
"""
...
class GeometryNodeDeleteGeometry(GeometryNode):
    ...
    mode: Annotated[Literal['ALL', 'EDGE_FACE', 'ONLY_FACE'], "is_animatable=False"]
    """Which parts of the mesh component to delete"""
    domain: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]
