...
class GeometryNodeDeleteGeometry(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def mode(self) -> Annotated[Literal['ALL', 'EDGE_FACE', 'ONLY_FACE'], "is_animatable=False"]:
        """Which parts of the mesh component to delete"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['ALL', 'EDGE_FACE', 'ONLY_FACE'], "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]:
        """Which domain to delete in"""
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]) -> None:
        ...
