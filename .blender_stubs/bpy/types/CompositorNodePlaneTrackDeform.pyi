...
class CompositorNodePlaneTrackDeform(CompositorNode):
    ...
    def clip(self, value: Annotated[Optional['MovieClip'], "is_animatable=False"]) -> None:
        ...
    @property
    def tracking_object(self) -> Annotated[str, "is_animatable=False"]:

        ...
    @tracking_object.setter
    def tracking_object(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def plane_track_name(self) -> Annotated[str, "is_animatable=False"]:

        ...
    @plane_track_name.setter
    def plane_track_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
