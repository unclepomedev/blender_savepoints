...
class FModifierCycles(FModifier):
    ...
    def mode_before(self) -> Literal['NONE', 'REPEAT', 'REPEAT_OFFSET', 'MIRROR']:
        ...
        ...
    @mode_before.setter
    def mode_before(self, value: Literal['NONE', 'REPEAT', 'REPEAT_OFFSET', 'MIRROR']):
        ...
    @property
    ...
    def cycles_before(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def mode_after(self) -> Literal['NONE', 'REPEAT', 'REPEAT_OFFSET', 'MIRROR']:
        ...
        ...
    @mode_after.setter
    def mode_after(self, value: Literal['NONE', 'REPEAT', 'REPEAT_OFFSET', 'MIRROR']):
        ...
    @property
    def cycles_after(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @cycles_after.setter
    def cycles_after(self, value: Annotated[int, "step=1"]):
        ...