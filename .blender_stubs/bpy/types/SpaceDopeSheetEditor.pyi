...
class SpaceDopeSheetEditor(Space):
    ...
    def mode(self) -> Literal['DOPESHEET', 'ACTION', 'SHAPEKEY', 'GPENCIL', 'MASK', 'CACHEFILE', 'TIMELINE']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['DOPESHEET', 'ACTION', 'SHAPEKEY', 'GPENCIL', 'MASK', 'CACHEFILE', 'TIMELINE']) -> None:
        ...
    @property
    def ui_mode(self) -> Literal['DOPESHEET', 'ACTION', 'SHAPEKEY', 'GPENCIL', 'MASK', 'CACHEFILE']:
        ...
        ...
    @ui_mode.setter
    def ui_mode(self, value: Literal['DOPESHEET', 'ACTION', 'SHAPEKEY', 'GPENCIL', 'MASK', 'CACHEFILE']) -> None:
        ...
    @property
    ...
    def show_pose_markers(self, value: bool) -> None:
        ...
    @property
    ...
    def show_interpolation(self, value: bool) -> None:
        ...
    @property
    ...
    def show_extremes(self, value: bool) -> None:
        ...
    @property
    ...
    def cache_softbody(self, value: bool) -> None:
        ...
    @property
    ...
    def cache_particles(self, value: bool) -> None:
        ...
    @property
    def cache_cloth(self) -> bool:
        ...
        ...
    @cache_cloth.setter
    def cache_cloth(self, value: bool) -> None:
        ...
    @property
    def cache_smoke(self) -> bool:
        ...
        ...
    @cache_smoke.setter
    def cache_smoke(self, value: bool) -> None:
        ...
    @property
    ...
    def cache_simulation_nodes(self, value: bool) -> None:
        ...
    @property
    ...
    def cache_dynamicpaint(self, value: bool) -> None:
        ...
    @property
    ...
    def cache_rigidbody(self, value: bool) -> None:
        ...
    @property
