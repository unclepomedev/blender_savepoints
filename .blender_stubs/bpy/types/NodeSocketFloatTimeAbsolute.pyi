...
https://docs.blender.org/api/current/bpy.types.NodeSocketFloatTimeAbsolute.html
"""
...
class NodeSocketFloatTimeAbsolute(NodeSocketStandard):
    ...
    def bl_subtype_label(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def default_value(self) -> Annotated[float, "subtype='TIME_ABSOLUTE'", "unit='TIME_ABSOLUTE'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[float, "subtype='TIME_ABSOLUTE'", "unit='TIME_ABSOLUTE'", "step=10.0", "precision=3"]) -> None:
        ...
