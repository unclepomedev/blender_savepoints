...
class UnifiedPaintSettings(bpy_struct):
    ...
    def use_unified_size(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_unified_strength(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_unified_weight(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_unified_color(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_unified_input_samples(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def unprojected_size(self, value: Annotated[float, "subtype='DISTANCE_DIAMETER'", "unit='LENGTH'", "step=1.0", "precision=-1", "is_animatable=False"]):
        ...
    @property
    def strength(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3", "is_animatable=False"]:
        ...
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3", "is_animatable=False"]):
        ...
    @property
    def weight(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3", "is_animatable=False"]:
        ...
        ...
    @weight.setter
    def weight(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def secondary_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def hue_jitter(self) -> Annotated[float, "step=0.05000000074505806", "precision=2", "is_animatable=False"]:
        ...
        ...
    @hue_jitter.setter
    def hue_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2", "is_animatable=False"]):
        ...
    @property
    ...
    def saturation_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2", "is_animatable=False"]):
        ...
    @property
    def value_jitter(self) -> Annotated[float, "step=0.05000000074505806", "precision=2", "is_animatable=False"]:
        ...
        ...
    @value_jitter.setter
    def value_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2", "is_animatable=False"]):
        ...
    @property
    ...
    def input_samples(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def use_locked_size(self, value: Annotated[Literal['VIEW', 'SCENE'], "is_animatable=False"]):
        ...