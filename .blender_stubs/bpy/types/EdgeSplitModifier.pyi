...
class EdgeSplitModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def split_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=2"]:
        """Angle above which to split edges"""
        ...
    @split_angle.setter
    def split_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=2"]) -> None:
        ...
    @property
    def use_edge_angle(self) -> bool:
        """Split edges with high angle between faces"""
        ...
    @use_edge_angle.setter
    def use_edge_angle(self, value: bool) -> None:
        ...
    @property
