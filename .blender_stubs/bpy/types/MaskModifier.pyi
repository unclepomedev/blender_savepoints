...
class MaskModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def mode(self) -> Literal['VERTEX_GROUP', 'ARMATURE']:

        ...
    @mode.setter
    def mode(self, value: Literal['VERTEX_GROUP', 'ARMATURE']):
        ...
    @property
    def armature(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        """Armature to use as source of bones to mask"""
        ...
    @armature.setter
    def armature(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
