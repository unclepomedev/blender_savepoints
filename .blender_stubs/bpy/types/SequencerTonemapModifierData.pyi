...
class SequencerTonemapModifierData(StripModifier):
    ...
    def tonemap_type(self) -> Literal['RD_PHOTORECEPTOR', 'RH_SIMPLE']:
        ...
        ...
    @tonemap_type.setter
    def tonemap_type(self, value: Literal['RD_PHOTORECEPTOR', 'RH_SIMPLE']):
        ...
    @property
    def key(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @key.setter
    def key(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def offset(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def gamma(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @gamma.setter
    def gamma(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def contrast(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @contrast.setter
    def contrast(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def adaptation(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @adaptation.setter
    def adaptation(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def correction(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @correction.setter
    def correction(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
