...
class ImagePaint(Paint):
    ...
    def use_occlude(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_occlude.setter
    def use_occlude(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_backface_culling(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_normal_falloff(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stencil_layer(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def invert_stencil(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def stencil_image(self, value: Annotated[Optional['Image'], "is_animatable=False"]):
        ...
    @property
    def canvas(self) -> Annotated[Optional['Image'], "is_animatable=False"]:
        ...
        ...
    @canvas.setter
    def canvas(self, value: Annotated[Optional['Image'], "is_animatable=False"]):
        ...
    @property
    def clone_image(self) -> Annotated[Optional['Image'], "is_animatable=False"]:
        ...
        ...
    @clone_image.setter
    def clone_image(self, value: Annotated[Optional['Image'], "is_animatable=False"]):
        ...
    @property
    ...
    def stencil_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def dither(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @dither.setter
    def dither(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def use_clone_layer(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def seam_bleed(self) -> Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]:
        ...
        ...
    @seam_bleed.setter
    def seam_bleed(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]):
        ...
    @property
    def normal_angle(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        ...
        ...
    @normal_angle.setter
    def normal_angle(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def screen_grab_size(self, value: Annotated[list[int], "subtype='PIXEL'", "step=1", "is_animatable=False"]):
        ...
    @property
    def mode(self) -> Annotated[Literal['MATERIAL', 'IMAGE'], "is_animatable=False"]:
        ...
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['MATERIAL', 'IMAGE'], "is_animatable=False"]):
        ...
    @property
    ...
    def interpolation(self, value: Annotated[Literal['LINEAR', 'CLOSEST'], "is_animatable=False"]):
        ...
    @property
    ...
    def clone_alpha(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @clone_alpha.setter
    def clone_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def clone_offset(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @clone_offset.setter
    def clone_offset(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
