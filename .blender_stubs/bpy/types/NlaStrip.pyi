...
class NlaStrip(bpy_struct):
    ...
    def extrapolation(self, value: Literal['NOTHING', 'HOLD', 'HOLD_FORWARD']):
        ...
    @property
    def blend_type(self) -> Literal['REPLACE', 'COMBINE', 'ADD', 'SUBTRACT', 'MULTIPLY']:
        ...
        ...
    @blend_type.setter
    def blend_type(self, value: Literal['REPLACE', 'COMBINE', 'ADD', 'SUBTRACT', 'MULTIPLY']):
        ...
    @property
    ...
    def frame_end(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @frame_end.setter
    def frame_end(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def frame_start_raw(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def frame_end_raw(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def frame_start_ui(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    def frame_end_ui(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @frame_end_ui.setter
    def frame_end_ui(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_auto_blend(self, value: bool):
        ...
    @property
    ...
    def action_frame_start(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def action_frame_end(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    def repeat(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @repeat.setter
    def repeat(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def strip_time(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @strip_time.setter
    def strip_time(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_animated_influence(self, value: bool):
        ...
    @property
    ...
    def use_animated_time(self, value: bool):
        ...
    @property
    ...
    def use_animated_time_cyclic(self, value: bool):
        ...
    @property
    ...
    def use_reverse(self) -> bool:
        ...
        ...
    @use_reverse.setter
    def use_reverse(self, value: bool):
        ...
    @property
    ...
    def use_sync_length(self, value: bool):
        ...