...
class NodeSocketFloatFactor(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
