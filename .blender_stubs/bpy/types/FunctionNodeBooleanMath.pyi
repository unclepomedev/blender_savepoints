...
https://docs.blender.org/api/current/bpy.types.FunctionNodeBooleanMath.html
"""
...
class FunctionNodeBooleanMath(FunctionNode):
    ...
    operation: Annotated[Literal['AND', 'OR', 'NOT', 'NAND', 'NOR', 'XNOR', 'XOR', 'IMPLY', 'NIMPLY'], "is_animatable=False"]
