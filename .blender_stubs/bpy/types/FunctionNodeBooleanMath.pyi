...
class FunctionNodeBooleanMath(FunctionNode):
    ...
    @property
    def operation(self) -> Annotated[Literal['AND', 'OR', 'NOT', 'NAND', 'NOR', 'XNOR', 'XOR', 'IMPLY', 'NIMPLY'], "is_animatable=False"]:

        ...
    @operation.setter
    def operation(self, value: Annotated[Literal['AND', 'OR', 'NOT', 'NAND', 'NOR', 'XNOR', 'XOR', 'IMPLY', 'NIMPLY'], "is_animatable=False"]) -> None:
        ...
