...
class GeometryNodeSimulationOutput(GeometryNode):
    ...
    def active_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_item(self) -> Annotated[Optional['SimulationStateItem'], "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_item.setter
    def active_item(self, value: Annotated[Optional['SimulationStateItem'], "is_animatable=False"]) -> None:
        ...
