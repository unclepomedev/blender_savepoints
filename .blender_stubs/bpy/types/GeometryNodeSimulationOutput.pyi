...
https://docs.blender.org/api/current/bpy.types.GeometryNodeSimulationOutput.html
"""
...
class GeometryNodeSimulationOutput(GeometryNode):
    ...
    @property
    def state_items(self) -> Annotated['NodeGeometrySimulationOutputItems', "is_animatable=False"]:

        ...
    active_index: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]
    """Index of the active item"""
    active_item: Annotated[Optional['SimulationStateItem'], "is_animatable=False"]
    """Index of the active item"""
