...
class BuildModifier(Modifier):
    ...
    def frame_start(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    def frame_duration(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        """Total time the build effect requires"""
        ...
    @frame_duration.setter
    def frame_duration(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_reverse(self, value: bool):
        ...
    @property
    def use_random_order(self) -> bool:
        """Randomize the faces or edges during build"""
        ...
    @use_random_order.setter
    def use_random_order(self, value: bool):
        ...
    @property
