...
class FloatProperty(Property):
    ...
    def tags(self) -> set[str]:
        ...
        ...
    @property
    def default(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Default value for this number"""
        ...
    @property
    def default_array(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
    ...
    def is_array(self) -> bool:
        ...
        ...
    @property
    def hard_min(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Minimum value used by buttons"""
        ...
    @property
    def hard_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Maximum value used by buttons"""
        ...
    @property
    def soft_min(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Minimum value used by buttons"""
        ...
    @property
    def soft_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Maximum value used by buttons"""
        ...
    @property
    def step(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]:
        """Step size used by number buttons, for floats 1/100th of the step size"""
        ...
    @property
    def precision(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
