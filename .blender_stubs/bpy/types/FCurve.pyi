...
class FCurve(bpy_struct):
    ...
    def extrapolation(self, value: Literal['CONSTANT', 'LINEAR']):
        ...
    @property
    ...
    def group(self) -> Annotated[Optional['ActionGroup'], "is_animatable=False"]:
        ...
        ...
    @group.setter
    def group(self, value: Annotated[Optional['ActionGroup'], "is_animatable=False"]):
        ...
    @property
    ...
    def array_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @array_index.setter
    def array_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    def color_mode(self) -> Literal['AUTO_RAINBOW', 'AUTO_RGB', 'AUTO_YRGB', 'CUSTOM']:
        ...
        ...
    @color_mode.setter
    def color_mode(self, value: Literal['AUTO_RAINBOW', 'AUTO_RGB', 'AUTO_YRGB', 'CUSTOM']):
        ...
    @property
    ...
    def auto_smoothing(self, value: Literal['NONE', 'CONT_ACCEL']):
        ...
    @property
