...
class MovieTrackingPlaneTrack(bpy_struct):
    ...
    def use_auto_keying(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def image_opacity(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...