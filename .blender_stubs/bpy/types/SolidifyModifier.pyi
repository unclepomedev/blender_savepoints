...
class SolidifyModifier(Modifier):
    ...
    def solidify_mode(self, value: Literal['EXTRUDE', 'NON_MANIFOLD']):
        ...
    @property
    def thickness(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=4"]:
        ...
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=4"]):
        ...
    @property
    ...
    def thickness_clamp(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=4"]):
        ...
    @property
    ...
    def use_thickness_angle_clamp(self, value: bool):
        ...
    @property
    ...
    def thickness_vertex_group(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    def offset(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=4"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=4"]):
        ...
    @property
    ...
    def edge_crease_inner(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def edge_crease_outer(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def edge_crease_rim(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def material_offset(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def material_offset_rim(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def shell_vertex_group(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def rim_vertex_group(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def use_even_offset(self, value: bool):
        ...
    @property
    ...
    def use_quality_normals(self, value: bool):
        ...
    @property
    ...
    def use_flat_faces(self, value: bool):
        ...
    @property
    ...
    def use_flip_normals(self, value: bool):
        ...
    @property
    def use_rim_only(self) -> bool:
        ...
        ...
    @use_rim_only.setter
    def use_rim_only(self, value: bool):
        ...
    @property
    ...
    def nonmanifold_thickness_mode(self, value: Literal['FIXED', 'EVEN', 'CONSTRAINTS']):
        ...
    @property
    ...
    def nonmanifold_boundary_mode(self, value: Literal['NONE', 'ROUND', 'FLAT']):
        ...
    @property
    ...
    def nonmanifold_merge_threshold(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]):
        ...
    @property
    def bevel_convex(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @bevel_convex.setter
    def bevel_convex(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...