...
class CollisionSettings(bpy_struct):
    ...
    def damping_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def damping_random(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def friction_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def friction_random(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def permeability(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @permeability.setter
    def permeability(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_particle_kill(self, value: bool) -> None:
        ...
    @property
    def stickiness(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @stickiness.setter
    def stickiness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def thickness_inner(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def thickness_outer(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def absorption(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]:
        ...
        ...
    @absorption.setter
    def absorption(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def cloth_friction(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
