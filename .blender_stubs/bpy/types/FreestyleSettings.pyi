...
class FreestyleSettings(bpy_struct):
    ...
    def mode(self) -> Literal['SCRIPT', 'EDITOR']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['SCRIPT', 'EDITOR']):
        ...
    @property
    ...
    def use_suggestive_contours(self, value: bool):
        ...
    @property
    ...
    def use_ridges_and_valleys(self, value: bool):
        ...
    @property
    ...
    def use_material_boundaries(self, value: bool):
        ...
    @property
    ...
    def use_smoothness(self, value: bool):
        ...
    @property
    ...
    def use_view_map_cache(self, value: bool):
        ...
    @property
    ...
    def as_render_pass(self, value: bool):
        ...
    @property
    ...
    def sphere_radius(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def kr_derivative_epsilon(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def crease_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @crease_angle.setter
    def crease_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
