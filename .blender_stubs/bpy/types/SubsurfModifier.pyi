...
class SubsurfModifier(Modifier):
    ...
    def subdivision_type(self, value: Literal['CATMULL_CLARK', 'SIMPLE']):
        ...
    @property
    ...
    def use_limit_surface(self, value: bool):
        ...
    @property
    ...
    def use_adaptive_subdivision(self, value: bool):
        ...
    @property
    ...
    def adaptive_space(self, value: Literal['PIXEL', 'OBJECT']):
        ...
    @property
    ...
    def adaptive_pixel_size(self, value: Annotated[float, "subtype='PIXEL'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def adaptive_object_edge_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def open_adaptive_subdivision_panel(self, value: bool):
        ...
    @property
    ...
    def open_advanced_panel(self, value: bool):
        ...