...
class SubsurfModifier(Modifier):
    ...
    adaptive_space: Literal['PIXEL', 'OBJECT']
    """How to adaptively subdivide the mesh"""
    adaptive_pixel_size: Annotated[float, "subtype='PIXEL'", "step=10.0", "precision=3"]
    """Target polygon pixel size for adaptive subdivision"""
    adaptive_object_edge_length: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]
