...
class FunctionNodeAxesToRotation(FunctionNode):
    ...
    @property
    def primary_axis(self) -> Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]:
        """Axis that is aligned exactly to the provided primary direction"""
        ...
    @primary_axis.setter
    def primary_axis(self, value: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]) -> None:
        ...
    @property
    def secondary_axis(self) -> Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]:
        """Axis that is aligned as well as possible given the alignment of the primary axis"""
        ...
    @secondary_axis.setter
    def secondary_axis(self, value: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]) -> None:
        ...
