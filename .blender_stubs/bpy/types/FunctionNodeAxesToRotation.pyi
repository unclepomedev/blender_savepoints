...
https://docs.blender.org/api/current/bpy.types.FunctionNodeAxesToRotation.html
"""
...
class FunctionNodeAxesToRotation(FunctionNode):
    ...
    primary_axis: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]
    """Axis that is aligned exactly to the provided primary direction"""
    secondary_axis: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]
