...
class SplineIKConstraint(Constraint):
    ...
    def joint_bindings(self, value: Annotated[list[float], "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_chain_offset(self, value: bool):
        ...
    @property
    ...
    def use_even_divisions(self, value: bool):
        ...
    @property
    ...
    def xz_scale_mode(self, value: Literal['NONE', 'BONE_ORIGINAL', 'INVERSE_PRESERVE', 'VOLUME_PRESERVE']):
        ...
    @property
    def y_scale_mode(self) -> Literal['NONE', 'FIT_CURVE', 'BONE_ORIGINAL']:
        ...
        ...
    @y_scale_mode.setter
    def y_scale_mode(self, value: Literal['NONE', 'FIT_CURVE', 'BONE_ORIGINAL']):
        ...
    @property
    ...
    def use_original_scale(self, value: bool):
        ...
    @property
    def bulge(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @bulge.setter
    def bulge(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_bulge_min(self, value: bool):
        ...
    @property
    ...
    def use_bulge_max(self, value: bool):
        ...
    @property
    def bulge_min(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @bulge_min.setter
    def bulge_min(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def bulge_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @bulge_max.setter
    def bulge_max(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def bulge_smooth(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @bulge_smooth.setter
    def bulge_smooth(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...