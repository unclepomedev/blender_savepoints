...
https://docs.blender.org/api/current/bpy.types.GreasePencilSimplifyModifier.html
"""
...
class GreasePencilSimplifyModifier(Modifier):
    ...
    factor: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]
    """Factor of Simplify"""
    mode: Literal['FIXED', 'ADAPTIVE', 'SAMPLE', 'MERGE']
    """How to simplify the stroke"""
    step: Annotated[int, "subtype='UNSIGNED'", "step=1"]
    """Number of times to apply simplify"""
    length: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.05000000074505806", "precision=3"]
    """Length of each segment"""
    sharp_threshold: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=1.0", "precision=1"]
    """Preserve corners that have sharper angle than this threshold"""
    distance: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=3"]
