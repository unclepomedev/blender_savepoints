...
class SpaceNodeEditor(Space):
    ...
    def tree_type(self) -> Literal['GeometryNodeTree', 'CompositorNodeTree', 'ShaderNodeTree', 'TextureNodeTree']:
        ...
        ...
    @tree_type.setter
    def tree_type(self, value: Literal['GeometryNodeTree', 'CompositorNodeTree', 'ShaderNodeTree', 'TextureNodeTree']) -> None:
        ...
    @property
    def texture_type(self) -> Literal['WORLD', 'BRUSH', 'LINESTYLE']:
        ...
        ...
    @texture_type.setter
    def texture_type(self, value: Literal['WORLD', 'BRUSH', 'LINESTYLE']) -> None:
        ...
    @property
    def shader_type(self) -> Literal['OBJECT', 'WORLD', 'LINESTYLE']:
        ...
        ...
    @shader_type.setter
    def shader_type(self, value: Literal['OBJECT', 'WORLD', 'LINESTYLE']) -> None:
        ...
    @property
    ...
    def node_tree_sub_type(self, value: str) -> None:
        ...
    @property
    ...
    def node_tree(self) -> Annotated[Optional['NodeTree'], "is_animatable=False"]:
        ...
        ...
    @node_tree.setter
    def node_tree(self, value: Annotated[Optional['NodeTree'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def show_backdrop(self, value: bool) -> None:
        ...
    @property
    ...
    def selected_node_group(self, value: Annotated[Optional['NodeTree'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def backdrop_zoom(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def backdrop_offset(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def backdrop_channels(self, value: Literal['COLOR_ALPHA', 'COLOR', 'ALPHA', 'RED', 'GREEN', 'BLUE']) -> None:
        ...
    @property
    ...
    def insert_offset_direction(self, value: Literal['RIGHT', 'LEFT']) -> None:
        ...
    @property
    ...
    def show_gizmo_active_node(self, value: bool) -> None:
        ...
    @property
