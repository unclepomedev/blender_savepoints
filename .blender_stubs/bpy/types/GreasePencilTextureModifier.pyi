...
class GreasePencilTextureModifier(Modifier):
    ...
    def uv_offset(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @uv_offset.setter
    def uv_offset(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    def uv_scale(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @uv_scale.setter
    def uv_scale(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def fill_rotation(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def fill_offset(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        ...
        ...
    @fill_offset.setter
    def fill_offset(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]):
        ...
    @property
    def fill_scale(self) -> Annotated[float, "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        ...
        ...
    @fill_scale.setter
    def fill_scale(self, value: Annotated[float, "subtype='COORDINATES'", "step=10.0", "precision=3"]):
        ...
    @property
    def fit_method(self) -> Literal['CONSTANT_LENGTH', 'FIT_STROKE']:
        ...
        ...
    @fit_method.setter
    def fit_method(self, value: Literal['CONSTANT_LENGTH', 'FIT_STROKE']):
        ...
    @property
    def mode(self) -> Literal['STROKE', 'FILL', 'STROKE_AND_FILL']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['STROKE', 'FILL', 'STROKE_AND_FILL']):
        ...