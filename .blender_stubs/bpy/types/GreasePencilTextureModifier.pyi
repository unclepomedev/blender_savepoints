...
class GreasePencilTextureModifier(Modifier):
    ...
    uv_offset: Annotated[float, "step=0.10000000149011612", "precision=3"]
    """Offset value to add to stroke UVs"""
    uv_scale: Annotated[float, "step=0.10000000149011612", "precision=3"]
    ...
    fill_rotation: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]
    """Additional rotation of the fill UV"""
    fill_offset: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]
    """Additional offset of the fill UV"""
    fill_scale: Annotated[float, "subtype='COORDINATES'", "step=10.0", "precision=3"]
    """Additional scale of the fill UV"""
    fit_method: Literal['CONSTANT_LENGTH', 'FIT_STROKE']

    mode: Literal['STROKE', 'FILL', 'STROKE_AND_FILL']
