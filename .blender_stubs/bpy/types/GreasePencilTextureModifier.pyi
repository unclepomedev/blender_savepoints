...
https://docs.blender.org/api/current/bpy.types.GreasePencilTextureModifier.html
"""
...
class GreasePencilTextureModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def uv_offset(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Offset value to add to stroke UVs"""
        ...
    @uv_offset.setter
    def uv_offset(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    def uv_scale(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Factor to scale the UVs"""
        ...
    @uv_scale.setter
    def uv_scale(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    ...
    def alignment_rotation(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def fill_rotation(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        """Additional rotation of the fill UV"""
        ...
    @fill_rotation.setter
    def fill_rotation(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def fill_offset(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        """Additional offset of the fill UV"""
        ...
    @fill_offset.setter
    def fill_offset(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def fill_scale(self) -> Annotated[float, "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        """Additional scale of the fill UV"""
        ...
    @fill_scale.setter
    def fill_scale(self, value: Annotated[float, "subtype='COORDINATES'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def fit_method(self) -> Literal['CONSTANT_LENGTH', 'FIT_STROKE']:

        ...
    @fit_method.setter
    def fit_method(self, value: Literal['CONSTANT_LENGTH', 'FIT_STROKE']) -> None:
        ...
    @property
    def mode(self) -> Literal['STROKE', 'FILL', 'STROKE_AND_FILL']:

        ...
    @mode.setter
    def mode(self, value: Literal['STROKE', 'FILL', 'STROKE_AND_FILL']) -> None:
        ...