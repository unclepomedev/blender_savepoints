...
class DecimateModifier(Modifier):
    ...
    ratio: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=4"]
    ...
    symmetry_axis: Literal['X', 'Y', 'Z']
    """Axis of symmetry"""
    vertex_group_factor: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=4"]
