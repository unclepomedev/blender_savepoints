...
Deprecated. Will be remove in 5.0."""
    ...
    subtype: Annotated[Literal['DEFAULT'], "is_animatable=False"]
    """Subtype of the default value"""
    dimensions: Annotated[int, "step=1", "is_animatable=False"]
    """Dimensions of the vector socket"""
    default_value: Annotated[list[float], "subtype='ACCELERATION'", "unit='ACCELERATION'", "step=10.0", "precision=3", "is_animatable=False"]
    """Input value used for unconnected socket"""
    min_value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """Minimum value"""
    max_value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """Maximum value"""
