...
class RaytraceEEVEE(bpy_struct):
    ...
    def resolution_scale(self, value: Annotated[Literal['1', '2', '4', '8', '16'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_denoise(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_denoise.setter
    def use_denoise(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def denoise_spatial(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def denoise_temporal(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def denoise_bilateral(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def screen_trace_thickness(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=5.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def trace_max_roughness(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def screen_trace_quality(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...