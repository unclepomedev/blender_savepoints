...
class StripProxy(bpy_struct):
    ...
    def build_record_run(self, value: bool):
        ...
    @property
    ...
    def timecode(self) -> Literal['NONE', 'RECORD_RUN', 'RECORD_RUN_NO_GAPS']:
        ...
        ...
    @timecode.setter
    def timecode(self, value: Literal['NONE', 'RECORD_RUN', 'RECORD_RUN_NO_GAPS']):
        ...
    @property
    ...
    def use_proxy_custom_directory(self, value: bool):
        ...
    @property
    ...
    def use_proxy_custom_file(self, value: bool):
        ...