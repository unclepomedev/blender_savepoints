...
class Itasc(IKParam):
    ...
    def precision(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @precision.setter
    def precision(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def step_count(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @step_count.setter
    def step_count(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def translate_root_bones(self, value: bool) -> None:
        ...
    @property
    def mode(self) -> Literal['ANIMATION', 'SIMULATION']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['ANIMATION', 'SIMULATION']) -> None:
        ...
    @property
    ...
    def reiteration_method(self, value: Literal['NEVER', 'INITIAL', 'ALWAYS']) -> None:
        ...
    @property
    ...
    def step_min(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @step_min.setter
    def step_min(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def step_max(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @step_max.setter
    def step_max(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def feedback(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @feedback.setter
    def feedback(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def velocity_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @velocity_max.setter
    def velocity_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def solver(self) -> Literal['SDLS', 'DLS']:
        ...
        ...
    @solver.setter
    def solver(self, value: Literal['SDLS', 'DLS']) -> None:
        ...
    @property
    def damping_max(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @damping_max.setter
    def damping_max(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def damping_epsilon(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...