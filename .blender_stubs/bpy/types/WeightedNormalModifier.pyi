...
class WeightedNormalModifier(Modifier):
    ...
    def weight(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @weight.setter
    def weight(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def mode(self) -> Literal['FACE_AREA', 'CORNER_ANGLE', 'FACE_AREA_WITH_ANGLE']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['FACE_AREA', 'CORNER_ANGLE', 'FACE_AREA_WITH_ANGLE']):
        ...
    @property
    def thresh(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @thresh.setter
    def thresh(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def keep_sharp(self) -> bool:
        ...
        ...
    @keep_sharp.setter
    def keep_sharp(self, value: bool):
        ...
    @property
    ...
    def use_face_influence(self, value: bool):
        ...