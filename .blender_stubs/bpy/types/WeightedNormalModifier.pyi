...
class WeightedNormalModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def weight(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @weight.setter
    def weight(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def mode(self) -> Literal['FACE_AREA', 'CORNER_ANGLE', 'FACE_AREA_WITH_ANGLE']:
        """Weighted vertex normal mode to use"""
        ...
    @mode.setter
    def mode(self, value: Literal['FACE_AREA', 'CORNER_ANGLE', 'FACE_AREA_WITH_ANGLE']) -> None:
        ...
    @property
    def thresh(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """Threshold value for different weights to be considered equal"""
        ...
    @thresh.setter
    def thresh(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def keep_sharp(self) -> bool:
        """Keep sharp edges as computed for default custom normals, instead of setting a single weighted normal for each vertex"""
        ...
    @keep_sharp.setter
    def keep_sharp(self, value: bool) -> None:
        ...
    @property
    ...
    def invert_vertex_group(self, value: bool) -> None:
        ...
    @property
    def use_face_influence(self) -> bool:
        """Use influence of face for weighting"""
        ...
    @use_face_influence.setter
    def use_face_influence(self, value: bool) -> None:
        ...