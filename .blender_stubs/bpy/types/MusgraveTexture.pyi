...
class MusgraveTexture(Texture):
    ...
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    musgrave_type: Literal['MULTIFRACTAL', 'RIDGED_MULTIFRACTAL', 'HYBRID_MULTIFRACTAL', 'FBM', 'HETERO_TERRAIN']
    """Fractal noise algorithm"""
    dimension_max: Annotated[float, "step=1.0", "precision=2"]
    """Highest fractal dimension"""
    lacunarity: Annotated[float, "step=1.0", "precision=2"]
    """Gap between successive frequencies"""
    octaves: Annotated[float, "step=1.0", "precision=2"]
    """Number of frequencies used"""
    offset: Annotated[float, "step=1.0", "precision=2"]
    """The fractal offset"""
    gain: Annotated[float, "step=1.0", "precision=2"]
    """The gain multiplier"""
    noise_intensity: Annotated[float, "step=1.0", "precision=2"]
