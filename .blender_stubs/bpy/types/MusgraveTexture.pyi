...
class MusgraveTexture(Texture):
    ...
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    @property
    def musgrave_type(self) -> Literal['MULTIFRACTAL', 'RIDGED_MULTIFRACTAL', 'HYBRID_MULTIFRACTAL', 'FBM', 'HETERO_TERRAIN']:
        """Fractal noise algorithm"""
        ...
    @musgrave_type.setter
    def musgrave_type(self, value: Literal['MULTIFRACTAL', 'RIDGED_MULTIFRACTAL', 'HYBRID_MULTIFRACTAL', 'FBM', 'HETERO_TERRAIN']) -> None:
        ...
    @property
    def dimension_max(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """Highest fractal dimension"""
        ...
    @dimension_max.setter
    def dimension_max(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def lacunarity(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """Gap between successive frequencies"""
        ...
    @lacunarity.setter
    def lacunarity(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def octaves(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """Number of frequencies used"""
        ...
    @octaves.setter
    def octaves(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def offset(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """The fractal offset"""
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def gain(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """The gain multiplier"""
        ...
    @gain.setter
    def gain(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def noise_intensity(self) -> Annotated[float, "step=1.0", "precision=2"]:
        """Intensity of the noise"""
        ...
    @noise_intensity.setter
    def noise_intensity(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
