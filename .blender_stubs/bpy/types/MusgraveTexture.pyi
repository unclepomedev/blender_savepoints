...
class MusgraveTexture(Texture):
    ...
    def musgrave_type(self, value: Literal['MULTIFRACTAL', 'RIDGED_MULTIFRACTAL', 'HYBRID_MULTIFRACTAL', 'FBM', 'HETERO_TERRAIN']):
        ...
    @property
    ...
    def dimension_max(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def lacunarity(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @lacunarity.setter
    def lacunarity(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def octaves(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @octaves.setter
    def octaves(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def offset(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def gain(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @gain.setter
    def gain(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def noise_intensity(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
