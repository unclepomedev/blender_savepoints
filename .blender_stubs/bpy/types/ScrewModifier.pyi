...
class ScrewModifier(Modifier):
    ...
    def steps(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @steps.setter
    def steps(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    def render_steps(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @render_steps.setter
    def render_steps(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    ...
    def angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=-1"]:
        ...
        ...
    @angle.setter
    def angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=-1"]) -> None:
        ...
    @property
    def screw_offset(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @screw_offset.setter
    def screw_offset(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_normal_flip(self, value: bool) -> None:
        ...
    @property
    ...
    def use_normal_calculate(self, value: bool) -> None:
        ...
    @property
    ...
    def use_object_screw_offset(self, value: bool) -> None:
        ...
    @property
    ...
    def use_stretch_u(self, value: bool) -> None:
        ...
    @property
    ...
    def use_stretch_v(self, value: bool) -> None:
        ...