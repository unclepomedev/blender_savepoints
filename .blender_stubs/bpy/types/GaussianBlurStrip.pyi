...
class GaussianBlurStrip(EffectStrip):
    ...
    def size_x(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]:
        ...
        ...
    @size_x.setter
    def size_x(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]):
        ...
    @property
    def size_y(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]:
        ...
        ...
    @size_y.setter
    def size_y(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]):
        ...
