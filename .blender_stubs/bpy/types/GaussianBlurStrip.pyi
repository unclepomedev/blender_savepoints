...
https://docs.blender.org/api/current/bpy.types.GaussianBlurStrip.html
"""
...
class GaussianBlurStrip(EffectStrip):
    ...
    def input_1(self, value: Annotated['Strip', "is_animatable=False"]) -> None:
        ...
    @property
    def size_x(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]:
        """Size of the blur along X axis"""
        ...
    @size_x.setter
    def size_x(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def size_y(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]:
        """Size of the blur along Y axis"""
        ...
    @size_y.setter
    def size_y(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=-1"]) -> None:
        ...
