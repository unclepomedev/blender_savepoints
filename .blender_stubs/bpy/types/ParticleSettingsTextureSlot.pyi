...
class ParticleSettingsTextureSlot(TextureSlot):
    ...
    def texture_coords(self, value: Literal['GLOBAL', 'OBJECT', 'UV', 'ORCO', 'STRAND']) -> None:
        ...
    @property
    ...
    def use_map_time(self) -> bool:
        ...
        ...
    @use_map_time.setter
    def use_map_time(self, value: bool) -> None:
        ...
    @property
    def use_map_life(self) -> bool:
        ...
        ...
    @use_map_life.setter
    def use_map_life(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_density(self, value: bool) -> None:
        ...
    @property
    def use_map_size(self) -> bool:
        ...
        ...
    @use_map_size.setter
    def use_map_size(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_velocity(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_field(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_gravity(self, value: bool) -> None:
        ...
    @property
    def use_map_damp(self) -> bool:
        ...
        ...
    @use_map_damp.setter
    def use_map_damp(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_clump(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_kink_amp(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_kink_freq(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_rough(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_length(self, value: bool) -> None:
        ...
    @property
    ...
    def use_map_twist(self, value: bool) -> None:
        ...
    @property
    def time_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @time_factor.setter
    def time_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def life_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @life_factor.setter
    def life_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def density_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def size_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @size_factor.setter
    def size_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def field_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @field_factor.setter
    def field_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def gravity_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def damp_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @damp_factor.setter
    def damp_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def length_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def kink_amp_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def kink_freq_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def rough_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @rough_factor.setter
    def rough_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def twist_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @twist_factor.setter
    def twist_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...