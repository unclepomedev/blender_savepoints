...
class AnimData(bpy_struct):
    ...
    def action_extrapolation(self, value: Literal['NOTHING', 'HOLD', 'HOLD_FORWARD']):
        ...
    @property
    ...
    def action_blend_type(self, value: Literal['REPLACE', 'COMBINE', 'ADD', 'SUBTRACT', 'MULTIPLY']):
        ...
    @property
    ...
    def action_influence(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def action_tweak_storage(self, value: Annotated[Optional['Action'], "is_animatable=False"]):
        ...
    @property
    ...
    def action_slot_handle_tweak_storage(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_tweak_mode(self, value: bool):
        ...
    @property
