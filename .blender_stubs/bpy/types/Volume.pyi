...
class Volume(ID):
    ...
    def is_sequence(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @is_sequence.setter
    def is_sequence(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def sequence_mode(self, value: Annotated[Literal['CLIP', 'EXTEND', 'REPEAT', 'PING_PONG'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def materials(self) -> Annotated['IDMaterials', "is_animatable=False"]:
        ...
        ...
    @property
    def display(self) -> Annotated[Optional['VolumeDisplay'], "is_animatable=False"]:
    ...
    def velocity_grid(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def velocity_x_grid(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @property
    def velocity_y_grid(self) -> Annotated[str, "is_animatable=False"]:
        """Name of the grid for the Y axis component of the velocity field if it was split into multiple grids"""
        ...
    @property
    def velocity_z_grid(self) -> Annotated[str, "is_animatable=False"]:
