...
class LineStyleAlphaModifier_Curvature_3D(LineStyleAlphaModifier):
    ...
    def curve(self) -> Annotated[Optional['CurveMapping'], "is_animatable=False"]:
        ...
        ...
    @property
    def curvature_min(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Minimum Curvature"""
        ...
    @curvature_min.setter
    def curvature_min(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def curvature_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Maximum Curvature"""
        ...
    @curvature_max.setter
    def curvature_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...