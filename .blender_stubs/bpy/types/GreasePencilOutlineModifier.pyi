...
https://docs.blender.org/api/current/bpy.types.GreasePencilOutlineModifier.html
"""
...
class GreasePencilOutlineModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def thickness(self) -> Annotated[int, "step=1"]:
        """Thickness of the perimeter stroke"""
        ...
    @thickness.setter
    def thickness(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def sample_length(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:

        ...
    @sample_length.setter
    def sample_length(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def subdivision(self) -> Annotated[int, "step=1"]:
        """Number of subdivisions"""
        ...
    @subdivision.setter
    def subdivision(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_keep_shape(self, value: bool) -> None:
        ...
    @property
    def outline_material(self) -> Annotated[Optional['Material'], "is_animatable=False"]:
        """Material used for outline strokes"""
        ...
    @outline_material.setter
    def outline_material(self, value: Annotated[Optional['Material'], "is_animatable=False"]) -> None:
        ...
    @property
