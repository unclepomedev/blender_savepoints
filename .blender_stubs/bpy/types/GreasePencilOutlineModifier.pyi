...
class GreasePencilOutlineModifier(Modifier):
    ...
    def thickness(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @thickness.setter
    def thickness(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def sample_length(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def subdivision(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @subdivision.setter
    def subdivision(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def outline_material(self, value: Annotated[Optional['Material'], "is_animatable=False"]):
        ...
    @property
