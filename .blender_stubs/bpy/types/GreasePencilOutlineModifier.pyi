...
class GreasePencilOutlineModifier(Modifier):
    ...
    thickness: Annotated[int, "step=1"]
    """Thickness of the perimeter stroke"""
    sample_length: Annotated[float, "step=0.10000000149011612", "precision=2"]

    subdivision: Annotated[int, "step=1"]
    """Number of subdivisions"""
    use_keep_shape: bool
    """Try to keep global shape"""
    outline_material: Annotated[Optional['Material'], "is_animatable=False"]
