...
https://docs.blender.org/api/current/bpy.types.VolumeDisplaceModifier.html
"""
...
class VolumeDisplaceModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def strength(self) -> Annotated[float, "step=0.10000000149011612", "precision=4"]:
        """Strength of the displacement"""
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "step=0.10000000149011612", "precision=4"]) -> None:
        ...
    @property
    ...
    def texture(self, value: Annotated[Optional['Texture'], "is_animatable=False"]) -> None:
        ...
    @property
    def texture_map_mode(self) -> Literal['LOCAL', 'GLOBAL', 'OBJECT']:

        ...
    @texture_map_mode.setter
    def texture_map_mode(self, value: Literal['LOCAL', 'GLOBAL', 'OBJECT']) -> None:
        ...
    @property
    def texture_map_object(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        """Object to use for texture mapping"""
        ...
    @texture_map_object.setter
    def texture_map_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def texture_mid_level(self) -> Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]:
        """Subtracted from the texture color to get a displacement vector"""
        ...
    @texture_mid_level.setter
    def texture_mid_level(self, value: Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]) -> None:
        ...
    @property
    def texture_sample_radius(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=5"]:
        """Smaller values result in better performance but might cut off the volume"""
        ...
    @texture_sample_radius.setter
    def texture_sample_radius(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=5"]) -> None:
        ...