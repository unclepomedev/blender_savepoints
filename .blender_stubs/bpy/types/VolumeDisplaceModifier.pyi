...
class VolumeDisplaceModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    strength: Annotated[float, "step=0.10000000149011612", "precision=4"]
    """Strength of the displacement"""
    texture: Annotated[Optional['Texture'], "is_animatable=False"]

    texture_map_mode: Literal['LOCAL', 'GLOBAL', 'OBJECT']

    texture_map_object: Annotated[Optional['Object'], "is_animatable=False"]
    """Object to use for texture mapping"""
    texture_mid_level: Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]
    """Subtracted from the texture color to get a displacement vector"""
    texture_sample_radius: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=5"]
