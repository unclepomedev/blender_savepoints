...
class VolumeDisplaceModifier(Modifier):
    ...
    def strength(self) -> Annotated[float, "step=0.10000000149011612", "precision=4"]:
        ...
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "step=0.10000000149011612", "precision=4"]):
        ...
    @property
    ...
    def texture_map_mode(self, value: Literal['LOCAL', 'GLOBAL', 'OBJECT']):
        ...
    @property
    ...
    def texture_map_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def texture_mid_level(self, value: Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]):
        ...
    @property
    ...
    def texture_sample_radius(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=5"]):
        ...