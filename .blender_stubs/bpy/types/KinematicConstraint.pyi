...
class KinematicConstraint(Constraint):
    ...
    def pole_target(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @pole_target.setter
    def pole_target(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def pole_subtarget(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def pole_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=4"]:
        ...
        ...
    @pole_angle.setter
    def pole_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=4"]):
        ...
    @property
    ...
    def orient_weight(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def chain_count(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @chain_count.setter
    def chain_count(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def reference_axis(self, value: Literal['BONE', 'TARGET']):
        ...
    @property
    def use_location(self) -> bool:
        ...
        ...
    @use_location.setter
    def use_location(self, value: bool):
        ...
    @property
    ...
    def lock_location_x(self, value: bool):
        ...
    @property
    ...
    def lock_location_y(self, value: bool):
        ...
    @property
    ...
    def lock_location_z(self, value: bool):
        ...
    @property
    ...
    def lock_rotation_x(self, value: bool):
        ...
    @property
    ...
    def lock_rotation_y(self, value: bool):
        ...
    @property
    ...
    def lock_rotation_z(self, value: bool):
        ...
    @property
    ...
    def ik_type(self) -> Literal['COPY_POSE', 'DISTANCE']:
        ...
        ...
    @ik_type.setter
    def ik_type(self, value: Literal['COPY_POSE', 'DISTANCE']):
        ...
    @property
    ...
    def distance(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @distance.setter
    def distance(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...