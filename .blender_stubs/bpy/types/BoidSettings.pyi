...
class BoidSettings(bpy_struct):
    ...
    def land_smooth(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @land_smooth.setter
    def land_smooth(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def bank(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @bank.setter
    def bank(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def height(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @height.setter
    def height(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def active_boid_state_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    def health(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @health.setter
    def health(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def aggression(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @aggression.setter
    def aggression(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def accuracy(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @accuracy.setter
    def accuracy(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def range(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @range.setter
    def range(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def air_speed_min(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def air_speed_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def air_acc_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @air_acc_max.setter
    def air_acc_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def air_ave_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @air_ave_max.setter
    def air_ave_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def air_personal_space(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def land_jump_speed(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def land_speed_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def land_acc_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @land_acc_max.setter
    def land_acc_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def land_ave_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @land_ave_max.setter
    def land_ave_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def land_personal_space(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def land_stick_force(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def use_flight(self) -> bool:
        ...
        ...
    @use_flight.setter
    def use_flight(self, value: bool) -> None:
        ...
    @property
    def use_land(self) -> bool:
        ...
        ...
    @use_land.setter
    def use_land(self, value: bool) -> None:
        ...
    @property
    def use_climb(self) -> bool:
        ...
        ...
    @use_climb.setter
    def use_climb(self, value: bool) -> None:
        ...