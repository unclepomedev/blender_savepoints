...
class MeshSequenceCacheModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def cache_file(self) -> Annotated[Optional['CacheFile'], "is_animatable=False"]:

        ...
    @cache_file.setter
    def cache_file(self, value: Annotated[Optional['CacheFile'], "is_animatable=False"]) -> None:
        ...
    @property
    def object_path(self) -> Annotated[str, "is_animatable=False"]:
        """Path to the object in the Alembic archive used to lookup geometric data"""
        ...
    @object_path.setter
    def object_path(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def read_data(self) -> set[str]:
        ...
        ...
    @read_data.setter
    def read_data(self, value: set[str]) -> None:
        ...
    @property
    def use_vertex_interpolation(self) -> bool:
        """Allow interpolation of vertex positions"""
        ...
    @use_vertex_interpolation.setter
    def use_vertex_interpolation(self, value: bool) -> None:
        ...
    @property
