...
class MeshSequenceCacheModifier(Modifier):
    ...
    def cache_file(self) -> Annotated[Optional['CacheFile'], "is_animatable=False"]:
        ...
        ...
    @cache_file.setter
    def cache_file(self, value: Annotated[Optional['CacheFile'], "is_animatable=False"]):
        ...
    @property
    def object_path(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @object_path.setter
    def object_path(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def read_data(self) -> set[str]:
        ...
        ...
    @read_data.setter
    def read_data(self, value: set[str]):
        ...
    @property
    ...
    def use_vertex_interpolation(self, value: bool):
        ...
    @property
