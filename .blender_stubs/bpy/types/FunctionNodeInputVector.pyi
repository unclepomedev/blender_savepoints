...
class FunctionNodeInputVector(FunctionNode):
    ...
    @property
    def vector(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]:

        ...
    @vector.setter
    def vector(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
