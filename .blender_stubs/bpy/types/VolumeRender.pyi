...
class VolumeRender(bpy_struct):
    ...
    def precision(self) -> Literal['FULL', 'HALF', 'VARIABLE']:
        ...
        ...
    @precision.setter
    def precision(self, value: Literal['FULL', 'HALF', 'VARIABLE']):
        ...
    @property
    ...
    def step_size(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @step_size.setter
    def step_size(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def clipping(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @clipping.setter
    def clipping(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...