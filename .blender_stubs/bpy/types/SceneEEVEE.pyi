...
class SceneEEVEE(bpy_struct):
    ...
    def gi_diffuse_bounces(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gi_cubemap_resolution(self, value: Annotated[Literal['128', '256', '512', '1024', '2048', '4096'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gi_visibility_resolution(self, value: Annotated[Literal['8', '16', '32', '64'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gi_glossy_clamp(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gi_irradiance_pool_size(self, value: Annotated[Literal['16', '32', '64', '128', '256', '512', '1024'], "is_animatable=False"]) -> None:
        ...
    @property
    def taa_samples(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @taa_samples.setter
    def taa_samples(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def taa_render_samples(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_taa_reprojection(self, value: bool) -> None:
        ...
    @property
    ...
    def ray_tracing_method(self, value: Annotated[Literal['PROBE', 'SCREEN'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_shadow_jitter_viewport(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def clamp_surface_direct(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def clamp_surface_indirect(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def clamp_volume_direct(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def clamp_volume_indirect(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_start(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_end(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_tile_size(self, value: Annotated[Literal['1', '2', '4', '8', '16'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_samples(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_sample_distribution(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_ray_depth(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_light_clamp(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_volumetric_shadows(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def volumetric_shadow_samples(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_volume_custom_range(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def use_fast_gi(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_fast_gi.setter
    def use_fast_gi(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_thickness_near(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_thickness_far(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_quality(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_step_count(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_ray_count(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_method(self, value: Annotated[Literal['AMBIENT_OCCLUSION_ONLY', 'GLOBAL_ILLUMINATION'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def fast_gi_bias(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @fast_gi_bias.setter
    def fast_gi_bias(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def fast_gi_resolution(self, value: Annotated[Literal['1', '2', '4', '8', '16'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bokeh_max_size(self, value: Annotated[float, "subtype='PIXEL'", "step=100.0", "precision=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bokeh_threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bokeh_neighbor_max(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_bokeh_jittered(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bokeh_overblur(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def motion_blur_depth_scale(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def motion_blur_max(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def motion_blur_steps(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def use_shadows(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_shadows.setter
    def use_shadows(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def shadow_pool_size(self, value: Annotated[Literal['16', '32', '64', '128', '256', '512', '1024'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def shadow_ray_count(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def shadow_step_count(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def light_threshold(self, value: Annotated[float, "subtype='UNSIGNED'", "step=0.10000000149011612", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def use_overscan(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_overscan.setter
    def use_overscan(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def overscan_size(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_raytracing(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def shadow_resolution_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...