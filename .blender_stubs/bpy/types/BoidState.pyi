...
class BoidState(bpy_struct):
    ...
    def ruleset_type(self) -> Literal['FUZZY', 'RANDOM', 'AVERAGE']:
        ...
        ...
    @ruleset_type.setter
    def ruleset_type(self, value: Literal['FUZZY', 'RANDOM', 'AVERAGE']):
        ...
    @property
    ...
    def active_boid_rule_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    def rule_fuzzy(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @rule_fuzzy.setter
    def rule_fuzzy(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
