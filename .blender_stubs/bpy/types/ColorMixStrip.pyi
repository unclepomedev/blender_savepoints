...
class ColorMixStrip(EffectStrip):
    ...
    blend_effect: Literal['DARKEN', 'MULTIPLY', 'BURN', 'LINEAR_BURN', 'LIGHTEN', 'SCREEN', 'DODGE', 'ADD', 'OVERLAY', 'SOFT_LIGHT', 'HARD_LIGHT', 'VIVID_LIGHT', 'LINEAR_LIGHT', 'PIN_LIGHT', 'DIFFERENCE', 'EXCLUSION', 'SUBTRACT', 'HUE', 'SATURATION', 'COLOR', 'VALUE']
    """Method for controlling how the strip combines with other strips"""
    factor: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Percentage of how much the strip's colors affect other strips"""
