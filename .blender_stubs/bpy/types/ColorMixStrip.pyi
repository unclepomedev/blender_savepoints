...
https://docs.blender.org/api/current/bpy.types.ColorMixStrip.html
"""
...
class ColorMixStrip(EffectStrip):
    ...
    def input_2(self) -> Annotated['Strip', "is_animatable=False"]:
        ...
        ...
    @input_2.setter
    def input_2(self, value: Annotated['Strip', "is_animatable=False"]) -> None:
        ...
    @property
    def blend_effect(self) -> Literal['DARKEN', 'MULTIPLY', 'BURN', 'LINEAR_BURN', 'LIGHTEN', 'SCREEN', 'DODGE', 'ADD', 'OVERLAY', 'SOFT_LIGHT', 'HARD_LIGHT', 'VIVID_LIGHT', 'LINEAR_LIGHT', 'PIN_LIGHT', 'DIFFERENCE', 'EXCLUSION', 'SUBTRACT', 'HUE', 'SATURATION', 'COLOR', 'VALUE']:
        """Method for controlling how the strip combines with other strips"""
        ...
    @blend_effect.setter
    def blend_effect(self, value: Literal['DARKEN', 'MULTIPLY', 'BURN', 'LINEAR_BURN', 'LIGHTEN', 'SCREEN', 'DODGE', 'ADD', 'OVERLAY', 'SOFT_LIGHT', 'HARD_LIGHT', 'VIVID_LIGHT', 'LINEAR_LIGHT', 'PIN_LIGHT', 'DIFFERENCE', 'EXCLUSION', 'SUBTRACT', 'HUE', 'SATURATION', 'COLOR', 'VALUE']) -> None:
        ...
    @property
    def factor(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
