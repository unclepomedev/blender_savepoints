...
class GreasePencilEnvelopeModifier(Modifier):
    ...
    def mode(self) -> Literal['DEFORM', 'SEGMENTS', 'FILLS']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['DEFORM', 'SEGMENTS', 'FILLS']):
        ...
    @property
    def spread(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @spread.setter
    def spread(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def mat_nr(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @mat_nr.setter
    def mat_nr(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def thickness(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def skip(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @skip.setter
    def skip(self, value: Annotated[int, "step=1"]):
        ...