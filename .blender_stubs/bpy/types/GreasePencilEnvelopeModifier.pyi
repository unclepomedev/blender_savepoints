...
https://docs.blender.org/api/current/bpy.types.GreasePencilEnvelopeModifier.html
"""
...
class GreasePencilEnvelopeModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def mode(self) -> Literal['DEFORM', 'SEGMENTS', 'FILLS']:
        """Algorithm to use for generating the envelope"""
        ...
    @mode.setter
    def mode(self, value: Literal['DEFORM', 'SEGMENTS', 'FILLS']) -> None:
        ...
    @property
    def spread(self) -> Annotated[int, "step=1"]:
        """The number of points to skip to create straight segments"""
        ...
    @spread.setter
    def spread(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def mat_nr(self) -> Annotated[int, "step=1"]:
        """The material to use for the new strokes"""
        ...
    @mat_nr.setter
    def mat_nr(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def thickness(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Multiplier for the thickness of the new strokes"""
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def strength(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Multiplier for the strength of the new strokes"""
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def skip(self) -> Annotated[int, "step=1"]:
        """The number of generated segments to skip to reduce complexity"""
        ...
    @skip.setter
    def skip(self, value: Annotated[int, "step=1"]) -> None:
        ...