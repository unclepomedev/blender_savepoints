...
class DynamicPaintBrushSettings(bpy_struct):
    ...
    def paint_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:
        ...
        ...
    @paint_color.setter
    def paint_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def paint_alpha(self) -> Annotated[float, "step=5.0", "precision=2"]:
        ...
        ...
    @paint_alpha.setter
    def paint_alpha(self, value: Annotated[float, "step=5.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def use_absolute_alpha(self, value: bool) -> None:
        ...
    @property
    ...
    def paint_wetness(self, value: Annotated[float, "step=5.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def use_paint_erase(self, value: bool) -> None:
        ...
    @property
    def wave_type(self) -> Annotated[Literal['CHANGE', 'DEPTH', 'FORCE', 'REFLECT'], "is_animatable=False"]:
        ...
        ...
    @wave_type.setter
    def wave_type(self, value: Annotated[Literal['CHANGE', 'DEPTH', 'FORCE', 'REFLECT'], "is_animatable=False"]) -> None:
        ...
    @property
    def wave_factor(self) -> Annotated[float, "step=5.0", "precision=2"]:
        ...
        ...
    @wave_factor.setter
    def wave_factor(self, value: Annotated[float, "step=5.0", "precision=2"]) -> None:
        ...
    @property
    def wave_clamp(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @wave_clamp.setter
    def wave_clamp(self, value: Annotated[float, "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def use_smudge(self) -> bool:
        ...
        ...
    @use_smudge.setter
    def use_smudge(self, value: bool) -> None:
        ...
    @property
    ...
    def smudge_strength(self, value: Annotated[float, "step=5.0", "precision=2"]) -> None:
        ...
    @property
    def velocity_max(self) -> Annotated[float, "step=5.0", "precision=2"]:
        ...
        ...
    @velocity_max.setter
    def velocity_max(self, value: Annotated[float, "step=5.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def use_velocity_alpha(self, value: bool) -> None:
        ...
    @property
    ...
    def use_velocity_depth(self, value: bool) -> None:
        ...
    @property
    ...
    def use_velocity_color(self, value: bool) -> None:
        ...
    @property
    def paint_source(self) -> Annotated[Literal['PARTICLE_SYSTEM', 'POINT', 'DISTANCE', 'VOLUME_DISTANCE', 'VOLUME'], "is_animatable=False"]:
        ...
        ...
    @paint_source.setter
    def paint_source(self, value: Annotated[Literal['PARTICLE_SYSTEM', 'POINT', 'DISTANCE', 'VOLUME_DISTANCE', 'VOLUME'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def paint_distance(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_proximity_ramp_alpha(self, value: bool) -> None:
        ...
    @property
    ...
    def proximity_falloff(self, value: Annotated[Literal['SMOOTH', 'CONSTANT', 'RAMP'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_proximity_project(self, value: bool) -> None:
        ...
    @property
    ...
    def ray_direction(self, value: Literal['CANVAS', 'BRUSH', 'Z_AXIS']) -> None:
        ...
    @property
    ...
    def invert_proximity(self, value: bool) -> None:
        ...
    @property
    ...
    def use_negative_volume(self, value: bool) -> None:
        ...
    @property
    ...
    def use_particle_radius(self, value: bool) -> None:
        ...
    @property
    def solid_radius(self) -> Annotated[float, "step=5.0", "precision=3"]:
        ...
        ...
    @solid_radius.setter
    def solid_radius(self, value: Annotated[float, "step=5.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def smooth_radius(self, value: Annotated[float, "step=5.0", "precision=-1"]) -> None:
        ...
    @property
