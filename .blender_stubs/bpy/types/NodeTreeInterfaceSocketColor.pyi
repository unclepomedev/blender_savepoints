...
https://docs.blender.org/api/current/bpy.types.NodeTreeInterfaceSocketColor.html
"""
...
Deprecated. Will be remove in 5.0."""
    ...
    def bl_socket_idname(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def default_value(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3", "is_animatable=False"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
