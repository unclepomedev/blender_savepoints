...
class GeometryNodeMergeLayers(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def mode(self) -> Annotated[Literal['MERGE_BY_NAME', 'MERGE_BY_ID'], "is_animatable=False"]:
        """Determines how to choose which layers are merged"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['MERGE_BY_NAME', 'MERGE_BY_ID'], "is_animatable=False"]) -> None:
        ...
