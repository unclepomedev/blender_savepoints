...
https://docs.blender.org/api/current/bpy.types.NodeGeometryCaptureAttributeItem.html
"""
...
class NodeGeometryCaptureAttributeItem(bpy_struct):
    ...
    def data_type(self) -> Annotated[Literal['FLOAT', 'INT', 'BOOLEAN', 'FLOAT_VECTOR', 'FLOAT_COLOR', 'QUATERNION', 'FLOAT4X4', 'STRING', 'INT8', 'INT16_2D', 'INT32_2D', 'FLOAT2', 'BYTE_COLOR'], "is_animatable=False"]:
        ...
        ...
    @data_type.setter
    def data_type(self, value: Annotated[Literal['FLOAT', 'INT', 'BOOLEAN', 'FLOAT_VECTOR', 'FLOAT_COLOR', 'QUATERNION', 'FLOAT4X4', 'STRING', 'INT8', 'INT16_2D', 'INT32_2D', 'FLOAT2', 'BYTE_COLOR'], "is_animatable=False"]) -> None:
        ...