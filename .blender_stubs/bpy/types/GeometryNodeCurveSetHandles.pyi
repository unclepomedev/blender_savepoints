...
https://docs.blender.org/api/current/bpy.types.GeometryNodeCurveSetHandles.html
"""
...
class GeometryNodeCurveSetHandles(GeometryNode):
    ...
    handle_type: Annotated[Literal['FREE', 'AUTO', 'VECTOR', 'ALIGN'], "is_animatable=False"]

    mode: Annotated[set[str], "is_animatable=False"]
