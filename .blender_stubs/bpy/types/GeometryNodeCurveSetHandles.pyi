...
class GeometryNodeCurveSetHandles(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def handle_type(self) -> Annotated[Literal['FREE', 'AUTO', 'VECTOR', 'ALIGN'], "is_animatable=False"]:

        ...
    @handle_type.setter
    def handle_type(self, value: Annotated[Literal['FREE', 'AUTO', 'VECTOR', 'ALIGN'], "is_animatable=False"]) -> None:
        ...
    @property
    def mode(self) -> Annotated[set[str], "is_animatable=False"]:
        """Whether to update left and right handles"""
        ...
    @mode.setter
    def mode(self, value: Annotated[set[str], "is_animatable=False"]) -> None:
        ...
