...
class ShaderNodeNormalMap(ShaderNode):
    ...
    @property
    def space(self) -> Literal['TANGENT', 'OBJECT', 'WORLD', 'BLENDER_OBJECT', 'BLENDER_WORLD']:
        """Space of the input normal"""
        ...
    @space.setter
    def space(self, value: Literal['TANGENT', 'OBJECT', 'WORLD', 'BLENDER_OBJECT', 'BLENDER_WORLD']) -> None:
        ...
    @property
    def uv_map(self) -> Annotated[str, "is_animatable=False"]:
        """UV Map for tangent space maps"""
        ...
    @uv_map.setter
    def uv_map(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
