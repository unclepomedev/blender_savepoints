...
class ShaderNodeTexVoronoi(ShaderNode):
    ...
    def distance(self) -> Literal['EUCLIDEAN', 'MANHATTAN', 'CHEBYCHEV', 'MINKOWSKI']:
        ...
        ...
    @distance.setter
    def distance(self, value: Literal['EUCLIDEAN', 'MANHATTAN', 'CHEBYCHEV', 'MINKOWSKI']):
        ...
    @property
    def feature(self) -> Literal['F1', 'F2', 'SMOOTH_F1', 'DISTANCE_TO_EDGE', 'N_SPHERE_RADIUS']:
        ...
        ...
    @feature.setter
    def feature(self, value: Literal['F1', 'F2', 'SMOOTH_F1', 'DISTANCE_TO_EDGE', 'N_SPHERE_RADIUS']):
        ...
    @property
