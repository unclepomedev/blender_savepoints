...
class MeshDeformModifier(Modifier):
    ...
    def vertex_group(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def precision(self) -> Annotated[int, "step=1"]:
        """The grid size for binding"""
        ...
    @precision.setter
    def precision(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def use_dynamic_bind(self) -> bool:
        """Recompute binding dynamically on top of other deformers (slower and more memory consuming)"""
        ...
    @use_dynamic_bind.setter
    def use_dynamic_bind(self, value: bool) -> None:
        ...