...
class GeometryNodeSortElements(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE', 'INSTANCE'], "is_animatable=False"]:

        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE', 'INSTANCE'], "is_animatable=False"]) -> None:
        ...
