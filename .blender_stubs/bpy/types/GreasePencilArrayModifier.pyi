...
class GreasePencilArrayModifier(Modifier):
    ...
    constant_offset: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]
    """Value for the distance between items"""
    relative_offset: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """The size of the geometry will determine the distance between arrayed items"""
    random_offset: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """Value for changes in location"""
    random_rotation: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=100.0", "precision=5"]
    """Value for changes in rotation"""
    random_scale: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """Value for changes in scale"""
    seed: Annotated[int, "subtype='UNSIGNED'", "step=1"]
    """Random seed"""
    replace_material: Annotated[int, "step=1"]
