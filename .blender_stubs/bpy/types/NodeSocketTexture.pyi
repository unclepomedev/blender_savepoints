...
https://docs.blender.org/api/current/bpy.types.NodeSocketTexture.html
"""
...
class NodeSocketTexture(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[Optional['Texture'], "is_animatable=False"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[Optional['Texture'], "is_animatable=False"]) -> None:
        ...
