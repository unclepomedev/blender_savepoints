...
class ShaderNodeTexImage(ShaderNode):
    ...
    def interpolation(self, value: Literal['Linear', 'Closest', 'Cubic', 'Smart']) -> None:
        ...
    @property
    def projection_blend(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """For box projection, amount of blend to use between sides"""
        ...
    @projection_blend.setter
    def projection_blend(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
