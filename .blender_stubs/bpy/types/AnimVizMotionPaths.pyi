...
class AnimVizMotionPaths(bpy_struct):
    ...
    def type(self) -> Literal['CURRENT_FRAME', 'RANGE']:
        ...
        ...
    @type.setter
    def type(self, value: Literal['CURRENT_FRAME', 'RANGE']):
        ...
    @property
    def range(self) -> Literal['KEYS_ALL', 'KEYS_SELECTED', 'SCENE', 'MANUAL']:
        ...
        ...
    @range.setter
    def range(self, value: Literal['KEYS_ALL', 'KEYS_SELECTED', 'SCENE', 'MANUAL']):
        ...
    @property
    ...
    def bake_location(self, value: Literal['HEADS', 'TAILS']):
        ...
    @property
    ...
    def show_frame_numbers(self, value: bool):
        ...
    @property
    ...
    def show_keyframe_highlight(self, value: bool):
        ...
    @property
    ...
    def show_keyframe_numbers(self, value: bool):
        ...
    @property
    ...
    def show_keyframe_action_all(self, value: bool):
        ...
    @property
    ...
    def frame_before(self) -> Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]:
        ...
        ...
    @frame_before.setter
    def frame_before(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    def frame_after(self) -> Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]:
        ...
        ...
    @frame_after.setter
    def frame_after(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def use_camera_space_bake(self, value: bool):
        ...