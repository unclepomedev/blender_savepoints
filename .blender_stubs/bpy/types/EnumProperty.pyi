...
class EnumProperty(Property):
    ...
    def tags(self) -> set[str]:
        ...
        ...
    @property
    def default(self) -> Literal['DEFAULT']:
        """Default value for this enum"""
        ...
    @property
    def default_flag(self) -> set[str]:
        """Default value for this enum"""
        ...
    @property
    def enum_items(self) -> Annotated[bpy_prop_collection['EnumPropertyItem'], "is_animatable=False"]:
        """Possible values for the property"""
        ...
    @property
    def enum_items_static(self) -> Annotated[bpy_prop_collection['EnumPropertyItem'], "is_animatable=False"]:
        """Possible values for the property (never calls optional dynamic generation of those)"""
        ...
    @property
    def enum_items_static_ui(self) -> Annotated[bpy_prop_collection['EnumPropertyItem'], "is_animatable=False"]:
