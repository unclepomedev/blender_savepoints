...
class SpotLight(Light):
    ...
    def use_square(self) -> bool:
        ...
        ...
    @use_square.setter
    def use_square(self, value: bool):
        ...
    @property
    def spot_blend(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @spot_blend.setter
    def spot_blend(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def spot_size(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @spot_size.setter
    def spot_size(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_soft_falloff(self, value: bool):
        ...
