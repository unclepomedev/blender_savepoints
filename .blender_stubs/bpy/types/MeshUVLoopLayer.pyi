...
class MeshUVLoopLayer(bpy_struct):
    ...
    def active(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @active.setter
    def active(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def active_render(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def active_clone(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @active_clone.setter
    def active_clone(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
