...
class MarbleTexture(Texture):
    ...
    def turbulence(self) -> Annotated[float, "step=10.0", "precision=2"]:
        ...
        ...
    @turbulence.setter
    def turbulence(self, value: Annotated[float, "step=10.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def noise_type(self, value: Literal['SOFT_NOISE', 'HARD_NOISE']) -> None:
        ...
    @property
    def marble_type(self) -> Literal['SOFT', 'SHARP', 'SHARPER']:

        ...
    @marble_type.setter
    def marble_type(self, value: Literal['SOFT', 'SHARP', 'SHARPER']) -> None:
        ...
    @property
    ...
    def noise_basis_2(self, value: Literal['SIN', 'SAW', 'TRI']) -> None:
        ...
    @property
