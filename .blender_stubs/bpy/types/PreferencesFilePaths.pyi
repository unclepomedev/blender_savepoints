...
class PreferencesFilePaths(bpy_struct):
    ...
    def show_hidden_files_datablocks(self, value: bool):
        ...
    @property
    ...
    def use_filter_files(self, value: bool):
        ...
    @property
    ...
    def show_recent_locations(self, value: bool):
        ...
    @property
    ...
    def show_system_bookmarks(self, value: bool):
        ...
    @property
    ...
    def use_relative_paths(self, value: bool):
        ...
    @property
    ...
    def use_file_compression(self, value: bool):
        ...
    @property
    def use_load_ui(self) -> bool:
        ...
        ...
    @use_load_ui.setter
    def use_load_ui(self, value: bool):
        ...
    @property
    ...
    def use_scripts_auto_execute(self, value: bool):
        ...
    @property
    ...
    def use_tabs_as_spaces(self, value: bool):
        ...
    @property
    ...
    def use_extension_online_access_handled(self, value: bool):
        ...
    @property
    ...
    def font_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def texture_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def render_output_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def i18n_branches_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def sound_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def temporary_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def render_cache_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    def image_editor(self) -> Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]:
        ...
        ...
    @image_editor.setter
    def image_editor(self, value: Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]):
        ...
    @property
...
Use the internal editor when left blank"""
        ...
    @text_editor.setter
    def text_editor(self, value: Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]):
        ...
    @property
...
Example: -f $filepath -l $line -c $column"""
    ...
    def text_editor_args(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def animation_player(self, value: Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def animation_player_preset(self, value: Literal['INTERNAL', 'DJV', 'FRAMECYCLER', 'RV', 'MPLAYER', 'CUSTOM']):
        ...
    @property
    def save_version(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @save_version.setter
    def save_version(self, value: Annotated[int, "step=1"]):
        ...
    @property
...
Warning: Sculpt and edit mode data won't be saved"""
    ...
    def use_auto_save_temporary_files(self, value: bool):
        ...
    @property
    ...
    def auto_save_time(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def recent_files(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @recent_files.setter
    def recent_files(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def file_preview_type(self, value: Literal['NONE', 'AUTO', 'SCREENSHOT', 'CAMERA']):
        ...
    @property
    ...
    def active_asset_library(self, value: Annotated[int, "step=1"]):
        ...