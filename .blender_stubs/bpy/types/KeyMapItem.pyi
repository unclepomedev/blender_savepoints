...
class KeyMapItem(bpy_struct):
    ...
    def map_type(self) -> Literal['KEYBOARD', 'MOUSE', 'NDOF', 'TEXTINPUT', 'TIMER']:
        ...
        ...
    @map_type.setter
    def map_type(self, value: Literal['KEYBOARD', 'MOUSE', 'NDOF', 'TEXTINPUT', 'TIMER']):
        ...
    @property
    ...
    def value(self) -> Literal['ANY', 'PRESS', 'RELEASE', 'CLICK', 'DOUBLE_CLICK', 'CLICK_DRAG', 'NOTHING']:
        ...
        ...
    @value.setter
    def value(self, value: Literal['ANY', 'PRESS', 'RELEASE', 'CLICK', 'DOUBLE_CLICK', 'CLICK_DRAG', 'NOTHING']):
        ...
    @property
    def direction(self) -> Literal['ANY', 'NORTH', 'NORTH_EAST', 'EAST', 'SOUTH_EAST', 'SOUTH', 'SOUTH_WEST', 'WEST', 'NORTH_WEST']:
        ...
        ...
    @direction.setter
    def direction(self, value: Literal['ANY', 'NORTH', 'NORTH_EAST', 'EAST', 'SOUTH_EAST', 'SOUTH', 'SOUTH_WEST', 'WEST', 'NORTH_WEST']):
        ...
    @property
    ...
    def shift(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @shift.setter
    def shift(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def ctrl(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @ctrl.setter
    def ctrl(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def alt(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @alt.setter
    def alt(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def oskey(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @oskey.setter
    def oskey(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def hyper(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @hyper.setter
    def hyper(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def propvalue(self) -> Literal['NONE']:
        ...
        ...
    @propvalue.setter
    def propvalue(self, value: Literal['NONE']):
        ...
    @property
