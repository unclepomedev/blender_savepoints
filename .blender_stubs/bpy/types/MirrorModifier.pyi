...
class MirrorModifier(Modifier):
    ...
    def use_axis(self) -> list[bool]:
        ...
        ...
    @use_axis.setter
    def use_axis(self, value: list[bool]):
        ...
    @property
    ...
    def use_bisect_axis(self, value: list[bool]):
        ...
    @property
    ...
    def use_bisect_flip_axis(self, value: list[bool]):
        ...
    @property
    ...
    def use_mirror_vertex_groups(self, value: bool):
        ...
    @property
    ...
    def use_mirror_merge(self, value: bool):
        ...
    @property
    def use_mirror_u(self) -> bool:
        ...
        ...
    @use_mirror_u.setter
    def use_mirror_u(self, value: bool):
        ...
    @property
    def use_mirror_v(self) -> bool:
        ...
        ...
    @use_mirror_v.setter
    def use_mirror_v(self, value: bool):
        ...
    @property
    ...
    def use_mirror_udim(self, value: bool):
        ...
    @property
    ...
    def mirror_offset_u(self, value: Annotated[float, "subtype='FACTOR'", "step=2.0", "precision=4"]):
        ...
    @property
    ...
    def mirror_offset_v(self, value: Annotated[float, "subtype='FACTOR'", "step=2.0", "precision=4"]):
        ...
    @property
    ...
    def merge_threshold(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=6"]):
        ...
    @property
    ...
    def bisect_threshold(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=6"]):
        ...
    @property
    ...
    def mirror_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...