...
class VertexWeightMixModifier(Modifier):
    ...
    def vertex_group_a(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def vertex_group_b(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def invert_vertex_group_a(self, value: bool):
        ...
    @property
    ...
    def invert_vertex_group_b(self, value: bool):
        ...
    @property
    ...
    def default_weight_a(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=-1"]):
        ...
    @property
    ...
    def default_weight_b(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=-1"]):
        ...
    @property
    def mix_mode(self) -> Literal['SET', 'ADD', 'SUB', 'MUL', 'DIV', 'DIF', 'AVG', 'MIN', 'MAX']:
        ...
        ...
    @mix_mode.setter
    def mix_mode(self, value: Literal['SET', 'ADD', 'SUB', 'MUL', 'DIV', 'DIF', 'AVG', 'MIN', 'MAX']):
        ...
    @property
    def mix_set(self) -> Literal['ALL', 'A', 'B', 'OR', 'AND']:
        ...
        ...
    @mix_set.setter
    def mix_set(self, value: Literal['ALL', 'A', 'B', 'OR', 'AND']):
        ...
    @property
