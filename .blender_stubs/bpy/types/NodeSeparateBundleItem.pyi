...
https://docs.blender.org/api/current/bpy.types.NodeSeparateBundleItem.html
"""
...
class NodeSeparateBundleItem(bpy_struct):
    ...
    def structure_type(self, value: Literal['AUTO', 'DYNAMIC', 'FIELD', 'GRID', 'LIST', 'SINGLE']) -> None:
        ...