...
https://docs.blender.org/api/current/bpy.types.FunctionNodeFormatString.html
"""
...
class FunctionNodeFormatString(FunctionNode):
    ...
    @property
    def format_items(self) -> Annotated['NodeFunctionFormatStringItems', "is_animatable=False"]:
