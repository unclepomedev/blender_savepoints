...
class MovieTrackingObjectPlaneTracks(bpy_struct):
    ...
    @property
    def active(self) -> Annotated[Optional['MovieTrackingTrack'], "is_animatable=False"]:
        """Active track in this tracking data object"""
        ...
    @active.setter
    def active(self, value: Annotated[Optional['MovieTrackingTrack'], "is_animatable=False"]) -> None:
        ...
