...
class VoronoiTexture(Texture):
    ...
    def weight_1(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @weight_1.setter
    def weight_1(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def weight_2(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @weight_2.setter
    def weight_2(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def weight_3(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @weight_3.setter
    def weight_3(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def weight_4(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @weight_4.setter
    def weight_4(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def minkovsky_exponent(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def distance_metric(self, value: Literal['DISTANCE', 'DISTANCE_SQUARED', 'MANHATTAN', 'CHEBYCHEV', 'MINKOVSKY_HALF', 'MINKOVSKY_FOUR', 'MINKOVSKY']):
        ...
    @property
    def color_mode(self) -> Literal['INTENSITY', 'POSITION', 'POSITION_OUTLINE', 'POSITION_OUTLINE_INTENSITY']:
        ...
        ...
    @color_mode.setter
    def color_mode(self, value: Literal['INTENSITY', 'POSITION', 'POSITION_OUTLINE', 'POSITION_OUTLINE_INTENSITY']):
        ...
    @property
    ...
    def noise_intensity(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
