...
class VoronoiTexture(Texture):
    ...
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    @property
    def weight_1(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Voronoi feature weight 1"""
        ...
    @weight_1.setter
    def weight_1(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def weight_2(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Voronoi feature weight 2"""
        ...
    @weight_2.setter
    def weight_2(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def weight_3(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Voronoi feature weight 3"""
        ...
    @weight_3.setter
    def weight_3(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def weight_4(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Voronoi feature weight 4"""
        ...
    @weight_4.setter
    def weight_4(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def minkovsky_exponent(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Minkowski exponent"""
        ...
    @minkovsky_exponent.setter
    def minkovsky_exponent(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def distance_metric(self) -> Literal['DISTANCE', 'DISTANCE_SQUARED', 'MANHATTAN', 'CHEBYCHEV', 'MINKOVSKY_HALF', 'MINKOVSKY_FOUR', 'MINKOVSKY']:
        """Algorithm used to calculate distance of sample points to feature points"""
        ...
    @distance_metric.setter
    def distance_metric(self, value: Literal['DISTANCE', 'DISTANCE_SQUARED', 'MANHATTAN', 'CHEBYCHEV', 'MINKOVSKY_HALF', 'MINKOVSKY_FOUR', 'MINKOVSKY']) -> None:
        ...
    @property
    def color_mode(self) -> Literal['INTENSITY', 'POSITION', 'POSITION_OUTLINE', 'POSITION_OUTLINE_INTENSITY']:

        ...
    @color_mode.setter
    def color_mode(self, value: Literal['INTENSITY', 'POSITION', 'POSITION_OUTLINE', 'POSITION_OUTLINE_INTENSITY']) -> None:
        ...
    @property
    def noise_intensity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Scales the intensity of the noise"""
        ...
    @noise_intensity.setter
    def noise_intensity(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
