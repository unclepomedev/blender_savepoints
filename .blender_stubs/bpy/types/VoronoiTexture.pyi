...
class VoronoiTexture(Texture):
    ...
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    weight_1: Annotated[float, "step=10.0", "precision=3"]
    """Voronoi feature weight 1"""
    weight_2: Annotated[float, "step=10.0", "precision=3"]
    """Voronoi feature weight 2"""
    weight_3: Annotated[float, "step=10.0", "precision=3"]
    """Voronoi feature weight 3"""
    weight_4: Annotated[float, "step=10.0", "precision=3"]
    """Voronoi feature weight 4"""
    minkovsky_exponent: Annotated[float, "step=10.0", "precision=3"]
    """Minkowski exponent"""
    distance_metric: Literal['DISTANCE', 'DISTANCE_SQUARED', 'MANHATTAN', 'CHEBYCHEV', 'MINKOVSKY_HALF', 'MINKOVSKY_FOUR', 'MINKOVSKY']
    """Algorithm used to calculate distance of sample points to feature points"""
    color_mode: Literal['INTENSITY', 'POSITION', 'POSITION_OUTLINE', 'POSITION_OUTLINE_INTENSITY']
    noise_intensity: Annotated[float, "step=10.0", "precision=3"]
