...
class ParticleInstanceModifier(Modifier):
    ...
    def particle_system_index(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def space(self) -> Literal['LOCAL', 'WORLD']:
        ...
        ...
    @space.setter
    def space(self, value: Literal['LOCAL', 'WORLD']) -> None:
        ...
    @property
    ...
    def use_children(self) -> bool:
        ...
        ...
    @use_children.setter
    def use_children(self, value: bool) -> None:
        ...
    @property
    ...
    def show_alive(self) -> bool:
        ...
        ...
    @show_alive.setter
    def show_alive(self, value: bool) -> None:
        ...
    @property
    def show_dead(self) -> bool:
        ...
        ...
    @show_dead.setter
    def show_dead(self, value: bool) -> None:
        ...
    @property
    ...
    def use_preserve_shape(self, value: bool) -> None:
        ...
    @property
    ...
    def position(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @position.setter
    def position(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def random_position(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def rotation(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @rotation.setter
    def rotation(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def random_rotation(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def particle_amount(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def particle_offset(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def index_layer_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def value_layer_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...