...
class ParticleInstanceModifier(Modifier):
    ...
    particle_system_index: Annotated[int, "step=1"]
    ...
    position: Annotated[float, "step=10.0", "precision=3"]
    """Position along path"""
    random_position: Annotated[float, "step=10.0", "precision=3"]
    """Randomize position along path"""
    rotation: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Rotation around path"""
    random_rotation: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Randomize rotation around path"""
    particle_amount: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Amount of particles to use for instancing"""
    particle_offset: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Relative offset of particles to use for instancing, to avoid overlap of multiple instances"""
    index_layer_name: Annotated[str, "is_animatable=False"]
    """Custom data layer name for the index"""
    value_layer_name: Annotated[str, "is_animatable=False"]
