...
class MeshCacheModifier(Modifier):
    ...
    def cache_format(self) -> Literal['MDD', 'PC2']:
        ...
        ...
    @cache_format.setter
    def cache_format(self, value: Literal['MDD', 'PC2']) -> None:
        ...
    @property
    ...
    def interpolation(self, value: Literal['NONE', 'LINEAR']) -> None:
        ...
    @property
    def time_mode(self) -> Literal['FRAME', 'TIME', 'FACTOR']:
        ...
        ...
    @time_mode.setter
    def time_mode(self, value: Literal['FRAME', 'TIME', 'FACTOR']) -> None:
        ...
    @property
    def play_mode(self) -> Literal['SCENE', 'CUSTOM']:
        ...
        ...
    @play_mode.setter
    def play_mode(self, value: Literal['SCENE', 'CUSTOM']) -> None:
        ...
    @property
    def deform_mode(self) -> Literal['OVERWRITE', 'INTEGRATE']:
        ...
        ...
    @deform_mode.setter
    def deform_mode(self, value: Literal['OVERWRITE', 'INTEGRATE']) -> None:
        ...
    @property
    ...
    def flip_axis(self) -> list[bool]:
        ...
        ...
    @flip_axis.setter
    def flip_axis(self, value: list[bool]) -> None:
        ...
    @property
    ...
    def eval_frame(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @eval_frame.setter
    def eval_frame(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def eval_time(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @eval_time.setter
    def eval_time(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def eval_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @eval_factor.setter
    def eval_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...