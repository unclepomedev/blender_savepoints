...
class ClothModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def settings(self) -> Annotated['ClothSettings', "is_animatable=False"]:

        ...
    @property
    def collision_settings(self) -> Annotated['ClothCollisionSettings', "is_animatable=False"]:

        ...
    @property
    def solver_result(self) -> Annotated[Optional['ClothSolverResult'], "is_animatable=False"]:
    ...
    def point_cache(self) -> Annotated['PointCache', "is_animatable=False"]:
        ...
        ...
    @property
    def hair_grid_min(self) -> Annotated[list[float], "step=10.0", "precision=3"]:

        ...
    @property
    def hair_grid_max(self) -> Annotated[list[float], "step=10.0", "precision=3"]:

        ...
    @property
    def hair_grid_resolution(self) -> Annotated[list[int], "step=1"]:
