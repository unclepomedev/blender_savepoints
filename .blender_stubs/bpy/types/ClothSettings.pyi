...
class ClothSettings(bpy_struct):
    ...
    def goal_default(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @goal_default.setter
    def goal_default(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def internal_friction(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def collider_friction(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def density_target(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def density_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def air_damping(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @air_damping.setter
    def air_damping(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def pin_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def quality(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @quality.setter
    def quality(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def vertex_group_shrink(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def shrink_min(self) -> Annotated[float, "subtype='FACTOR'", "step=0.05000000074505806", "precision=3"]:
        ...
        ...
    @shrink_min.setter
    def shrink_min(self, value: Annotated[float, "subtype='FACTOR'", "step=0.05000000074505806", "precision=3"]) -> None:
        ...
    @property
    def shrink_max(self) -> Annotated[float, "subtype='FACTOR'", "step=0.05000000074505806", "precision=3"]:
        ...
        ...
    @shrink_max.setter
    def shrink_max(self, value: Annotated[float, "subtype='FACTOR'", "step=0.05000000074505806", "precision=3"]) -> None:
        ...
    @property
    ...
    def voxel_cell_size(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def tension_damping(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def compression_damping(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shear_damping(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def tension_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def tension_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def compression_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def compression_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shear_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shear_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def sewing_force_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def vertex_group_structural_stiffness(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def vertex_group_shear_stiffness(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bending_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def bending_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def bending_damping(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_sewing_springs(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def vertex_group_bending(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def rest_shape_key(self, value: Annotated[Optional['ShapeKey'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_dynamic_mesh(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bending_model(self, value: Annotated[Literal['ANGULAR', 'LINEAR'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_internal_springs(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def internal_spring_normal_check(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def internal_spring_max_length(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def internal_spring_max_diversion(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def internal_tension_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def internal_tension_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def internal_compression_stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def internal_compression_stiffness_max(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def vertex_group_intern(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pressure_volume(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def uniform_pressure_force(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def target_volume(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def pressure_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def fluid_density(self, value: Annotated[float, "step=0.05000000074505806", "precision=4"]) -> None:
        ...
    @property
    ...
    def vertex_group_pressure(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...