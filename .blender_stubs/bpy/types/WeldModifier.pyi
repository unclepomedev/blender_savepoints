...
class WeldModifier(Modifier):
    ...
    def mode(self) -> Literal['ALL', 'CONNECTED']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['ALL', 'CONNECTED']) -> None:
        ...
    @property
    ...
    def merge_threshold(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=6"]) -> None:
        ...
    @property
    ...
    def loose_edges(self) -> bool:
        ...
        ...
    @loose_edges.setter
    def loose_edges(self, value: bool) -> None:
        ...