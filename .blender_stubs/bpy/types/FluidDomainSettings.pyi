...
class FluidDomainSettings(bpy_struct):
    ...
    def effector_group(self, value: Annotated[Optional['Collection'], "is_animatable=False"]):
        ...
    @property
    def fluid_group(self) -> Annotated[Optional['Collection'], "is_animatable=False"]:
        ...
        ...
    @fluid_group.setter
    def fluid_group(self, value: Annotated[Optional['Collection'], "is_animatable=False"]):
        ...
    @property
    ...
    def force_collection(self, value: Annotated[Optional['Collection'], "is_animatable=False"]):
        ...
    @property
    ...
    def additional_res(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def adapt_margin(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @adapt_margin.setter
    def adapt_margin(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def adapt_threshold(self, value: Annotated[float, "step=0.0020000000949949026", "precision=6"]):
        ...
    @property
    ...
    def use_adaptive_domain(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def resolution_max(self, value: Annotated[int, "step=2", "is_animatable=False"]):
        ...
    @property
    ...
    def use_collision_border_front(self, value: bool):
        ...
    @property
    ...
    def use_collision_border_back(self, value: bool):
        ...
    @property
    ...
    def use_collision_border_right(self, value: bool):
        ...
    @property
    ...
    def use_collision_border_left(self, value: bool):
        ...
    @property
    ...
    def use_collision_border_top(self, value: bool):
        ...
    @property
    ...
    def use_collision_border_bottom(self, value: bool):
        ...
    @property
    ...
    def domain_type(self) -> Annotated[Literal['GAS', 'LIQUID'], "is_animatable=False"]:
        ...
        ...
    @domain_type.setter
    def domain_type(self, value: Annotated[Literal['GAS', 'LIQUID'], "is_animatable=False"]):
        ...
    @property
    ...
    def delete_in_obstacle(self, value: bool):
        ...
    @property
    def alpha(self) -> Annotated[float, "step=0.019999999552965164", "precision=5"]:
        ...
        ...
    @alpha.setter
    def alpha(self, value: Annotated[float, "step=0.019999999552965164", "precision=5"]):
        ...
    @property
    def beta(self) -> Annotated[float, "step=0.019999999552965164", "precision=5"]:
        ...
        ...
    @beta.setter
    def beta(self, value: Annotated[float, "step=0.019999999552965164", "precision=5"]):
        ...
    @property
    ...
    def dissolve_speed(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def vorticity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @vorticity.setter
    def vorticity(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def highres_sampling(self, value: Literal['FULLSAMPLE', 'LINEAR', 'NEAREST']):
        ...
    @property
    ...
    def use_dissolve_smoke(self, value: bool):
        ...
    @property
    ...
    def use_dissolve_smoke_log(self, value: bool):
        ...
    @property
    def burning_rate(self) -> Annotated[float, "step=1.0", "precision=5"]:
        ...
        ...
    @burning_rate.setter
    def burning_rate(self, value: Annotated[float, "step=1.0", "precision=5"]):
        ...
    @property
    def flame_smoke(self) -> Annotated[float, "step=1.0", "precision=5"]:
        ...
        ...
    @flame_smoke.setter
    def flame_smoke(self, value: Annotated[float, "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def flame_vorticity(self, value: Annotated[float, "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def flame_ignition(self, value: Annotated[float, "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def flame_max_temp(self, value: Annotated[float, "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def flame_smoke_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def noise_strength(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def noise_pos_scale(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def noise_time_anim(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def noise_scale(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @noise_scale.setter
    def noise_scale(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def use_noise(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_noise.setter
    def use_noise(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def simulation_method(self, value: Annotated[Literal['FLIP', 'APIC'], "is_animatable=False"]):
        ...
    @property
    def flip_ratio(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @flip_ratio.setter
    def flip_ratio(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def particle_randomness(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def particle_number(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def particle_min(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @particle_min.setter
    def particle_min(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def particle_max(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @particle_max.setter
    def particle_max(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def particle_radius(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def particle_band_width(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_flip_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_fractions(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def fractions_threshold(self, value: Annotated[float, "step=0.05000000074505806", "precision=-1"]):
        ...
    @property
    ...
    def fractions_distance(self, value: Annotated[float, "step=0.10000000149011612", "precision=-1"]):
        ...
    @property
    ...
    def sys_particle_maximum(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_viscosity(self, value: bool):
        ...
    @property
    ...
    def viscosity_value(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def use_diffusion(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def surface_tension(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def viscosity_base(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def viscosity_exponent(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def mesh_concave_upper(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def mesh_concave_lower(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def mesh_smoothen_pos(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def mesh_smoothen_neg(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def mesh_scale(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @mesh_scale.setter
    def mesh_scale(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def mesh_generator(self, value: Literal['IMPROVED', 'UNION']):
        ...
    @property
    def use_mesh(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_mesh.setter
    def use_mesh(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_speed_vectors(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def mesh_particle_radius(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_min_wavecrest(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_max_wavecrest(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_min_trappedair(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_max_trappedair(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_min_energy(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_potential_max_energy(self, value: Annotated[float, "step=100.0", "precision=3"]):
        ...
    @property
    ...
    def sndparticle_sampling_wavecrest(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def sndparticle_sampling_trappedair(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def sndparticle_bubble_buoyancy(self, value: Annotated[float, "step=10.0", "precision=2"]):
        ...
    @property
    ...
    def sndparticle_bubble_drag(self, value: Annotated[float, "step=10.0", "precision=2"]):
        ...
    @property
    ...
    def sndparticle_life_min(self, value: Annotated[float, "step=100.0", "precision=1"]):
        ...
    @property
    ...
    def sndparticle_life_max(self, value: Annotated[float, "step=100.0", "precision=1"]):
        ...
    @property
    ...
    def sndparticle_boundary(self, value: Literal['DELETE', 'PUSHOUT']):
        ...
    @property
    ...
    def sndparticle_combined_export(self, value: Literal['OFF', 'SPRAY_FOAM', 'SPRAY_BUBBLES', 'FOAM_BUBBLES', 'SPRAY_FOAM_BUBBLES']):
        ...
    @property
    ...
    def sndparticle_potential_radius(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def sndparticle_update_radius(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def particle_scale(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def use_spray_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_bubble_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_foam_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_tracer_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def guide_alpha(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @guide_alpha.setter
    def guide_alpha(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def guide_beta(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @guide_beta.setter
    def guide_beta(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def guide_vel_factor(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def guide_source(self) -> Literal['DOMAIN', 'EFFECTOR']:
        ...
        ...
    @guide_source.setter
    def guide_source(self, value: Literal['DOMAIN', 'EFFECTOR']):
        ...
    @property
    def guide_parent(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @guide_parent.setter
    def guide_parent(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def cache_frame_start(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def cache_frame_end(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def cache_frame_offset(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def cache_frame_pause_data(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def cache_frame_pause_noise(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def cache_frame_pause_mesh(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def cache_frame_pause_particles(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def cache_frame_pause_guide(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=1"]):
        ...
    @property
    ...
    def cache_mesh_format(self, value: Annotated[Literal['UNI', 'OPENVDB', 'RAW'], "is_animatable=False"]):
        ...
    @property
    ...
    def cache_data_format(self, value: Annotated[Literal['UNI', 'OPENVDB', 'RAW'], "is_animatable=False"]):
        ...
    @property
    ...
    def cache_particle_format(self, value: Annotated[Literal['UNI', 'OPENVDB', 'RAW'], "is_animatable=False"]):
        ...
    @property
    ...
    def cache_noise_format(self, value: Annotated[Literal['UNI', 'OPENVDB', 'RAW'], "is_animatable=False"]):
        ...
    @property
    def cache_type(self) -> Annotated[Literal['REPLAY', 'MODULAR', 'ALL'], "is_animatable=False"]:
        ...
        ...
    @cache_type.setter
    def cache_type(self, value: Annotated[Literal['REPLAY', 'MODULAR', 'ALL'], "is_animatable=False"]):
        ...
    @property
    ...
    def cache_resumable(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def cache_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def is_cache_baking_data(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_data(self, value: bool):
        ...
    @property
    ...
    def is_cache_baking_noise(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_noise(self, value: bool):
        ...
    @property
    ...
    def is_cache_baking_mesh(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_mesh(self, value: bool):
        ...
    @property
    ...
    def is_cache_baking_particles(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_particles(self, value: bool):
        ...
    @property
    ...
    def is_cache_baking_guide(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_guide(self, value: bool):
        ...
    @property
    ...
    def is_cache_baking_any(self, value: bool):
        ...
    @property
    ...
    def has_cache_baked_any(self, value: bool):
        ...
    @property
    ...
    def export_manta_script(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def openvdb_cache_compress_type(self, value: Literal['ZIP', 'NONE']):
        ...
    @property
    ...
    def openvdb_data_depth(self, value: Literal['NONE']):
        ...
    @property
    ...
    def use_adaptive_timesteps(self, value: bool):
        ...
    @property
    ...
    def cfl_condition(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def timesteps_min(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def timesteps_max(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def slice_per_voxel(self, value: Annotated[float, "step=0.10000000149011612", "precision=1"]):
        ...
    @property
    ...
    def display_thickness(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def display_interpolation(self, value: Literal['LINEAR', 'CUBIC', 'CLOSEST']):
        ...
    @property
    ...
    def vector_display_type(self, value: Literal['NEEDLE', 'STREAMLINE', 'MAC']):
        ...
    @property
    def vector_field(self) -> Literal['FLUID_VELOCITY', 'GUIDE_VELOCITY', 'FORCE']:
        ...
        ...
    @vector_field.setter
    def vector_field(self, value: Literal['FLUID_VELOCITY', 'GUIDE_VELOCITY', 'FORCE']):
        ...
    @property
    ...
    def vector_scale_with_magnitude(self, value: bool):
        ...
    @property
    ...
    def vector_show_mac_x(self, value: bool):
        ...
    @property
    ...
    def vector_show_mac_y(self, value: bool):
        ...
    @property
    ...
    def vector_show_mac_z(self, value: bool):
        ...
    @property
    def vector_scale(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @vector_scale.setter
    def vector_scale(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def color_ramp_field(self, value: Literal['NONE']):
        ...
    @property
    ...
    def color_ramp_field_scale(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def clipping(self) -> Annotated[float, "step=0.10000000149011612", "precision=6"]:
        ...
        ...
    @clipping.setter
    def clipping(self, value: Annotated[float, "step=0.10000000149011612", "precision=6"]):
        ...
    @property
    ...
    def gridlines_color_field(self, value: Literal['NONE', 'FLAGS', 'RANGE']):
        ...
    @property
    ...
    def gridlines_lower_bound(self, value: Annotated[float, "step=0.10000000149011612", "precision=6"]):
        ...
    @property
    ...
    def gridlines_upper_bound(self, value: Annotated[float, "step=0.10000000149011612", "precision=6"]):
        ...
    @property
    ...
    def gridlines_range_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def gridlines_cell_filter(self, value: Literal['NONE', 'FLUID', 'OBSTACLE', 'EMPTY', 'INFLOW', 'OUTFLOW']):
        ...
    @property
