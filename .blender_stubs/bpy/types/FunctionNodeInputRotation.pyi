...
https://docs.blender.org/api/current/bpy.types.FunctionNodeInputRotation.html
"""
...
class FunctionNodeInputRotation(FunctionNode):
    ...
    rotation_euler: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=10.0", "precision=3"]
