...
class FunctionNodeInputRotation(FunctionNode):
    ...
    @property
    def rotation_euler(self) -> Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @rotation_euler.setter
    def rotation_euler(self, value: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
