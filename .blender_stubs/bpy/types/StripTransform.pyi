...
class StripTransform(bpy_struct):
    ...
    def scale_x(self) -> Annotated[float, "subtype='UNSIGNED'", "step=3.0", "precision=3"]:
        ...
        ...
    @scale_x.setter
    def scale_x(self, value: Annotated[float, "subtype='UNSIGNED'", "step=3.0", "precision=3"]) -> None:
        ...
    @property
    def scale_y(self) -> Annotated[float, "subtype='UNSIGNED'", "step=3.0", "precision=3"]:
        ...
        ...
    @scale_y.setter
    def scale_y(self, value: Annotated[float, "subtype='UNSIGNED'", "step=3.0", "precision=3"]) -> None:
        ...
    @property
    def offset_x(self) -> Annotated[float, "subtype='PIXEL'", "step=100.0", "precision=3"]:
        ...
        ...
    @offset_x.setter
    def offset_x(self, value: Annotated[float, "subtype='PIXEL'", "step=100.0", "precision=3"]) -> None:
        ...
    @property
    def offset_y(self) -> Annotated[float, "subtype='PIXEL'", "step=100.0", "precision=3"]:
        ...
        ...
    @offset_y.setter
    def offset_y(self, value: Annotated[float, "subtype='PIXEL'", "step=100.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def origin(self) -> Annotated[list[float], "step=1.0", "precision=3"]:
        ...
        ...
    @origin.setter
    def origin(self, value: Annotated[list[float], "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def filter(self) -> Literal['AUTO', 'NEAREST', 'BILINEAR', 'CUBIC_MITCHELL', 'CUBIC_BSPLINE', 'BOX']:
        ...
        ...
    @filter.setter
    def filter(self, value: Literal['AUTO', 'NEAREST', 'BILINEAR', 'CUBIC_MITCHELL', 'CUBIC_BSPLINE', 'BOX']) -> None:
        ...