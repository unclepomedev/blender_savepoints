...
class RigidBodyWorld(bpy_struct):
    ...
    def constraints(self) -> Annotated[Optional['Collection'], "is_animatable=False"]:
        ...
        ...
    @constraints.setter
    def constraints(self, value: Annotated[Optional['Collection'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def time_scale(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @time_scale.setter
    def time_scale(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def substeps_per_frame(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_split_impulse(self, value: bool) -> None:
        ...
    @property
