...
class RegionView3D(bpy_struct):
    ...
    def show_sync_view(self, value: bool) -> None:
        ...
    @property
    def use_box_clip(self) -> bool:
        ...
        ...
    @use_box_clip.setter
    def use_box_clip(self, value: bool) -> None:
        ...
    @property
    ...
    def view_matrix(self) -> Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3"]:
        ...
        ...
    @view_matrix.setter
    def view_matrix(self, value: Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def view_perspective(self, value: Literal['PERSP', 'ORTHO', 'CAMERA']) -> None:
        ...
    @property
    ...
    def is_perspective(self, value: bool) -> None:
        ...
    @property
    ...
    def is_orthographic_side_view(self, value: bool) -> None:
        ...
    @property
    ...
    def use_clip_planes(self, value: bool) -> None:
        ...
    @property
    def clip_planes(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        ...
        ...
    @clip_planes.setter
    def clip_planes(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def view_location(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=10.0", "precision=5"]) -> None:
        ...
    @property
    ...
    def view_rotation(self, value: Annotated[list[float], "subtype='QUATERNION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def view_distance(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def view_camera_zoom(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def view_camera_offset(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
