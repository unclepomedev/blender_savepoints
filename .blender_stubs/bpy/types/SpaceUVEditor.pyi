...
class SpaceUVEditor(bpy_struct):
    ...
    def edge_display_type(self, value: Literal['OUTLINE', 'DASH', 'BLACK', 'WHITE']) -> None:
        ...
    @property
    def show_stretch(self) -> bool:
        ...
        ...
    @show_stretch.setter
    def show_stretch(self, value: bool) -> None:
        ...
    @property
    ...
    def display_stretch_type(self, value: Literal['ANGLE', 'AREA']) -> None:
        ...
    @property
    ...
    def show_modified_edges(self, value: bool) -> None:
        ...
    @property
    ...
    def show_uv(self) -> bool:
        ...
        ...
    @show_uv.setter
    def show_uv(self, value: bool) -> None:
        ...
    @property
    ...
    def show_pixel_coords(self, value: bool) -> None:
        ...
    @property
    ...
    def tile_grid_shape(self, value: Annotated[list[int], "subtype='XYZ'", "step=1"]) -> None:
        ...
    @property
    ...
    def show_grid_over_image(self, value: bool) -> None:
        ...
    @property
    ...
    def grid_shape_source(self, value: Literal['DYNAMIC', 'FIXED', 'PIXEL']) -> None:
        ...
    @property
    ...
    def custom_grid_subdivisions(self, value: Annotated[list[int], "subtype='XYZ'", "step=1"]) -> None:
        ...
    @property
    def uv_opacity(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @uv_opacity.setter
    def uv_opacity(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def uv_face_opacity(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def stretch_opacity(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def pixel_round_mode(self, value: Literal['DISABLED', 'CORNER', 'CENTER']) -> None:
        ...
    @property
    def lock_bounds(self) -> bool:
        ...
        ...
    @lock_bounds.setter
    def lock_bounds(self, value: bool) -> None:
        ...
    @property
    ...
    def use_live_unwrap(self, value: bool) -> None:
        ...