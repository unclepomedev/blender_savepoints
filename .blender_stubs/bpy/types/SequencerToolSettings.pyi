...
class SequencerToolSettings(bpy_struct):
    ...
    def fit_method(self) -> Annotated[Literal['FIT', 'FILL', 'STRETCH', 'ORIGINAL'], "is_animatable=False"]:
        ...
        ...
    @fit_method.setter
    def fit_method(self, value: Annotated[Literal['FIT', 'FILL', 'STRETCH', 'ORIGINAL'], "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_current_frame(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_hold_offset(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_markers(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_retiming_keys(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_frame_range(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_borders(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_center(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_to_strips_preview(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_ignore_muted(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_ignore_sound(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_snap_current_frame_to_strips(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def snap_distance(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]):
        ...
    @property
    def overlap_mode(self) -> Annotated[Literal['EXPAND', 'OVERWRITE', 'SHUFFLE'], "is_animatable=False"]:
        ...
        ...
    @overlap_mode.setter
    def overlap_mode(self, value: Annotated[Literal['EXPAND', 'OVERWRITE', 'SHUFFLE'], "is_animatable=False"]):
        ...
    @property
    def pivot_point(self) -> Annotated[Literal['CENTER', 'MEDIAN', 'CURSOR', 'INDIVIDUAL_ORIGINS'], "is_animatable=False"]:
        ...
        ...
    @pivot_point.setter
    def pivot_point(self, value: Annotated[Literal['CENTER', 'MEDIAN', 'CURSOR', 'INDIVIDUAL_ORIGINS'], "is_animatable=False"]):
        ...