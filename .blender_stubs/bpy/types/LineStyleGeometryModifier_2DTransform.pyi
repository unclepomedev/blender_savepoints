...
class LineStyleGeometryModifier_2DTransform(LineStyleGeometryModifier):
    ...
    def pivot(self) -> Literal['CENTER', 'START', 'END', 'PARAM', 'ABSOLUTE']:
        ...
        ...
    @pivot.setter
    def pivot(self, value: Literal['CENTER', 'START', 'END', 'PARAM', 'ABSOLUTE']):
        ...
    @property
    def scale_x(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @scale_x.setter
    def scale_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def scale_y(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @scale_y.setter
    def scale_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def pivot_u(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @pivot_u.setter
    def pivot_u(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def pivot_x(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @pivot_x.setter
    def pivot_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def pivot_y(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @pivot_y.setter
    def pivot_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...