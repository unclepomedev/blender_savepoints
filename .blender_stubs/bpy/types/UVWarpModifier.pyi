...
class UVWarpModifier(Modifier):
    ...
    def axis_u(self) -> Literal['X', 'Y', 'Z']:
        ...
        ...
    @axis_u.setter
    def axis_u(self, value: Literal['X', 'Y', 'Z']) -> None:
        ...
    @property
    def axis_v(self) -> Literal['X', 'Y', 'Z']:
        ...
        ...
    @axis_v.setter
    def axis_v(self, value: Literal['X', 'Y', 'Z']) -> None:
        ...
    @property
    ...
    def offset(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def scale(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        ...
        ...
    @scale.setter
    def scale(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
    @property
