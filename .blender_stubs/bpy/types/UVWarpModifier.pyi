...
class UVWarpModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    axis_u: Literal['X', 'Y', 'Z']
    """Pole axis for rotation"""
    axis_v: Literal['X', 'Y', 'Z']
    """Pole axis for rotation"""
    center: Annotated[list[float], "step=10.0", "precision=3"]
    """Center point for rotate/scale"""
    offset: Annotated[list[float], "step=10.0", "precision=3"]
    """2D Offset for the warp"""
    scale: Annotated[list[float], "step=10.0", "precision=3"]
