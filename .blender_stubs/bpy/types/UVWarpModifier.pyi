...
class UVWarpModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def axis_u(self) -> Literal['X', 'Y', 'Z']:
        """Pole axis for rotation"""
        ...
    @axis_u.setter
    def axis_u(self, value: Literal['X', 'Y', 'Z']):
        ...
    @property
    def axis_v(self) -> Literal['X', 'Y', 'Z']:
        """Pole axis for rotation"""
        ...
    @axis_v.setter
    def axis_v(self, value: Literal['X', 'Y', 'Z']):
        ...
    @property
    def center(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        """Center point for rotate/scale"""
        ...
    @center.setter
    def center(self, value: Annotated[list[float], "step=10.0", "precision=3"]):
        ...
    @property
    def offset(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        """2D Offset for the warp"""
        ...
    @offset.setter
    def offset(self, value: Annotated[list[float], "step=10.0", "precision=3"]):
        ...
    @property
    def scale(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        """2D Scale for the warp"""
        ...
    @scale.setter
    def scale(self, value: Annotated[list[float], "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def object_from(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @object_from.setter
    def object_from(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def bone_from(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @bone_from.setter
    def bone_from(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def object_to(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @object_to.setter
    def object_to(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def bone_to(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @bone_to.setter
    def bone_to(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
