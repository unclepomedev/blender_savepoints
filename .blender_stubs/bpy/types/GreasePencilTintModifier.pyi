...
class GreasePencilTintModifier(Modifier):
    ...
    def color_mode(self) -> Literal['BOTH', 'STROKE', 'FILL']:
        ...
        ...
    @color_mode.setter
    def color_mode(self, value: Literal['BOTH', 'STROKE', 'FILL']):
        ...
    @property
    def factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def tint_mode(self) -> Literal['UNIFORM', 'GRADIENT']:
        ...
        ...
    @tint_mode.setter
    def tint_mode(self, value: Literal['UNIFORM', 'GRADIENT']):
        ...
    @property
    ...
    def radius(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        ...
        ...
    @radius.setter
    def radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]):
        ...
    @property
