...
class GreasePencilTintModifier(Modifier):
    ...
    factor: Annotated[float, "step=0.10000000149011612", "precision=2"]
    """Factor for tinting"""
    tint_mode: Literal['UNIFORM', 'GRADIENT']
    ...
    radius: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]
