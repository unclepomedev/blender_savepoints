...
https://docs.blender.org/api/current/bpy.types.GreasePencilTintModifier.html
"""
...
class GreasePencilTintModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def color_mode(self) -> Literal['BOTH', 'STROKE', 'FILL']:
        """Attributes to modify"""
        ...
    @color_mode.setter
    def color_mode(self, value: Literal['BOTH', 'STROKE', 'FILL']) -> None:
        ...
    @property
    def factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        """Factor for tinting"""
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def tint_mode(self) -> Literal['UNIFORM', 'GRADIENT']:

        ...
    @tint_mode.setter
    def tint_mode(self, value: Literal['UNIFORM', 'GRADIENT']) -> None:
        ...
    @property
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def radius(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        """Influence distance from the object"""
        ...
    @radius.setter
    def radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
