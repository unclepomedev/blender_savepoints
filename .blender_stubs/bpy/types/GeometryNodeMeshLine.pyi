...
class GeometryNodeMeshLine(GeometryNode):
    ...
    def mode(self) -> Annotated[Literal['OFFSET', 'END_POINTS'], "is_animatable=False"]:
        ...
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['OFFSET', 'END_POINTS'], "is_animatable=False"]):
        ...
    @property
    def count_mode(self) -> Annotated[Literal['TOTAL', 'RESOLUTION'], "is_animatable=False"]:
        ...
        ...
    @count_mode.setter
    def count_mode(self, value: Annotated[Literal['TOTAL', 'RESOLUTION'], "is_animatable=False"]):
        ...
