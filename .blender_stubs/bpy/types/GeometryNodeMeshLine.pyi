...
https://docs.blender.org/api/current/bpy.types.GeometryNodeMeshLine.html
"""
...
class GeometryNodeMeshLine(GeometryNode):
    ...
    mode: Annotated[Literal['OFFSET', 'END_POINTS'], "is_animatable=False"]

    count_mode: Annotated[Literal['TOTAL', 'RESOLUTION'], "is_animatable=False"]
