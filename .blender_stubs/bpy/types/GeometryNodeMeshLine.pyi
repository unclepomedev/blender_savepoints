...
class GeometryNodeMeshLine(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def mode(self) -> Annotated[Literal['OFFSET', 'END_POINTS'], "is_animatable=False"]:

        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['OFFSET', 'END_POINTS'], "is_animatable=False"]) -> None:
        ...
    @property
    def count_mode(self) -> Annotated[Literal['TOTAL', 'RESOLUTION'], "is_animatable=False"]:

        ...
    @count_mode.setter
    def count_mode(self, value: Annotated[Literal['TOTAL', 'RESOLUTION'], "is_animatable=False"]) -> None:
        ...
