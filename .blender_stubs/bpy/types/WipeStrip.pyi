...
https://docs.blender.org/api/current/bpy.types.WipeStrip.html
"""
...
class WipeStrip(EffectStrip):
    ...
    def input_2(self, value: Annotated['Strip', "is_animatable=False"]) -> None:
        ...
    @property
    def blur_width(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Width of the blur for the transition, in percentage relative to the image size"""
        ...
    @blur_width.setter
    def blur_width(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def direction(self) -> Literal['OUT', 'IN']:
        ...
        ...
    @direction.setter
    def direction(self, value: Literal['OUT', 'IN']) -> None:
        ...
    @property
    def transition_type(self) -> Literal['SINGLE', 'DOUBLE', 'IRIS', 'CLOCK']:

        ...
    @transition_type.setter
    def transition_type(self, value: Literal['SINGLE', 'DOUBLE', 'IRIS', 'CLOCK']) -> None:
        ...
