...
class WipeStrip(EffectStrip):
    ...
    def blur_width(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @blur_width.setter
    def blur_width(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def direction(self) -> Literal['OUT', 'IN']:
        ...
        ...
    @direction.setter
    def direction(self, value: Literal['OUT', 'IN']):
        ...
    @property
    ...
    def transition_type(self, value: Literal['SINGLE', 'DOUBLE', 'IRIS', 'CLOCK']):
        ...
