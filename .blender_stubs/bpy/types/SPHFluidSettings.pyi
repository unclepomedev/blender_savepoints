...
class SPHFluidSettings(bpy_struct):
    ...
    def solver(self) -> Annotated[Literal['DDR', 'CLASSICAL'], "is_animatable=False"]:
        ...
        ...
    @solver.setter
    def solver(self, value: Annotated[Literal['DDR', 'CLASSICAL'], "is_animatable=False"]) -> None:
        ...
    @property
    def spring_force(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @spring_force.setter
    def spring_force(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def fluid_radius(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @fluid_radius.setter
    def fluid_radius(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_viscoelastic_springs(self, value: bool) -> None:
        ...
    @property
    ...
    def use_initial_rest_length(self, value: bool) -> None:
        ...
    @property
    def plasticity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @plasticity.setter
    def plasticity(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def yield_ratio(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @yield_ratio.setter
    def yield_ratio(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def spring_frames(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def linear_viscosity(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def stiff_viscosity(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def stiffness(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @stiffness.setter
    def stiffness(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def repulsion(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @repulsion.setter
    def repulsion(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def rest_density(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @rest_density.setter
    def rest_density(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def buoyancy(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @buoyancy.setter
    def buoyancy(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_factor_repulsion(self, value: bool) -> None:
        ...
    @property
    ...
    def use_factor_density(self, value: bool) -> None:
        ...
    @property
    ...
    def use_factor_radius(self, value: bool) -> None:
        ...
    @property
    ...
    def use_factor_stiff_viscosity(self, value: bool) -> None:
        ...
    @property
    ...
    def use_factor_rest_length(self, value: bool) -> None:
        ...