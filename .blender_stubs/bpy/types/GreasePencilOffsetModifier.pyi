...
class GreasePencilOffsetModifier(Modifier):
    ...
    offset_mode: Literal['RANDOM', 'LAYER', 'STROKE', 'MATERIAL']
    ...
    scale: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """Values for changes in scale"""
    stroke_location: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """Value for changes in location"""
    stroke_rotation: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=100.0", "precision=5"]
    """Value for changes in rotation"""
    stroke_scale: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]
    """Value for changes in scale"""
    seed: Annotated[int, "subtype='UNSIGNED'", "step=1"]
    """Random seed"""
    stroke_step: Annotated[int, "subtype='UNSIGNED'", "step=1"]
    """Number of elements that will be grouped"""
    stroke_start_offset: Annotated[int, "subtype='UNSIGNED'", "step=1"]
