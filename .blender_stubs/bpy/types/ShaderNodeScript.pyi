...
class ShaderNodeScript(ShaderNode):
    ...
    def use_auto_update(self, value: bool) -> None:
        ...
    @property
    def bytecode(self) -> Annotated[str, "is_animatable=False"]:
        """Compile bytecode for shader script node"""
        ...
    @bytecode.setter
    def bytecode(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def bytecode_hash(self) -> Annotated[str, "is_animatable=False"]:
        """Hash of compile bytecode, for quick equality checking"""
        ...
    @bytecode_hash.setter
    def bytecode_hash(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
