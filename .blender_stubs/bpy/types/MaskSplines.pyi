...
class MaskSplines(bpy_struct):
    ...
    def active(self) -> Annotated[Optional['MaskSpline'], "is_animatable=False"]:
        ...
        ...
    @active.setter
    def active(self, value: Annotated[Optional['MaskSpline'], "is_animatable=False"]) -> None:
        ...
    @property
    def active_point(self) -> Annotated[Optional['MaskSplinePoint'], "is_animatable=False"]:
        ...
        ...
    @active_point.setter
    def active_point(self, value: Annotated[Optional['MaskSplinePoint'], "is_animatable=False"]) -> None:
        ...
