...
class SceneStrip(Strip):
    ...
    def scene(self, value: Annotated[Optional['Scene'], "is_animatable=False"]) -> None:
        ...
    @property
    def scene_camera(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        """Override the scene's active camera"""
        ...
    @scene_camera.setter
    def scene_camera(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def scene_input(self) -> Literal['CAMERA', 'SEQUENCER']:
        """Input type to use for the Scene strip"""
        ...
    @scene_input.setter
    def scene_input(self, value: Literal['CAMERA', 'SEQUENCER']) -> None:
        ...
    @property
    def use_annotations(self) -> bool:
        """Show Annotations in OpenGL previews"""
        ...
    @use_annotations.setter
    def use_annotations(self, value: bool) -> None:
        ...
    @property
