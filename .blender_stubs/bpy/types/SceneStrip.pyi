...
class SceneStrip(Strip):
    ...
    def scene_camera(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @scene_camera.setter
    def scene_camera(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def scene_input(self) -> Literal['CAMERA', 'SEQUENCER']:
        ...
        ...
    @scene_input.setter
    def scene_input(self, value: Literal['CAMERA', 'SEQUENCER']):
        ...
    @property
    ...
    def use_annotations(self, value: bool):
        ...
    @property
