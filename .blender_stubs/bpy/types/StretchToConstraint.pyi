...
class StretchToConstraint(Constraint):
    ...
    def volume(self) -> Literal['VOLUME_XZX', 'VOLUME_X', 'VOLUME_Z', 'NO_VOLUME']:
        ...
        ...
    @volume.setter
    def volume(self, value: Literal['VOLUME_XZX', 'VOLUME_X', 'VOLUME_Z', 'NO_VOLUME']):
        ...
    @property
    def keep_axis(self) -> Literal['PLANE_X', 'PLANE_Z', 'SWING_Y']:
        ...
        ...
    @keep_axis.setter
    def keep_axis(self, value: Literal['PLANE_X', 'PLANE_Z', 'SWING_Y']):
        ...
    @property
    def rest_length(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=5"]:
        ...
        ...
    @rest_length.setter
    def rest_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=5"]):
        ...
    @property
