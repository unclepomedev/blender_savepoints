...
class CompositorNodeOutputFile(CompositorNode):
    ...
    def active_item_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def file_name(self) -> Annotated[str, "subtype='FILE_NAME'", "is_animatable=False"]:
        ...
        ...
    @file_name.setter
    def file_name(self, value: Annotated[str, "subtype='FILE_NAME'", "is_animatable=False"]):
        ...
    @property
