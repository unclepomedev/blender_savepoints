...
class CompositorNodeOutputFile(CompositorNode):
    ...
    def file_output_items(self) -> Annotated['NodeCompositorFileOutputItems', "is_animatable=False"]:
        ...
        ...
    @property
    def active_item_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_item_index.setter
    def active_item_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]) -> None:
        ...
    @property
    def file_name(self) -> Annotated[str, "subtype='FILE_NAME'", "is_animatable=False"]:
        """The base name of the file. Other information might be included in the final file name depending on the node options"""
        ...
    @file_name.setter
    def file_name(self, value: Annotated[str, "subtype='FILE_NAME'", "is_animatable=False"]) -> None:
        ...
    @property
