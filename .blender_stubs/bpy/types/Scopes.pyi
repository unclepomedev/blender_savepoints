...
class Scopes(bpy_struct):
    ...
    def use_full_resolution(self, value: bool):
        ...
    @property
    def accuracy(self) -> Annotated[float, "subtype='PERCENTAGE'", "step=10.0", "precision=1"]:
        ...
        ...
    @accuracy.setter
    def accuracy(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=10.0", "precision=1"]):
        ...
    @property
    ...
    def waveform_mode(self, value: Literal['LUMA', 'PARADE', 'YCBCR601', 'YCBCR709', 'YCBCRJPG', 'RGB']):
        ...
    @property
    ...
    def waveform_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def vectorscope_mode(self, value: Literal['LUMA', 'RGB']):
        ...
    @property
    ...
    def vectorscope_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...