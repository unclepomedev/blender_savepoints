...
https://docs.blender.org/api/current/bpy.types.MeshToVolumeModifier.html
"""
...
class MeshToVolumeModifier(Modifier):
    ...
    def resolution_mode(self, value: Literal['VOXEL_AMOUNT', 'VOXEL_SIZE']) -> None:
        ...
    @property
    ...
    def voxel_amount(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def interior_band_width(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Width of the gradient inside of the mesh"""
        ...
    @interior_band_width.setter
    def interior_band_width(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def density(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Density of the new volume"""
        ...
    @density.setter
    def density(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...