...
https://docs.blender.org/api/current/bpy.types.GreasePencilThickModifierData.html
"""
...
class GreasePencilThickModifierData(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def thickness(self) -> Annotated[float, "step=0.004999999888241291", "precision=3"]:
        """Absolute thickness to apply everywhere"""
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "step=0.004999999888241291", "precision=3"]) -> None:
        ...
    @property
    def thickness_factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Factor to multiply the thickness with"""
        ...
    @thickness_factor.setter
    def thickness_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    def use_weight_factor(self) -> bool:
        """Use weight to modulate effect"""
        ...
    @use_weight_factor.setter
    def use_weight_factor(self, value: bool) -> None:
        ...
    @property
    def use_uniform_thickness(self) -> bool:
        """Replace the stroke thickness"""
        ...
    @use_uniform_thickness.setter
    def use_uniform_thickness(self, value: bool) -> None:
        ...