...
class MovieTrackingTrack(bpy_struct):
    ...
    def frames_limit(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @frames_limit.setter
    def frames_limit(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def pattern_match(self, value: Annotated[Literal['KEYFRAME', 'PREV_FRAME'], "is_animatable=False"]):
        ...
    @property
    ...
    def motion_model(self) -> Annotated[Literal['Perspective', 'Affine', 'LocRotScale', 'LocScale', 'LocRot', 'Loc'], "is_animatable=False"]:
        ...
        ...
    @motion_model.setter
    def motion_model(self, value: Annotated[Literal['Perspective', 'Affine', 'LocRotScale', 'LocScale', 'LocRot', 'Loc'], "is_animatable=False"]):
        ...
    @property
    ...
    def correlation_min(self, value: Annotated[float, "step=0.05000000074505806", "precision=3", "is_animatable=False"]):
        ...
    @property
    def use_brute(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_brute.setter
    def use_brute(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_normalization(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_red_channel(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_green_channel(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_blue_channel(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_grayscale_preview(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_alpha_preview(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def select_anchor(self, value: bool):
        ...
    @property
    ...
    def select_pattern(self, value: bool):
        ...
    @property
    ...
    def select_search(self, value: bool):
        ...
    @property
    ...
    def weight_stab(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @weight_stab.setter
    def weight_stab(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def offset(self) -> Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]):
        ...