...
https://docs.blender.org/api/current/bpy.types.NodeSocketVector4D.html
"""
...
class NodeSocketVector4D(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
