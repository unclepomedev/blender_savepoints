...
class PreferencesInput(bpy_struct):
    ...
    def view_zoom_method(self, value: Literal['CONTINUE', 'DOLLY', 'SCALE']) -> None:
        ...
    @property
    ...
    def view_zoom_axis(self, value: Literal['VERTICAL', 'HORIZONTAL']) -> None:
        ...
    @property
    ...
    def use_multitouch_gestures(self, value: bool) -> None:
        ...
    @property
    ...
    def invert_mouse_zoom(self, value: bool) -> None:
        ...
    @property
    ...
    def use_mouse_depth_navigate(self, value: bool) -> None:
        ...
    @property
    ...
    def use_zoom_to_mouse(self, value: bool) -> None:
        ...
    @property
    ...
    def use_auto_perspective(self, value: bool) -> None:
        ...
    @property
    ...
    def use_rotate_around_active(self, value: bool) -> None:
        ...
    @property
    ...
    def view_rotate_method(self, value: Literal['TURNTABLE', 'TRACKBALL']) -> None:
        ...
    @property
    ...
    def use_mouse_continuous(self, value: bool) -> None:
        ...
    @property
    ...
    def use_drag_immediately(self, value: bool) -> None:
        ...
    @property
    ...
    def use_numeric_input_advanced(self, value: bool) -> None:
        ...
    @property
    ...
    def navigation_mode(self, value: Literal['WALK', 'FLY']) -> None:
        ...
    @property
    ...
    def view_rotate_sensitivity_turntable(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def view_rotate_sensitivity_trackball(self, value: Annotated[float, "subtype='FACTOR'", "step=0.009999999776482582", "precision=2"]) -> None:
        ...
    @property
    ...
    def drag_threshold_mouse(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    ...
    def drag_threshold_tablet(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    ...
    def drag_threshold(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    ...
    def move_threshold(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    ...
    def pressure_threshold_max(self, value: Annotated[float, "subtype='FACTOR'", "step=0.009999999776482582", "precision=3"]) -> None:
        ...
    @property
    ...
    def pressure_softness(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def tablet_api(self) -> Literal['AUTOMATIC', 'WINDOWS_INK', 'WINTAB']:
        ...
        ...
    @tablet_api.setter
    def tablet_api(self, value: Literal['AUTOMATIC', 'WINDOWS_INK', 'WINTAB']) -> None:
        ...
    @property
    ...
    def ndof_translation_sensitivity(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def ndof_rotation_sensitivity(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def ndof_deadzone(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def ndof_zoom_direction(self, value: Literal['NDOF_ZOOM_FORWARD', 'NDOF_ZOOM_UP']) -> None:
        ...
    @property
    ...
    def ndof_show_guide_orbit_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_show_guide_orbit_center(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_navigation_mode(self, value: Literal['OBJECT', 'FLY']) -> None:
        ...
    @property
    ...
    def ndof_lock_horizon(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_fly_speed_auto(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_orbit_center_auto(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_orbit_center_selected(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_rotx_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_roty_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_rotz_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_panx_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_pany_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_panz_invert_axis(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_fly_helicopter(self, value: bool) -> None:
        ...
    @property
    ...
    def ndof_lock_camera_pan_zoom(self, value: bool) -> None:
        ...
    @property
    ...
    def mouse_double_click_time(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_mouse_emulate_3_button(self, value: bool) -> None:
        ...
    @property
    ...
    def mouse_emulate_3_button_modifier(self, value: Literal['ALT', 'OSKEY']) -> None:
        ...
    @property
    ...
    def use_emulate_numpad(self, value: bool) -> None:
        ...
    @property
    ...
    def invert_zoom_wheel(self, value: bool) -> None:
        ...
    @property
    ...
    def touchpad_scroll_direction(self, value: Literal['TRADITIONAL', 'NATURAL']) -> None:
        ...