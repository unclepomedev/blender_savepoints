...
class GeometryNodeViewer(GeometryNode):
    ...
    @property
    def ui_shortcut(self) -> Annotated[int, "step=1", "is_animatable=False"]:

        ...
    @ui_shortcut.setter
    def ui_shortcut(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def active_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_item(self) -> Annotated[Optional['NodeGeometryViewerItem'], "is_animatable=False"]:

        ...
    @active_item.setter
    def active_item(self, value: Annotated[Optional['NodeGeometryViewerItem'], "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Annotated[Literal['AUTO', 'POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]:
        """Domain to evaluate fields on"""
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['AUTO', 'POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]) -> None:
        ...
