...
class GeometryNodeViewer(GeometryNode):
    ...
    def ui_shortcut(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @ui_shortcut.setter
    def ui_shortcut(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def active_item(self) -> Annotated[Optional['NodeGeometryViewerItem'], "is_animatable=False"]:
        ...
        ...
    @active_item.setter
    def active_item(self, value: Annotated[Optional['NodeGeometryViewerItem'], "is_animatable=False"]):
        ...
    @property
    def domain(self) -> Annotated[Literal['AUTO', 'POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]:
        ...
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['AUTO', 'POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]):
        ...
