...
https://docs.blender.org/api/current/bpy.types.GeometryNodeViewer.html
"""
...
class GeometryNodeViewer(GeometryNode):
    ...
    ui_shortcut: Annotated[int, "step=1", "is_animatable=False"]

    @property
    def viewer_items(self) -> Annotated['NodeGeometryViewerItems', "is_animatable=False"]:

        ...
    active_index: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]
    """Index of the active item"""
    active_item: Annotated[Optional['NodeGeometryViewerItem'], "is_animatable=False"]

    domain: Annotated[Literal['AUTO', 'POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]
