...
class FunctionNodeBitMath(FunctionNode):
    ...
    @property
    def operation(self) -> Annotated[Literal['AND', 'OR', 'XOR', 'NOT', 'SHIFT', 'ROTATE'], "is_animatable=False"]:

        ...
    @operation.setter
    def operation(self, value: Annotated[Literal['AND', 'OR', 'XOR', 'NOT', 'SHIFT', 'ROTATE'], "is_animatable=False"]) -> None:
        ...
