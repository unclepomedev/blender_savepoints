...
https://docs.blender.org/api/current/bpy.types.GeometryNodeMenuSwitch.html
"""
...
class GeometryNodeMenuSwitch(GeometryNode):
    ...
    @property
    def enum_items(self) -> Annotated['NodeMenuSwitchItems', "is_animatable=False"]:
    ...
    def active_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_item(self) -> Annotated[Optional['NodeEnumItem'], "is_animatable=False"]:
        """Active item"""
        ...
    @active_item.setter
    def active_item(self, value: Annotated[Optional['NodeEnumItem'], "is_animatable=False"]) -> None:
        ...
    @property
    def enum_definition(self) -> Annotated[Optional['Node'], "is_animatable=False"]:
    ...
    def data_type(self) -> Annotated[Literal['FLOAT', 'INT', 'BOOLEAN', 'VECTOR', 'RGBA', 'ROTATION', 'MATRIX', 'STRING', 'MENU', 'SHADER', 'OBJECT', 'IMAGE', 'GEOMETRY', 'COLLECTION', 'TEXTURE', 'MATERIAL', 'BUNDLE', 'CLOSURE'], "is_animatable=False"]:
        ...
        ...
    @data_type.setter
    def data_type(self, value: Annotated[Literal['FLOAT', 'INT', 'BOOLEAN', 'VECTOR', 'RGBA', 'ROTATION', 'MATRIX', 'STRING', 'MENU', 'SHADER', 'OBJECT', 'IMAGE', 'GEOMETRY', 'COLLECTION', 'TEXTURE', 'MATERIAL', 'BUNDLE', 'CLOSURE'], "is_animatable=False"]) -> None:
        ...
