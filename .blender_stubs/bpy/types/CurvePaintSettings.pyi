...
class CurvePaintSettings(bpy_struct):
    ...
    def curve_type(self) -> Annotated[Literal['POLY', 'BEZIER'], "is_animatable=False"]:
        ...
        ...
    @curve_type.setter
    def curve_type(self, value: Annotated[Literal['POLY', 'BEZIER'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_corners_detect(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pressure_radius(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_stroke_endpoints(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_offset_absolute(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_project_only_selected(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def error_threshold(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def fit_method(self) -> Annotated[Literal['REFIT', 'SPLIT'], "subtype='PIXEL'", "is_animatable=False"]:
        ...
        ...
    @fit_method.setter
    def fit_method(self, value: Annotated[Literal['REFIT', 'SPLIT'], "subtype='PIXEL'", "is_animatable=False"]) -> None:
        ...
    @property
    def corner_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @corner_angle.setter
    def corner_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def radius_min(self) -> Annotated[float, "step=10.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @radius_min.setter
    def radius_min(self, value: Annotated[float, "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    def radius_max(self) -> Annotated[float, "step=10.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @radius_max.setter
    def radius_max(self, value: Annotated[float, "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def radius_taper_start(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def radius_taper_end(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def surface_offset(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    def depth_mode(self) -> Annotated[Literal['CURSOR', 'SURFACE'], "is_animatable=False"]:
        ...
        ...
    @depth_mode.setter
    def depth_mode(self, value: Annotated[Literal['CURSOR', 'SURFACE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def surface_plane(self, value: Annotated[Literal['NORMAL_VIEW', 'NORMAL_SURFACE', 'VIEW'], "is_animatable=False"]) -> None:
        ...