...
class WaveModifier(Modifier):
    ...
    time_offset: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]
    ...
    damping_time: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]
    ...
    start_position_x: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=100.0", "precision=2"]
    """X coordinate of the start position"""
    start_position_y: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=100.0", "precision=2"]
    """Y coordinate of the start position"""
    start_position_object: Annotated[Optional['Object'], "is_animatable=False"]
    ...
    speed: Annotated[float, "step=10.0", "precision=2"]
    """Speed of the wave, towards the starting point when negative"""
    height: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]
    """Height of the wave"""
    width: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]
    """Distance between the waves"""
    narrowness: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]
    ...
    """UV map name"""
    texture_coords_object: Annotated[Optional['Object'], "is_animatable=False"]
    """Object to set the texture coordinates"""
    texture_coords_bone: Annotated[str, "is_animatable=False"]
