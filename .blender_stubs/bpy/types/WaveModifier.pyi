...
class WaveModifier(Modifier):
    ...
    def use_normal(self) -> bool:
        ...
        ...
    @use_normal.setter
    def use_normal(self, value: bool) -> None:
        ...
    @property
    def use_normal_x(self) -> bool:
        ...
        ...
    @use_normal_x.setter
    def use_normal_x(self, value: bool) -> None:
        ...
    @property
    def use_normal_y(self) -> bool:
        ...
        ...
    @use_normal_y.setter
    def use_normal_y(self, value: bool) -> None:
        ...
    @property
    def use_normal_z(self) -> bool:
        ...
        ...
    @use_normal_z.setter
    def use_normal_z(self, value: bool) -> None:
        ...
    @property
    def time_offset(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @time_offset.setter
    def time_offset(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def damping_time(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @damping_time.setter
    def damping_time(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def falloff_radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=100.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def start_position_x(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=100.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def start_position_y(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=100.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def start_position_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def speed(self) -> Annotated[float, "step=10.0", "precision=2"]:
        ...
        ...
    @speed.setter
    def speed(self, value: Annotated[float, "step=10.0", "precision=2"]) -> None:
        ...
    @property
    def height(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]:
        ...
        ...
    @height.setter
    def height(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]) -> None:
        ...
    @property
    def width(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]:
        ...
        ...
    @width.setter
    def width(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]) -> None:
        ...
    @property
    def narrowness(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]:
        ...
        ...
    @narrowness.setter
    def narrowness(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=2"]) -> None:
        ...
    @property
