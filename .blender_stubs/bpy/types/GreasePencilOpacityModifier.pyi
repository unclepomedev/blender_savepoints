...
https://docs.blender.org/api/current/bpy.types.GreasePencilOpacityModifier.html
"""
...
class GreasePencilOpacityModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def color_mode(self) -> Literal['BOTH', 'STROKE', 'FILL', 'HARDNESS']:
        """Attributes to modify"""
        ...
    @color_mode.setter
    def color_mode(self, value: Literal['BOTH', 'STROKE', 'FILL', 'HARDNESS']) -> None:
        ...
    @property
    def color_factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        """Factor of opacity"""
        ...
    @color_factor.setter
    def color_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def hardness_factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        """Factor of stroke hardness"""
        ...
    @hardness_factor.setter
    def hardness_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def use_weight_as_factor(self) -> bool:
        """Use vertex group weight as factor instead of influence"""
        ...
    @use_weight_as_factor.setter
    def use_weight_as_factor(self, value: bool) -> None:
        ...
    @property
    def use_uniform_opacity(self) -> bool:
        """Replace the stroke opacity instead of modulating each point"""
        ...
    @use_uniform_opacity.setter
    def use_uniform_opacity(self, value: bool) -> None:
        ...