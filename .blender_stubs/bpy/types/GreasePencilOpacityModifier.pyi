...
class GreasePencilOpacityModifier(Modifier):
    ...
    color_mode: Literal['BOTH', 'STROKE', 'FILL', 'HARDNESS']
    """Attributes to modify"""
    color_factor: Annotated[float, "step=0.10000000149011612", "precision=2"]
    """Factor of opacity"""
    hardness_factor: Annotated[float, "step=0.10000000149011612", "precision=2"]
