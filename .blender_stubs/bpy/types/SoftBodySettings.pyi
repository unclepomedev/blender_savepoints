...
class SoftBodySettings(bpy_struct):
    ...
    def gravity(self) -> Annotated[float, "subtype='ACCELERATION'", "unit='ACCELERATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @gravity.setter
    def gravity(self, value: Annotated[float, "subtype='ACCELERATION'", "unit='ACCELERATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def speed(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @speed.setter
    def speed(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def vertex_group_goal(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def goal_default(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @goal_default.setter
    def goal_default(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def pull(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @pull.setter
    def pull(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def push(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @push.setter
    def push(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def damping(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @damping.setter
    def damping(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_length(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def aero(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @aero.setter
    def aero(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def plastic(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @plastic.setter
    def plastic(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def bend(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @bend.setter
    def bend(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def shear(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @shear.setter
    def shear(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def vertex_group_spring(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def collision_type(self, value: Annotated[Literal['MANUAL', 'AVERAGE', 'MINIMAL', 'MAXIMAL', 'MINMAX'], "is_animatable=False"]):
        ...
    @property
    def ball_size(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @ball_size.setter
    def ball_size(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def ball_stiff(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @ball_stiff.setter
    def ball_stiff(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def ball_damp(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @ball_damp.setter
    def ball_damp(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def error_threshold(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def step_min(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @step_min.setter
    def step_min(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def step_max(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @step_max.setter
    def step_max(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def choke(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @choke.setter
    def choke(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def fuzzy(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @fuzzy.setter
    def fuzzy(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_diagnose(self) -> bool:
        ...
        ...
    @use_diagnose.setter
    def use_diagnose(self, value: bool):
        ...
    @property
    ...
    def use_estimate_matrix(self, value: bool):
        ...
    @property
    ...
    def location_mass_center(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def rotation_estimate(self, value: Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def scale_estimate(self, value: Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3"]):
        ...
    @property
    def use_goal(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_goal.setter
    def use_goal(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def use_edges(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_edges.setter
    def use_edges(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stiff_quads(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_edge_collision(self, value: bool):
        ...
    @property
    ...
    def use_face_collision(self, value: bool):
        ...
    @property
    ...
    def aerodynamics_type(self, value: Literal['SIMPLE', 'LIFT_FORCE']):
        ...
    @property
    ...
    def use_self_collision(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
