...
class NodeSocketFloatTime(NodeSocketStandard):
    ...
    def bl_subtype_label(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def default_value(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]) -> None:
        ...
