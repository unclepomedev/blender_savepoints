...
class GeometryNodeSetMeshNormal(GeometryNode):
    ...
    @property
    def mode(self) -> Annotated[Literal['SHARPNESS', 'FREE', 'TANGENT_SPACE'], "is_animatable=False"]:
        """Storage mode for custom normal data"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['SHARPNESS', 'FREE', 'TANGENT_SPACE'], "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'FACE', 'CORNER'], "is_animatable=False"]:
        """Attribute domain to store free custom normals"""
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'FACE', 'CORNER'], "is_animatable=False"]) -> None:
        ...
