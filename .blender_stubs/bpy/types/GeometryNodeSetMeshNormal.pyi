...
https://docs.blender.org/api/current/bpy.types.GeometryNodeSetMeshNormal.html
"""
...
class GeometryNodeSetMeshNormal(GeometryNode):
    ...
    mode: Annotated[Literal['SHARPNESS', 'FREE', 'TANGENT_SPACE'], "is_animatable=False"]
    """Storage mode for custom normal data"""
    domain: Annotated[Literal['POINT', 'FACE', 'CORNER'], "is_animatable=False"]
