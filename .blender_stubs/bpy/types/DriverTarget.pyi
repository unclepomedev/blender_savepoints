...
class DriverTarget(bpy_struct):
    ...
    def bone_target(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @bone_target.setter
    def bone_target(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def transform_type(self, value: Literal['LOC_X', 'LOC_Y', 'LOC_Z', 'ROT_X', 'ROT_Y', 'ROT_Z', 'ROT_W', 'SCALE_X', 'SCALE_Y', 'SCALE_Z', 'SCALE_AVG']) -> None:
        ...
    @property
    ...
    def rotation_mode(self, value: Literal['AUTO', 'XYZ', 'XZY', 'YXZ', 'YZX', 'ZXY', 'ZYX', 'QUATERNION', 'SWING_TWIST_X', 'SWING_TWIST_Y', 'SWING_TWIST_Z']) -> None:
        ...
    @property
    ...
    def transform_space(self, value: Literal['WORLD_SPACE', 'TRANSFORM_SPACE', 'LOCAL_SPACE']) -> None:
        ...
    @property
    ...
    def context_property(self, value: Literal['ACTIVE_SCENE', 'ACTIVE_VIEW_LAYER']) -> None:
        ...
    @property
    ...
    def use_fallback_value(self, value: bool) -> None:
        ...
    @property
    ...
    def fallback_value(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
