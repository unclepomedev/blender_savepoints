...
https://docs.blender.org/api/current/bpy.types.GeometryNodeForeachGeometryElementInput.html
"""
...
class GeometryNodeForeachGeometryElementInput(GeometryNode):
    ...
    @property
    def paired_output(self) -> Annotated[Optional['Node'], "is_animatable=False"]:
