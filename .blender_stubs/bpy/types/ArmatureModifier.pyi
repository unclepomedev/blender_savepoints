...
class ArmatureModifier(Modifier):
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_bone_envelopes(self) -> Annotated[bool, "is_animatable=False"]:
        """Bind Bone envelopes to armature modifier"""
        ...
    @use_bone_envelopes.setter
    def use_bone_envelopes(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def use_vertex_groups(self) -> Annotated[bool, "is_animatable=False"]:
        """Bind vertex groups to armature modifier"""
        ...
    @use_vertex_groups.setter
    def use_vertex_groups(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def use_deform_preserve_volume(self) -> bool:
        """Deform rotation interpolation with quaternions"""
        ...
    @use_deform_preserve_volume.setter
    def use_deform_preserve_volume(self, value: bool) -> None:
        ...
    @property
    def use_multi_modifier(self) -> bool:
        """Use same input as previous modifier, and mix results using overall vgroup"""
        ...
    @use_multi_modifier.setter
    def use_multi_modifier(self, value: bool) -> None:
        ...
    @property
