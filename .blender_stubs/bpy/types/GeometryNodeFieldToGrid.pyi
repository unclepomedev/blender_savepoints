...
https://docs.blender.org/api/current/bpy.types.GeometryNodeFieldToGrid.html
"""
...
class GeometryNodeFieldToGrid(GeometryNode):
    ...
    @property
    def grid_items(self) -> Annotated['GeometryNodeFieldToGridItems', "is_animatable=False"]:
    ...
    def active_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_item(self) -> Annotated[Optional['RepeatItem'], "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_item.setter
    def active_item(self, value: Annotated[Optional['RepeatItem'], "is_animatable=False"]) -> None:
        ...
    @property
