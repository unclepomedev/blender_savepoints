...
class GeometryNodeCurveToPoints(GeometryNode):
    ...
    @property
    def mode(self) -> Annotated[Literal['EVALUATED', 'COUNT', 'LENGTH'], "is_animatable=False"]:
        """How to generate points from the input curve"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['EVALUATED', 'COUNT', 'LENGTH'], "is_animatable=False"]) -> None:
        ...
