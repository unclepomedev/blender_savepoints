...
class SceneGpencil(bpy_struct):
    ...
    def antialias_threshold(self, value: Annotated[float, "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def antialias_threshold_render(self, value: Annotated[float, "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def aa_samples(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @aa_samples.setter
    def aa_samples(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def motion_blur_steps(self, value: Annotated[int, "step=1"]) -> None:
        ...