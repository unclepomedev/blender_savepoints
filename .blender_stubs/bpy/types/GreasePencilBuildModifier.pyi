...
class GreasePencilBuildModifier(Modifier):
    ...
    start_delay: Annotated[float, "step=1.0", "precision=-1"]
    """Number of frames after each GP keyframe before the modifier has any effect"""
    length: Annotated[float, "step=1.0", "precision=-1"]
    ...
    speed_factor: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=-1"]
    """Multiply recorded drawing speed by a factor"""
    speed_maxgap: Annotated[float, "step=0.009999999776482582", "precision=-1"]
    ...
    percentage_factor: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    ...
    fade_factor: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Defines how much of the stroke is fading in/out"""
    target_vertex_group: Annotated[str, "is_animatable=False"]
    """Output Vertex group"""
    fade_opacity_strength: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """How much strength fading applies on top of stroke opacity"""
    fade_thickness_strength: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
