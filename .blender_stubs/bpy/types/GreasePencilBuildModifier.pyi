...
class GreasePencilBuildModifier(Modifier):
    ...
    def open_frame_range_panel(self, value: bool):
        ...
    @property
    ...
    def open_fading_panel(self, value: bool):
        ...
    @property
    def mode(self) -> Literal['SEQUENTIAL', 'CONCURRENT', 'ADDITIVE']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['SEQUENTIAL', 'CONCURRENT', 'ADDITIVE']):
        ...
    @property
    def transition(self) -> Literal['GROW', 'SHRINK', 'FADE']:
        ...
        ...
    @transition.setter
    def transition(self, value: Literal['GROW', 'SHRINK', 'FADE']):
        ...
    @property
    def start_delay(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        ...
        ...
    @start_delay.setter
    def start_delay(self, value: Annotated[float, "step=1.0", "precision=-1"]):
        ...
    @property
    def length(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        ...
        ...
    @length.setter
    def length(self, value: Annotated[float, "step=1.0", "precision=-1"]):
        ...
    @property
    ...
    def concurrent_time_alignment(self, value: Literal['START', 'END']):
        ...
    @property
    def time_mode(self) -> Literal['DRAWSPEED', 'FRAMES', 'PERCENTAGE']:
        ...
        ...
    @time_mode.setter
    def time_mode(self, value: Literal['DRAWSPEED', 'FRAMES', 'PERCENTAGE']):
        ...
    @property
    def speed_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=-1"]:
        ...
        ...
    @speed_factor.setter
    def speed_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=-1"]):
        ...
    @property
    def speed_maxgap(self) -> Annotated[float, "step=0.009999999776482582", "precision=-1"]:
        ...
        ...
    @speed_maxgap.setter
    def speed_maxgap(self, value: Annotated[float, "step=0.009999999776482582", "precision=-1"]):
        ...
    @property
    ...
    def use_restrict_frame_range(self, value: bool):
        ...
    @property
    ...
    def use_percentage(self, value: bool):
        ...
    @property
    ...
    def percentage_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_fading(self) -> bool:
        ...
        ...
    @use_fading.setter
    def use_fading(self, value: bool):
        ...
    @property
    def fade_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @fade_factor.setter
    def fade_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def target_vertex_group(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def fade_opacity_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def fade_thickness_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
