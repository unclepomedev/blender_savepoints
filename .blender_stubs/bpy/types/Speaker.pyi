...
class Speaker(ID):
    ...
    def preview(self) -> Annotated[Optional['ImagePreview'], "is_animatable=False"]:
        ...
        ...
    muted: Annotated[bool, "is_animatable=False"]
    """Mute the speaker"""
    sound: Annotated[Optional['Sound'], "is_animatable=False"]
    """Sound data-block used by this speaker"""
    volume_max: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]
    """Maximum volume, no matter how near the object is"""
    volume_min: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]
    """Minimum volume, no matter how far away the object is"""
    distance_max: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """Maximum distance for volume calculation, no matter how far away the object is"""
    distance_reference: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """Reference distance at which volume is 100%"""
    attenuation: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """How strong the distance affects volume, depending on distance model"""
    cone_angle_outer: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    ...
    cone_angle_inner: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]
    """Angle of the inner cone, in degrees, inside the cone the volume is 100%"""
    cone_volume_outer: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]
    """Volume outside the outer cone"""
    volume: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
