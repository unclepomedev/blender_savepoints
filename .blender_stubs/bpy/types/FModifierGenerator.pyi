...
class FModifierGenerator(FModifier):
    ...
    def mode(self) -> Literal['POLYNOMIAL', 'POLYNOMIAL_FACTORISED']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['POLYNOMIAL', 'POLYNOMIAL_FACTORISED']):
        ...
    @property
    def poly_order(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @poly_order.setter
    def poly_order(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def coefficients(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        ...
        ...
    @coefficients.setter
    def coefficients(self, value: Annotated[list[float], "step=10.0", "precision=3"]):
        ...