...
class GPencilSculptSettings(bpy_struct):
    ...
    def use_multiframe_falloff(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_thickness_curve(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_scale_thickness(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_stroke(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_layer_stroke(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_material_stroke(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_layer_active(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_material_active(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def lock_axis(self) -> Annotated[Literal['VIEW', 'AXIS_Y', 'AXIS_X', 'AXIS_Z', 'CURSOR'], "is_animatable=False"]:
        ...
        ...
    @lock_axis.setter
    def lock_axis(self, value: Annotated[Literal['VIEW', 'AXIS_Y', 'AXIS_X', 'AXIS_Z', 'CURSOR'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def intersection_threshold(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...