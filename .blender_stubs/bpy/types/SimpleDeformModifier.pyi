...
class SimpleDeformModifier(Modifier):
    ...
    def deform_method(self, value: Literal['TWIST', 'BEND', 'TAPER', 'STRETCH']) -> None:
        ...
    @property
    ...
    def deform_axis(self) -> Literal['X', 'Y', 'Z']:
        ...
        ...
    @deform_axis.setter
    def deform_axis(self, value: Literal['X', 'Y', 'Z']) -> None:
        ...
    @property
    def origin(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @origin.setter
    def origin(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def factor(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def limits(self) -> Annotated[list[float], "step=5.0", "precision=2"]:
        ...
        ...
    @limits.setter
    def limits(self, value: Annotated[list[float], "step=5.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def lock_z(self) -> bool:
        ...
        ...
    @lock_z.setter
    def lock_z(self, value: bool) -> None:
        ...
    @property
