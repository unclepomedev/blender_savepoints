...
class SimpleDeformModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def deform_method(self) -> Literal['TWIST', 'BEND', 'TAPER', 'STRETCH']:

        ...
    @deform_method.setter
    def deform_method(self, value: Literal['TWIST', 'BEND', 'TAPER', 'STRETCH']):
        ...
    @property
    ...
    def vertex_group(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def deform_axis(self) -> Literal['X', 'Y', 'Z']:
        """Deform around local axis"""
        ...
    @deform_axis.setter
    def deform_axis(self, value: Literal['X', 'Y', 'Z']):
        ...
    @property
    def origin(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        """Offset the origin and orientation of the deformation"""
        ...
    @origin.setter
    def origin(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def factor(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Amount to deform object"""
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def limits(self) -> Annotated[list[float], "step=5.0", "precision=2"]:
        """Lower/Upper limits for deform"""
        ...
    @limits.setter
    def limits(self, value: Annotated[list[float], "step=5.0", "precision=2"]):
        ...
    @property
    ...
    def lock_y(self) -> bool:
        ...
        ...
    @lock_y.setter
    def lock_y(self, value: bool):
        ...
    @property
    def lock_z(self) -> bool:
        """Do not allow deformation along the Z axis"""
        ...
    @lock_z.setter
    def lock_z(self, value: bool):
        ...
    @property
