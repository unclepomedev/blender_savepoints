...
https://docs.blender.org/api/current/bpy.types.GreasePencilHookModifier.html
"""
...
class GreasePencilHookModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def open_falloff_panel(self) -> bool:

        ...
    @open_falloff_panel.setter
    def open_falloff_panel(self, value: bool) -> None:
        ...
    @property
    ...
    def center(self) -> Annotated[list[float], "step=10.0", "precision=3"]:
        ...
        ...
    @center.setter
    def center(self, value: Annotated[list[float], "step=10.0", "precision=3"]) -> None:
        ...
    @property
