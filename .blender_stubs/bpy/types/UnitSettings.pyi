...
class UnitSettings(bpy_struct):
    ...
    def system(self) -> Annotated[Literal['NONE', 'METRIC', 'IMPERIAL'], "is_animatable=False"]:
        ...
        ...
    @system.setter
    def system(self, value: Annotated[Literal['NONE', 'METRIC', 'IMPERIAL'], "is_animatable=False"]):
        ...
    @property
    ...
    def system_rotation(self, value: Annotated[Literal['DEGREES', 'RADIANS'], "is_animatable=False"]):
        ...
    @property
    def scale_length(self) -> Annotated[float, "subtype='UNSIGNED'", "step=0.10000000149011612", "precision=6", "is_animatable=False"]:
        ...
        ...
    @scale_length.setter
    def scale_length(self, value: Annotated[float, "subtype='UNSIGNED'", "step=0.10000000149011612", "precision=6", "is_animatable=False"]):
        ...
    @property
    def use_separate(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_separate.setter
    def use_separate(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def length_unit(self) -> Annotated[Literal['DEFAULT'], "is_animatable=False"]:
        ...
        ...
    @length_unit.setter
    def length_unit(self, value: Annotated[Literal['DEFAULT'], "is_animatable=False"]):
        ...
    @property
    def mass_unit(self) -> Annotated[Literal['DEFAULT'], "is_animatable=False"]:
        ...
        ...
    @mass_unit.setter
    def mass_unit(self, value: Annotated[Literal['DEFAULT'], "is_animatable=False"]):
        ...
    @property
    def time_unit(self) -> Annotated[Literal['DEFAULT'], "is_animatable=False"]:
        ...
        ...
    @time_unit.setter
    def time_unit(self, value: Annotated[Literal['DEFAULT'], "is_animatable=False"]):
        ...
    @property
    ...
    def temperature_unit(self, value: Annotated[Literal['DEFAULT'], "is_animatable=False"]):
        ...