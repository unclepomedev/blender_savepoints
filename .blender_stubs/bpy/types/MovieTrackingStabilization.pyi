...
class MovieTrackingStabilization(bpy_struct):
    ...
    def use_2d_stabilization(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stabilize_rotation(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stabilize_scale(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def active_track_index(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def active_rotation_track_index(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def anchor_frame(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @anchor_frame.setter
    def anchor_frame(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def target_position(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def target_rotation(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def target_scale(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @target_scale.setter
    def target_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]):
        ...
    @property
    ...
    def use_autoscale(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def scale_max(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @scale_max.setter
    def scale_max(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def influence_location(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def influence_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def influence_rotation(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def filter_type(self) -> Literal['NEAREST', 'BILINEAR', 'BICUBIC']:
        ...
        ...
    @filter_type.setter
    def filter_type(self, value: Literal['NEAREST', 'BILINEAR', 'BICUBIC']):
        ...
    @property
    ...
    def show_tracks_expanded(self, value: Annotated[bool, "is_animatable=False"]):
        ...