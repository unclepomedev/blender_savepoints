...
Deprecated. Will be remove in 5.0."""
    ...
    default_value: Annotated[int, "subtype='PERCENTAGE'", "step=1", "is_animatable=False"]
    """Input value used for unconnected socket"""
    min_value: Annotated[int, "step=1", "is_animatable=False"]
    """Minimum value"""
    max_value: Annotated[int, "step=1", "is_animatable=False"]
    """Maximum value"""
