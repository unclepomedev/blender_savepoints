...
class BrushCurvesSculptSettings(bpy_struct):
    ...
    def add_amount(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @add_amount.setter
    def add_amount(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def points_per_curve(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_uniform_scale(self, value: bool) -> None:
        ...
    @property
    ...
    def minimum_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_length_interpolate(self, value: bool) -> None:
        ...
    @property
    ...
    def use_radius_interpolate(self, value: bool) -> None:
        ...
    @property
    ...
    def use_point_count_interpolate(self, value: bool) -> None:
        ...
    @property
    ...
    def use_shape_interpolate(self, value: bool) -> None:
        ...
    @property
    def curve_length(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @curve_length.setter
    def curve_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def minimum_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=2"]) -> None:
        ...
    @property
    def curve_radius(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=2"]:
        ...
        ...
    @curve_radius.setter
    def curve_radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=2"]) -> None:
        ...
    @property
    ...
    def density_add_attempts(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def density_mode(self) -> Literal['AUTO', 'ADD', 'REMOVE']:
        ...
        ...
    @density_mode.setter
    def density_mode(self, value: Literal['AUTO', 'ADD', 'REMOVE']) -> None:
        ...
    @property
