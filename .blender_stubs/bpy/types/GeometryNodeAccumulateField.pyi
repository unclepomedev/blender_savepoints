...
class GeometryNodeAccumulateField(GeometryNode):
    ...
    @property
    def data_type(self) -> Annotated[Literal['FLOAT', 'INT', 'FLOAT_VECTOR', 'TRANSFORM'], "is_animatable=False"]:
        """Type of data that is accumulated"""
        ...
    @data_type.setter
    def data_type(self, value: Annotated[Literal['FLOAT', 'INT', 'FLOAT_VECTOR', 'TRANSFORM'], "is_animatable=False"]) -> None:
        ...
    @property
