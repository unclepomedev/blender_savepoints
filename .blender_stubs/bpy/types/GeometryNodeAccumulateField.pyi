...
https://docs.blender.org/api/current/bpy.types.GeometryNodeAccumulateField.html
"""
...
class GeometryNodeAccumulateField(GeometryNode):
    ...
    data_type: Annotated[Literal['FLOAT', 'INT', 'FLOAT_VECTOR', 'TRANSFORM'], "is_animatable=False"]
