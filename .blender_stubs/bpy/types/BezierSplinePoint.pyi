...
class BezierSplinePoint(bpy_struct):
    ...
    def handle_left_type(self, value: Literal['FREE', 'VECTOR', 'ALIGNED', 'AUTO']) -> None:
        ...
    @property
    ...
    def handle_right_type(self, value: Literal['FREE', 'VECTOR', 'ALIGNED', 'AUTO']) -> None:
        ...
    @property
    def handle_left(self) -> Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]:
        ...
        ...
    @handle_left.setter
    def handle_left(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]) -> None:
        ...
    @property
    ...
    def handle_right(self) -> Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]:
        ...
        ...
    @handle_right.setter
    def handle_right(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]) -> None:
        ...
    @property
