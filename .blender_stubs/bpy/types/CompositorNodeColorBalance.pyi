...
class CompositorNodeColorBalance(CompositorNode):
    ...
    @property
    def input_whitepoint(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        """The color which gets mapped to white (automatically converted to/from temperature and tint)"""
        ...
    @input_whitepoint.setter
    def input_whitepoint(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def output_whitepoint(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        """The color which gets white gets mapped to (automatically converted to/from temperature and tint)"""
        ...
    @output_whitepoint.setter
    def output_whitepoint(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
