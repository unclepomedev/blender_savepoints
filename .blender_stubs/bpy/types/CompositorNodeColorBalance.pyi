...
class CompositorNodeColorBalance(CompositorNode):
    ...
    def input_whitepoint(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def output_whitepoint(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
