...
class SpaceTextEditor(Space):
    ...
    def text(self) -> Annotated[Optional['Text'], "is_animatable=False"]:
        ...
        ...
    @text.setter
    def text(self, value: Annotated[Optional['Text'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def show_word_wrap(self, value: bool) -> None:
        ...
    @property
    ...
    def show_syntax_highlight(self, value: bool) -> None:
        ...
    @property
    ...
    def show_line_highlight(self, value: bool) -> None:
        ...
    @property
    def tab_width(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @tab_width.setter
    def tab_width(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def show_margin(self) -> bool:
        ...
        ...
    @show_margin.setter
    def show_margin(self, value: bool) -> None:
        ...
    @property
    ...
    def margin_column(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def top(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @top.setter
    def top(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_live_edit(self, value: bool) -> None:
        ...
    @property
    def use_find_all(self) -> bool:
        ...
        ...
    @use_find_all.setter
    def use_find_all(self, value: bool) -> None:
        ...
    @property
    ...
    def use_find_wrap(self, value: bool) -> None:
        ...
    @property
    ...
    def use_match_case(self, value: bool) -> None:
        ...
    @property
    def find_text(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @find_text.setter
    def find_text(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def replace_text(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @replace_text.setter
    def replace_text(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
