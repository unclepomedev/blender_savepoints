...
class TriangulateModifier(Modifier):
    ...
    def quad_method(self) -> Literal['BEAUTY', 'FIXED', 'FIXED_ALTERNATE', 'SHORTEST_DIAGONAL', 'LONGEST_DIAGONAL']:
        ...
        ...
    @quad_method.setter
    def quad_method(self, value: Literal['BEAUTY', 'FIXED', 'FIXED_ALTERNATE', 'SHORTEST_DIAGONAL', 'LONGEST_DIAGONAL']) -> None:
        ...
    @property
    def ngon_method(self) -> Literal['BEAUTY', 'CLIP']:
        ...
        ...
    @ngon_method.setter
    def ngon_method(self, value: Literal['BEAUTY', 'CLIP']) -> None:
        ...
    @property
    def min_vertices(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @min_vertices.setter
    def min_vertices(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
...
Warning: Depending on chosen triangulation method, shading may not be fully preserved, "Fixed" method usually gives the best result here"""
    ...
    def keep_custom_normals(self, value: bool) -> None:
        ...