...
class TriangulateModifier(Modifier):
    ...
    def ngon_method(self, value: Literal['BEAUTY', 'CLIP']):
        ...
    @property
    def min_vertices(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        """Triangulate only polygons with vertex count greater than or equal to this number"""
        ...
    @min_vertices.setter
    def min_vertices(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    def keep_custom_normals(self) -> bool:
...
Warning: Depending on chosen triangulation method, shading may not be fully preserved, "Fixed" method usually gives the best result here"""
        ...
    @keep_custom_normals.setter
    def keep_custom_normals(self, value: bool):
        ...