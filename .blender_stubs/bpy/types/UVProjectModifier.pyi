...
class UVProjectModifier(Modifier):
    ...
    def projector_count(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def aspect_x(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @aspect_x.setter
    def aspect_x(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    def aspect_y(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @aspect_y.setter
    def aspect_y(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    def scale_x(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @scale_x.setter
    def scale_x(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    def scale_y(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @scale_y.setter
    def scale_y(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...