...
class UVProjectModifier(Modifier):
    ...
    def uv_layer(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def projector_count(self) -> Annotated[int, "step=1"]:
        """Number of projectors to use"""
        ...
    @projector_count.setter
    def projector_count(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def projectors(self) -> Annotated[bpy_prop_collection['UVProjector'], "is_animatable=False"]:

        ...
    @property
    def aspect_x(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Horizontal aspect ratio (only used for camera projectors)"""
        ...
    @aspect_x.setter
    def aspect_x(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def aspect_y(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Vertical aspect ratio (only used for camera projectors)"""
        ...
    @aspect_y.setter
    def aspect_y(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def scale_x(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Horizontal scale (only used for camera projectors)"""
        ...
    @scale_x.setter
    def scale_x(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def scale_y(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Vertical scale (only used for camera projectors)"""
        ...
    @scale_y.setter
    def scale_y(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...