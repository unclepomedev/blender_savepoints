...
class DynamicPaintSurface(bpy_struct):
    ...
    def surface_format(self, value: Annotated[Literal['VERTEX', 'IMAGE'], "is_animatable=False"]):
        ...
    @property
    def surface_type(self) -> Annotated[Literal['PAINT'], "is_animatable=False"]:
        ...
        ...
    @surface_type.setter
    def surface_type(self, value: Annotated[Literal['PAINT'], "is_animatable=False"]):
        ...
    @property
    ...
    def brush_collection(self, value: Annotated[Optional['Collection'], "is_animatable=False"]):
        ...
    @property
    def use_dissolve(self) -> bool:
        ...
        ...
    @use_dissolve.setter
    def use_dissolve(self, value: bool):
        ...
    @property
    ...
    def dissolve_speed(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=5"]):
        ...
    @property
    def use_drying(self) -> bool:
        ...
        ...
    @use_drying.setter
    def use_drying(self, value: bool):
        ...
    @property
    def dry_speed(self) -> Annotated[int, "subtype='TIME'", "unit='TIME'", "step=5"]:
        ...
        ...
    @dry_speed.setter
    def dry_speed(self, value: Annotated[int, "subtype='TIME'", "unit='TIME'", "step=5"]):
        ...
    @property
    ...
    def image_resolution(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def frame_start(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @frame_start.setter
    def frame_start(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def frame_end(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @frame_end.setter
    def frame_end(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def frame_substeps(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_antialiasing(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def brush_influence_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def brush_radius_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def init_color_type(self, value: Annotated[Literal['NONE', 'COLOR', 'TEXTURE', 'VERTEX_COLOR'], "is_animatable=False"]):
        ...
    @property
    def init_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @init_color.setter
    def init_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def init_texture(self) -> Annotated[Optional['Texture'], "is_animatable=False"]:
        ...
        ...
    @init_texture.setter
    def init_texture(self, value: Annotated[Optional['Texture'], "is_animatable=False"]):
        ...
    @property
    ...
    def init_layername(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def effect_ui(self) -> Annotated[Literal['SPREAD', 'DRIP', 'SHRINK'], "is_animatable=False"]:
        ...
        ...
    @effect_ui.setter
    def effect_ui(self, value: Annotated[Literal['SPREAD', 'DRIP', 'SHRINK'], "is_animatable=False"]):
        ...
    @property
    def use_dry_log(self) -> bool:
        ...
        ...
    @use_dry_log.setter
    def use_dry_log(self, value: bool):
        ...
    @property
    ...
    def use_dissolve_log(self, value: bool):
        ...
    @property
    def use_spread(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_spread.setter
    def use_spread(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def spread_speed(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @spread_speed.setter
    def spread_speed(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def color_dry_threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def color_spread_speed(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def use_drip(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_drip.setter
    def use_drip(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def use_shrink(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_shrink.setter
    def use_shrink(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def shrink_speed(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @shrink_speed.setter
    def shrink_speed(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def drip_velocity(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def drip_acceleration(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def use_premultiply(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def image_output_path(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def output_name_a(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def use_output_a(self) -> bool:
        ...
        ...
    @use_output_a.setter
    def use_output_a(self, value: bool):
        ...
    @property
    ...
    def output_name_b(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def use_output_b(self) -> bool:
        ...
        ...
    @use_output_b.setter
    def use_output_b(self, value: bool):
        ...
    @property
    def depth_clamp(self) -> Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @depth_clamp.setter
    def depth_clamp(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]):
        ...
    @property
    ...
    def displace_factor(self, value: Annotated[float, "step=1.0", "precision=2", "is_animatable=False"]):
        ...
    @property
    ...
    def image_fileformat(self, value: Annotated[Literal['PNG', 'OPENEXR'], "is_animatable=False"]):
        ...
    @property
    ...
    def displace_type(self, value: Annotated[Literal['DISPLACE', 'DEPTH'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_incremental_displace(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def wave_damping(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @wave_damping.setter
    def wave_damping(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def wave_speed(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @wave_speed.setter
    def wave_speed(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def wave_timescale(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def wave_spring(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @wave_spring.setter
    def wave_spring(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def wave_smoothness(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def use_wave_open_border(self, value: bool):
        ...
    @property
