...
class ShrinkwrapConstraint(Constraint):
    ...
    def shrinkwrap_type(self, value: Literal['NEAREST_SURFACE', 'PROJECT', 'NEAREST_VERTEX', 'TARGET_PROJECT']):
        ...
    @property
    ...
    def project_axis(self) -> Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z']:
        ...
        ...
    @project_axis.setter
    def project_axis(self, value: Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z']):
        ...
    @property
    ...
    def project_axis_space(self, value: Literal['WORLD', 'CUSTOM', 'POSE', 'LOCAL_WITH_PARENT', 'LOCAL']):
        ...
    @property
    ...
    def project_limit(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_project_opposite(self, value: bool):
        ...
    @property
    ...
    def use_track_normal(self, value: bool):
        ...
    @property
    def track_axis(self) -> Literal['TRACK_X', 'TRACK_Y', 'TRACK_Z', 'TRACK_NEGATIVE_X', 'TRACK_NEGATIVE_Y', 'TRACK_NEGATIVE_Z']:
        ...
        ...
    @track_axis.setter
    def track_axis(self, value: Literal['TRACK_X', 'TRACK_Y', 'TRACK_Z', 'TRACK_NEGATIVE_X', 'TRACK_NEGATIVE_Y', 'TRACK_NEGATIVE_Z']):
        ...