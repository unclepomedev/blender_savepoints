...
https://docs.blender.org/api/current/bpy.types.SoundEqualizerModifier.html
"""
...
class SoundEqualizerModifier(StripModifier):
    ...
    def is_active(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def graphics(self) -> Annotated[bpy_prop_collection['EQCurveMappingData'], "is_animatable=False"]:
