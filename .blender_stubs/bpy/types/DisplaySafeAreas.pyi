...
class DisplaySafeAreas(bpy_struct):
    ...
    def title(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @title.setter
    def title(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def action(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @action.setter
    def action(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def title_center(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @title_center.setter
    def title_center(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def action_center(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...