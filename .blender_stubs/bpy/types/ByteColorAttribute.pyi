...
https://docs.blender.org/api/current/bpy.types.ByteColorAttribute.html
"""
...
class ByteColorAttribute(Attribute):
    ...
    def is_required(self) -> bool:
        ...
        ...
    @property
    def data(self) -> Annotated[bpy_prop_collection['ByteColorAttributeValue'], "is_animatable=False"]:
