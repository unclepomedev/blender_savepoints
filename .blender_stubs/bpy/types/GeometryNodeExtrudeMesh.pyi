...
class GeometryNodeExtrudeMesh(GeometryNode):
    ...
    @property
    def mode(self) -> Annotated[Literal['VERTICES', 'EDGES', 'FACES'], "is_animatable=False"]:

        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['VERTICES', 'EDGES', 'FACES'], "is_animatable=False"]) -> None:
        ...
