...
class SceneDisplay(bpy_struct):
    ...
    def light_direction(self, value: Annotated[list[float], "subtype='DIRECTION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def shadow_shift(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=1.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @shadow_shift.setter
    def shadow_shift(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    def shadow_focus(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @shadow_focus.setter
    def shadow_focus(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def matcap_ssao_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def matcap_ssao_attenuation(self, value: Annotated[float, "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def matcap_ssao_samples(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def render_aa(self) -> Annotated[Literal['OFF', 'FXAA', '5', '8', '11', '16', '32'], "is_animatable=False"]:
        ...
        ...
    @render_aa.setter
    def render_aa(self, value: Annotated[Literal['OFF', 'FXAA', '5', '8', '11', '16', '32'], "is_animatable=False"]) -> None:
        ...
    @property
