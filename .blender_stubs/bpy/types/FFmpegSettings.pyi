...
class FFmpegSettings(bpy_struct):
    ...
    def format(self) -> Annotated[Literal['MPEG4', 'MKV', 'WEBM', 'AVI', 'DV', 'FLASH', 'MPEG1', 'MPEG2', 'OGG', 'QUICKTIME'], "is_animatable=False"]:
        ...
        ...
    @format.setter
    def format(self, value: Annotated[Literal['MPEG4', 'MKV', 'WEBM', 'AVI', 'DV', 'FLASH', 'MPEG1', 'MPEG2', 'OGG', 'QUICKTIME'], "is_animatable=False"]) -> None:
        ...
    @property
    def codec(self) -> Annotated[Literal['NONE', 'AV1', 'H264', 'H265', 'WEBM', 'DNXHD', 'DV', 'FFV1', 'FLASH', 'HUFFYUV', 'MPEG1', 'MPEG2', 'MPEG4', 'PNG', 'PRORES', 'QTRLE', 'THEORA'], "is_animatable=False"]:
        ...
        ...
    @codec.setter
    def codec(self, value: Annotated[Literal['NONE', 'AV1', 'H264', 'H265', 'WEBM', 'DNXHD', 'DV', 'FFV1', 'FLASH', 'HUFFYUV', 'MPEG1', 'MPEG2', 'MPEG4', 'PNG', 'PRORES', 'QTRLE', 'THEORA'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def video_bitrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def minrate(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @minrate.setter
    def minrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def maxrate(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @maxrate.setter
    def maxrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def muxrate(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @muxrate.setter
    def muxrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def gopsize(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @gopsize.setter
    def gopsize(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def max_b_frames(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @max_b_frames.setter
    def max_b_frames(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_max_b_frames(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def buffersize(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @buffersize.setter
    def buffersize(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def packetsize(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @packetsize.setter
    def packetsize(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def constant_rate_factor(self, value: Annotated[Literal['NONE', 'LOSSLESS', 'PERC_LOSSLESS', 'HIGH', 'MEDIUM', 'LOW', 'VERYLOW', 'LOWEST'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def ffmpeg_preset(self, value: Annotated[Literal['BEST', 'GOOD', 'REALTIME'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def ffmpeg_prores_profile(self, value: Annotated[Literal['422_PROXY', '422_LT', '422_STD', '422_HQ', '4444', '4444_XQ'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_autosplit(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_lossless_output(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def audio_codec(self) -> Annotated[Literal['NONE', 'AAC', 'AC3', 'FLAC', 'MP2', 'MP3', 'OPUS', 'PCM', 'VORBIS'], "is_animatable=False"]:
        ...
        ...
    @audio_codec.setter
    def audio_codec(self, value: Annotated[Literal['NONE', 'AAC', 'AC3', 'FLAC', 'MP2', 'MP3', 'OPUS', 'PCM', 'VORBIS'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def audio_bitrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def audio_volume(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @audio_volume.setter
    def audio_volume(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def audio_mixrate(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def audio_channels(self, value: Annotated[Literal['MONO', 'STEREO', 'SURROUND4', 'SURROUND51', 'SURROUND71'], "is_animatable=False"]) -> None:
        ...