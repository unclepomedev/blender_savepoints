...
https://docs.blender.org/api/current/bpy.types.NodeSocketFloatDistance.html
"""
...
class NodeSocketFloatDistance(NodeSocketStandard):
    ...
    def default_value(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
