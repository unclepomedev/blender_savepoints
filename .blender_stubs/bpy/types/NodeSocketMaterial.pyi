...
https://docs.blender.org/api/current/bpy.types.NodeSocketMaterial.html
"""
...
class NodeSocketMaterial(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[Optional['Material'], "is_animatable=False"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[Optional['Material'], "is_animatable=False"]) -> None:
        ...
