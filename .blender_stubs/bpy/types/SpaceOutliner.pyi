...
class SpaceOutliner(Space):
    ...
    def display_mode(self) -> Literal['SCENES', 'VIEW_LAYER', 'SEQUENCE', 'LIBRARIES', 'DATA_API', 'LIBRARY_OVERRIDES', 'ORPHAN_DATA']:
        ...
        ...
    @display_mode.setter
    def display_mode(self, value: Literal['SCENES', 'VIEW_LAYER', 'SEQUENCE', 'LIBRARIES', 'DATA_API', 'LIBRARY_OVERRIDES', 'ORPHAN_DATA']) -> None:
        ...
    @property
    ...
    def lib_override_view_mode(self, value: Literal['PROPERTIES', 'HIERARCHIES']) -> None:
        ...
    @property
    ...
    def use_filter_case_sensitive(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_complete(self, value: bool) -> None:
        ...
    @property
    ...
    def use_sort_alpha(self, value: bool) -> None:
        ...
    @property
    ...
    def use_sync_select(self, value: bool) -> None:
        ...
    @property
    ...
    def show_mode_column(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_enable(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_select(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_hide(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_viewport(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_render(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_holdout(self, value: bool) -> None:
        ...
    @property
    ...
    def show_restrict_column_indirect_only(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_content(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_children(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_collection(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_view_layers(self, value: bool) -> None:
        ...
    @property
    def filter_state(self) -> Literal['ALL', 'VISIBLE', 'SELECTED', 'ACTIVE', 'SELECTABLE']:
        ...
        ...
    @filter_state.setter
    def filter_state(self, value: Literal['ALL', 'VISIBLE', 'SELECTED', 'ACTIVE', 'SELECTABLE']) -> None:
        ...
    @property
    ...
    def filter_invert(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_mesh(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_armature(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_empty(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_light(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_camera(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_grease_pencil(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_object_others(self, value: bool) -> None:
        ...
    @property
    ...
    def use_filter_id_type(self, value: bool) -> None:
        ...
    @property
    ...
    def filter_id_type(self, value: Literal['ACTION', 'ARMATURE', 'BRUSH', 'CACHEFILE', 'CAMERA', 'COLLECTION', 'CURVE', 'CURVES', 'FONT', 'GREASEPENCIL', 'GREASEPENCIL_V3', 'IMAGE', 'KEY', 'LATTICE', 'LIBRARY', 'LIGHT', 'LIGHT_PROBE', 'LINESTYLE', 'MASK', 'MATERIAL', 'MESH', 'META', 'MOVIECLIP', 'NODETREE', 'OBJECT', 'PAINTCURVE', 'PALETTE', 'PARTICLE', 'POINTCLOUD', 'SCENE', 'SCREEN', 'SOUND', 'SPEAKER', 'TEXT', 'TEXTURE', 'VOLUME', 'WINDOWMANAGER', 'WORKSPACE', 'WORLD']) -> None:
        ...
    @property
    ...
    def use_filter_lib_override_system(self, value: bool) -> None:
        ...