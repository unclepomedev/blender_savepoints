...
class RigidBodyConstraint(bpy_struct):
    ...
    def type(self) -> Annotated[Literal['FIXED', 'POINT', 'HINGE', 'SLIDER', 'PISTON', 'GENERIC', 'GENERIC_SPRING', 'MOTOR'], "is_animatable=False"]:
        ...
        ...
    @type.setter
    def type(self, value: Annotated[Literal['FIXED', 'POINT', 'HINGE', 'SLIDER', 'PISTON', 'GENERIC', 'GENERIC_SPRING', 'MOTOR'], "is_animatable=False"]):
        ...
    @property
    def spring_type(self) -> Annotated[Literal['SPRING1', 'SPRING2'], "is_animatable=False"]:
        ...
        ...
    @spring_type.setter
    def spring_type(self, value: Annotated[Literal['SPRING1', 'SPRING2'], "is_animatable=False"]):
        ...
    @property
    ...
    def disable_collisions(self, value: bool):
        ...
    @property
    def object1(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @object1.setter
    def object1(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def object2(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @object2.setter
    def object2(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def use_breaking(self) -> bool:
        ...
        ...
    @use_breaking.setter
    def use_breaking(self, value: bool):
        ...
    @property
    ...
    def breaking_threshold(self, value: Annotated[float, "step=100.0", "precision=2"]):
        ...
    @property
    ...
    def use_override_solver_iterations(self, value: bool):
        ...
    @property
    ...
    def use_limit_lin_x(self, value: bool):
        ...
    @property
    ...
    def use_limit_lin_y(self, value: bool):
        ...
    @property
    ...
    def use_limit_lin_z(self, value: bool):
        ...
    @property
    ...
    def use_limit_ang_x(self, value: bool):
        ...
    @property
    ...
    def use_limit_ang_y(self, value: bool):
        ...
    @property
    ...
    def use_limit_ang_z(self, value: bool):
        ...
    @property
    def use_spring_x(self) -> bool:
        ...
        ...
    @use_spring_x.setter
    def use_spring_x(self, value: bool):
        ...
    @property
    def use_spring_y(self) -> bool:
        ...
        ...
    @use_spring_y.setter
    def use_spring_y(self, value: bool):
        ...
    @property
    def use_spring_z(self) -> bool:
        ...
        ...
    @use_spring_z.setter
    def use_spring_z(self, value: bool):
        ...
    @property
    ...
    def use_spring_ang_x(self, value: bool):
        ...
    @property
    ...
    def use_spring_ang_y(self, value: bool):
        ...
    @property
    ...
    def use_spring_ang_z(self, value: bool):
        ...
    @property
    ...
    def use_motor_lin(self, value: bool):
        ...
    @property
    ...
    def use_motor_ang(self, value: bool):
        ...
    @property
    ...
    def limit_lin_x_lower(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_lin_x_upper(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_lin_y_lower(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_lin_y_upper(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_lin_z_lower(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_lin_z_upper(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_x_lower(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_x_upper(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_y_lower(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_y_upper(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_z_lower(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def limit_ang_z_upper(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_x(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_y(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_z(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_ang_x(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_ang_y(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_stiffness_ang_z(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_z(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_ang_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_ang_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def spring_damping_ang_z(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def motor_lin_target_velocity(self, value: Annotated[float, "subtype=''", "unit='VELOCITY'", "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def motor_lin_max_impulse(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def motor_ang_target_velocity(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def motor_ang_max_impulse(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...