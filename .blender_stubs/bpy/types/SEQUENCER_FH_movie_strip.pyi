...
https://docs.blender.org/api/current/bpy.types.SEQUENCER_FH_movie_strip.html
"""
...
class SEQUENCER_FH_movie_strip(FileHandler, SequencerFileHandlerBase):
    ...
    def bl_import_operator(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def bl_export_operator(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
...
For Example: ``".blend;.ble"``"""
    ...
    def bl_file_extensions(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
