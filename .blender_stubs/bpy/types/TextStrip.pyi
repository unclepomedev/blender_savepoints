...
https://docs.blender.org/api/current/bpy.types.TextStrip.html
"""
...
class TextStrip(EffectStrip):
    ...
    def font(self, value: Annotated[Optional['VectorFont'], "is_animatable=False"]) -> None:
        ...
    @property
    def font_size(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=1"]:
        """Size of the text"""
        ...
    @font_size.setter
    def font_size(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=1"]) -> None:
        ...
    @property
    ...
    def color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def shadow_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:

        ...
    @shadow_color.setter
    def shadow_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def shadow_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:

        ...
    @shadow_angle.setter
    def shadow_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def shadow_offset(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]:

        ...
    @shadow_offset.setter
    def shadow_offset(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def shadow_blur(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]:

        ...
    @shadow_blur.setter
    def shadow_blur(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def outline_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:

        ...
    @outline_color.setter
    def outline_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def outline_width(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]:

        ...
    @outline_width.setter
    def outline_width(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    def box_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:

        ...
    @box_color.setter
    def box_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def location(self) -> Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=-1"]:
        """Location of the text"""
        ...
    @location.setter
    def location(self, value: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def wrap_width(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        """Word wrap width as factor, zero disables"""
        ...
    @wrap_width.setter
    def wrap_width(self, value: Annotated[float, "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def box_margin(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        """Box margin as factor of image width"""
        ...
    @box_margin.setter
    def box_margin(self, value: Annotated[float, "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    def box_roundness(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Box corner radius as a factor of box height"""
        ...
    @box_roundness.setter
    def box_roundness(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def alignment_x(self) -> Literal['LEFT', 'CENTER', 'RIGHT']:
        """Horizontal text alignment"""
        ...
    @alignment_x.setter
    def alignment_x(self, value: Literal['LEFT', 'CENTER', 'RIGHT']) -> None:
        ...
    @property
    def anchor_x(self) -> Literal['LEFT', 'CENTER', 'RIGHT']:
        """Horizontal position of the text box relative to Location"""
        ...
    @anchor_x.setter
    def anchor_x(self, value: Literal['LEFT', 'CENTER', 'RIGHT']) -> None:
        ...
    @property
    def anchor_y(self) -> Literal['TOP', 'CENTER', 'BOTTOM']:
        """Vertical position of the text box relative to Location"""
        ...
    @anchor_y.setter
    def anchor_y(self, value: Literal['TOP', 'CENTER', 'BOTTOM']) -> None:
        ...
    @property
    def text(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @text.setter
    def text(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_shadow(self, value: bool) -> None:
        ...
    @property
    def use_outline(self) -> bool:
        """Display outline around text"""
        ...
    @use_outline.setter
    def use_outline(self, value: bool) -> None:
        ...
    @property
    def use_box(self) -> bool:
        """Display colored box behind text"""
        ...
    @use_box.setter
    def use_box(self, value: bool) -> None:
        ...
    @property
    def use_bold(self) -> bool:
        ...
        ...
    @use_bold.setter
    def use_bold(self, value: bool) -> None:
        ...
    @property
    def use_italic(self) -> bool:
        ...
        ...
    @use_italic.setter
    def use_italic(self, value: bool) -> None:
        ...
