...
class TextStrip(EffectStrip):
    ...
    def font(self) -> Annotated[Optional['VectorFont'], "is_animatable=False"]:
        ...
        ...
    @font.setter
    def font(self, value: Annotated[Optional['VectorFont'], "is_animatable=False"]):
        ...
    @property
    def font_size(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=1"]:
        ...
        ...
    @font_size.setter
    def font_size(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=1"]):
        ...
    @property
    ...
    def shadow_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:
        ...
        ...
    @shadow_color.setter
    def shadow_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    def shadow_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @shadow_angle.setter
    def shadow_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def shadow_offset(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]):
        ...
    @property
    def shadow_blur(self) -> Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]:
        ...
        ...
    @shadow_blur.setter
    def shadow_blur(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def outline_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def outline_width(self, value: Annotated[float, "subtype='UNSIGNED'", "step=1.0", "precision=2"]):
        ...
    @property
    def box_color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:
        ...
        ...
    @box_color.setter
    def box_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    def location(self) -> Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=-1"]:
        ...
        ...
    @location.setter
    def location(self, value: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=-1"]):
        ...
    @property
    def wrap_width(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        ...
        ...
    @wrap_width.setter
    def wrap_width(self, value: Annotated[float, "step=1.0", "precision=-1"]):
        ...
    @property
    def box_margin(self) -> Annotated[float, "step=1.0", "precision=-1"]:
        ...
        ...
    @box_margin.setter
    def box_margin(self, value: Annotated[float, "step=1.0", "precision=-1"]):
        ...
    @property
    ...
    def box_roundness(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def alignment_x(self) -> Literal['LEFT', 'CENTER', 'RIGHT']:
        ...
        ...
    @alignment_x.setter
    def alignment_x(self, value: Literal['LEFT', 'CENTER', 'RIGHT']):
        ...
    @property
    def anchor_x(self) -> Literal['LEFT', 'CENTER', 'RIGHT']:
        ...
        ...
    @anchor_x.setter
    def anchor_x(self, value: Literal['LEFT', 'CENTER', 'RIGHT']):
        ...
    @property
    def anchor_y(self) -> Literal['TOP', 'CENTER', 'BOTTOM']:
        ...
        ...
    @anchor_y.setter
    def anchor_y(self, value: Literal['TOP', 'CENTER', 'BOTTOM']):
        ...
    @property
    ...
    def use_outline(self) -> bool:
        ...
        ...
    @use_outline.setter
    def use_outline(self, value: bool):
        ...
    @property
