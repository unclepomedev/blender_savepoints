...
https://docs.blender.org/api/current/bpy.types.NodeSocketVectorFactor4D.html
"""
...
class NodeSocketVectorFactor4D(NodeSocketStandard):
    ...
    def bl_subtype_label(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def default_value(self) -> Annotated[list[float], "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[list[float], "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
