...
https://docs.blender.org/api/current/bpy.types.GeometryNodeDistributePointsInGrid.html
"""
...
class GeometryNodeDistributePointsInGrid(GeometryNode):
    ...
    mode: Annotated[Literal['DENSITY_RANDOM', 'DENSITY_GRID'], "is_animatable=False"]
