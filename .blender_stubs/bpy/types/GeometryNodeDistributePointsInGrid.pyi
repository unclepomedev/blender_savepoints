...
class GeometryNodeDistributePointsInGrid(GeometryNode):
    ...
    @property
    def mode(self) -> Annotated[Literal['DENSITY_RANDOM', 'DENSITY_GRID'], "is_animatable=False"]:
        """Method to use for scattering points"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['DENSITY_RANDOM', 'DENSITY_GRID'], "is_animatable=False"]) -> None:
        ...
