...
class GeometryNodeProximity(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def target_element(self) -> Annotated[Literal['POINTS', 'EDGES', 'FACES'], "is_animatable=False"]:
        """Element of the target geometry to calculate the distance from"""
        ...
    @target_element.setter
    def target_element(self, value: Annotated[Literal['POINTS', 'EDGES', 'FACES'], "is_animatable=False"]) -> None:
        ...
