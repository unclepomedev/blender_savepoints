...
class GeometryNodeFieldMinAndMax(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def data_type(self) -> Annotated[Literal['FLOAT', 'INT', 'FLOAT_VECTOR'], "is_animatable=False"]:
        """Type of data the outputs are calculated from"""
        ...
    @data_type.setter
    def data_type(self, value: Annotated[Literal['FLOAT', 'INT', 'FLOAT_VECTOR'], "is_animatable=False"]) -> None:
        ...
    @property
