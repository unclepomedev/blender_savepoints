...
https://docs.blender.org/api/current/bpy.types.GreasePencilNoiseModifier.html
"""
...
class GreasePencilNoiseModifier(Modifier):
    ...
    def use_custom_curve(self, value: bool) -> None:
        ...
    @property
    ...
    def open_random_panel(self, value: bool) -> None:
        ...
    @property
    def factor(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        """Amount of noise to apply"""
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def factor_strength(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        """Amount of noise to apply to opacity"""
        ...
    @factor_strength.setter
    def factor_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def factor_thickness(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        """Amount of noise to apply to thickness"""
        ...
    @factor_thickness.setter
    def factor_thickness(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def factor_uvs(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        """Amount of noise to apply to UV rotation"""
        ...
    @factor_uvs.setter
    def factor_uvs(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    ...
    def seed(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    def noise_scale(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Scale the noise frequency"""
        ...
    @noise_scale.setter
    def noise_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def noise_offset(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]:
        """Offset the noise along the strokes"""
        ...
    @noise_offset.setter
    def noise_offset(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    ...
    def step(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def random_mode(self) -> Literal['STEP', 'KEYFRAME']:
        """Where to perform randomization"""
        ...
    @random_mode.setter
    def random_mode(self, value: Literal['STEP', 'KEYFRAME']) -> None:
        ...