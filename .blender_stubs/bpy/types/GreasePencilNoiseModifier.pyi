...
class GreasePencilNoiseModifier(Modifier):
    ...
    def factor(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    ...
    def factor_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    ...
    def factor_thickness(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def factor_uvs(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @factor_uvs.setter
    def factor_uvs(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    ...
    def noise_scale(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @noise_scale.setter
    def noise_scale(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def noise_offset(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @noise_offset.setter
    def noise_offset(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def random_mode(self) -> Literal['STEP', 'KEYFRAME']:
        ...
        ...
    @random_mode.setter
    def random_mode(self, value: Literal['STEP', 'KEYFRAME']):
        ...