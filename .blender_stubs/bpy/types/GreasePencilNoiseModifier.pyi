...
class GreasePencilNoiseModifier(Modifier):
    ...
    factor: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]
    """Amount of noise to apply"""
    factor_strength: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]
    """Amount of noise to apply to opacity"""
    factor_thickness: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]
    """Amount of noise to apply to thickness"""
    factor_uvs: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]
    """Amount of noise to apply to UV rotation"""
    use_random: bool
    """Use random values over time"""
    seed: Annotated[int, "subtype='UNSIGNED'", "step=1"]
    """Random seed"""
    noise_scale: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Scale the noise frequency"""
    noise_offset: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]
    """Offset the noise along the strokes"""
    step: Annotated[int, "step=1"]
    """Number of frames between randomization steps"""
    random_mode: Literal['STEP', 'KEYFRAME']
