...
class GeometryNodeWarning(GeometryNode):
    ...
    @property
    def warning_type(self) -> Annotated[Literal['ERROR', 'WARNING', 'INFO'], "is_animatable=False"]:

        ...
    @warning_type.setter
    def warning_type(self, value: Annotated[Literal['ERROR', 'WARNING', 'INFO'], "is_animatable=False"]) -> None:
        ...
