...
class ParticleBrush(bpy_struct):
    ...
    def size(self) -> Annotated[int, "subtype='PIXEL'", "step=10", "is_animatable=False"]:
        ...
        ...
    @size.setter
    def size(self, value: Annotated[int, "subtype='PIXEL'", "step=10", "is_animatable=False"]):
        ...
    @property
    ...
    def count(self) -> Annotated[int, "step=10", "is_animatable=False"]:
        ...
        ...
    @count.setter
    def count(self, value: Annotated[int, "step=10", "is_animatable=False"]):
        ...
    @property
    def steps(self) -> Annotated[int, "step=10", "is_animatable=False"]:
        ...
        ...
    @steps.setter
    def steps(self, value: Annotated[int, "step=10", "is_animatable=False"]):
        ...
    @property
    def puff_mode(self) -> Annotated[Literal['ADD', 'SUB'], "is_animatable=False"]:
        ...
        ...
    @puff_mode.setter
    def puff_mode(self, value: Annotated[Literal['ADD', 'SUB'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_puff_volume(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def length_mode(self) -> Annotated[Literal['GROW', 'SHRINK'], "is_animatable=False"]:
        ...
        ...
    @length_mode.setter
    def length_mode(self, value: Annotated[Literal['GROW', 'SHRINK'], "is_animatable=False"]):
        ...
    @property
