...
class ClothCollisionSettings(bpy_struct):
    ...
    def collision_quality(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def impulse_clamp(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_self_collision(self, value: bool) -> None:
        ...
    @property
    ...
    def self_distance_min(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def self_friction(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def vertex_group_self_collisions(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def vertex_group_object_collisions(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def self_impulse_clamp(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...