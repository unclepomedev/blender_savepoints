...
class PreferencesView(bpy_struct):
    ...
    def ui_scale(self) -> Annotated[float, "step=1.0", "precision=2"]:
        ...
        ...
    @ui_scale.setter
    def ui_scale(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def border_width(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @border_width.setter
    def border_width(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def ui_line_width(self, value: Literal['THIN', 'AUTO', 'THICK']):
        ...
    @property
    ...
    def show_tooltips_python(self, value: bool):
        ...
    @property
    ...
    def show_developer_ui(self, value: bool):
        ...
    @property
    ...
    def show_area_handle(self, value: bool):
        ...
    @property
    ...
    def show_number_arrows(self, value: bool):
        ...
    @property
    ...
    def show_object_info(self, value: bool):
        ...
    @property
    ...
    def show_view_name(self, value: bool):
        ...
    @property
    def show_splash(self) -> bool:
        ...
        ...
    @show_splash.setter
    def show_splash(self, value: bool):
        ...
    @property
    ...
    def show_playback_fps(self, value: bool):
        ...
    @property
    ...
    def playback_fps_samples(self, value: Annotated[int, "step=1"]):
        ...
    @property
...
It improves shape readability of very dense meshes, but increases eye fatigue when modeling lower poly"""
    ...
    def use_fresnel_edit(self, value: bool):
        ...
    @property
    ...
    def show_addons_enabled_only(self, value: bool):
        ...
    @property
    ...
    def factor_display_type(self, value: Literal['FACTOR', 'PERCENTAGE']):
        ...
    @property
    ...
    def use_weight_color_range(self, value: bool):
        ...
    @property
    ...
    def show_navigate_ui(self, value: bool):
        ...
    @property
    ...
    def use_mouse_over_open(self, value: bool):
        ...
    @property
    ...
    def menu_close_leave(self, value: bool):
        ...
    @property
    ...
    def open_toplevel_delay(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def open_sublevel_delay(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def color_picker_type(self, value: Literal['CIRCLE_HSV', 'CIRCLE_HSL', 'SQUARE_SV', 'SQUARE_HS', 'SQUARE_HV']):
        ...
    @property
    ...
    def pie_initial_timeout(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def pie_tap_timeout(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def pie_animation_timeout(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def pie_menu_radius(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def pie_menu_threshold(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def pie_menu_confirm(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def use_save_prompt(self, value: bool):
        ...
    @property
    ...
    def show_column_layout(self, value: bool):
        ...
    @property
    ...
    def use_filter_brushes_by_tool(self, value: bool):
        ...
    @property
    def header_align(self) -> Literal['NONE', 'TOP', 'BOTTOM']:
        ...
        ...
    @header_align.setter
    def header_align(self, value: Literal['NONE', 'TOP', 'BOTTOM']):
        ...
    @property
    ...
    def render_display_type(self, value: Literal['NONE', 'SCREEN', 'AREA', 'WINDOW']):
        ...
    @property
    ...
    def filebrowser_display_type(self, value: Literal['SCREEN', 'WINDOW']):
        ...
    @property
    ...
    def preferences_display_type(self, value: Literal['SCREEN', 'WINDOW']):
        ...
    @property
    ...
    def mini_axis_type(self, value: Literal['NONE', 'MINIMAL', 'GIZMO']):
        ...
    @property
    ...
    def mini_axis_size(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def mini_axis_brightness(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def smooth_view(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @smooth_view.setter
    def smooth_view(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def rotation_angle(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def gizmo_size(self) -> Annotated[int, "subtype='PIXEL'", "step=1"]:
        ...
        ...
    @gizmo_size.setter
    def gizmo_size(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def gizmo_size_navigate_v3d(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def lookdev_sphere_size(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def view2d_grid_spacing_min(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def timecode_style(self, value: Literal['MINIMAL', 'SMPTE', 'SMPTE_COMPACT', 'MILLISECONDS', 'SECONDS_ONLY']):
        ...
    @property
    ...
    def view_frame_type(self, value: Literal['KEEP_RANGE', 'SECONDS', 'KEYFRAMES']):
        ...
    @property
    ...
    def view_frame_keyframes(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def view_frame_seconds(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_text_antialiasing(self, value: bool):
        ...
    @property
    ...
    def use_text_render_subpixelaa(self, value: bool):
        ...
    @property
    def text_hinting(self) -> Literal['AUTO', 'NONE', 'SLIGHT', 'FULL']:
        ...
        ...
    @text_hinting.setter
    def text_hinting(self, value: Literal['AUTO', 'NONE', 'SLIGHT', 'FULL']):
        ...
    @property
    def font_path_ui(self) -> Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]:
        ...
        ...
    @font_path_ui.setter
    def font_path_ui(self, value: Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def font_path_ui_mono(self, value: Annotated[str, "subtype='FILE_PATH'", "is_animatable=False"]):
        ...
    @property
    ...
    def use_translate_tooltips(self, value: bool):
        ...
    @property
    ...
    def use_translate_interface(self, value: bool):
        ...
    @property
    ...
    def use_translate_reports(self, value: bool):
        ...
    @property
    ...
    def use_translate_new_dataname(self, value: bool):
        ...
    @property
    ...
    def show_statusbar_memory(self, value: bool):
        ...
    @property
    ...
    def show_statusbar_vram(self, value: bool):
        ...
    @property
    ...
    def show_statusbar_version(self, value: bool):
        ...
    @property
    ...
    def show_statusbar_stats(self, value: bool):
        ...
    @property
    ...
    def show_statusbar_scene_duration(self, value: bool):
        ...
    @property
    ...
    def show_extensions_updates(self, value: bool):
        ...
    @property
    ...
    def use_reduce_motion(self, value: bool):
        ...