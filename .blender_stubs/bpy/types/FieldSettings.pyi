...
class FieldSettings(bpy_struct):
    ...
    def type(self) -> Literal['NONE', 'BOID', 'CHARGE', 'GUIDE', 'DRAG', 'FLUID_FLOW', 'FORCE', 'HARMONIC', 'LENNARDJ', 'MAGNET', 'TEXTURE', 'TURBULENCE', 'VORTEX', 'WIND']:
        ...
        ...
    @type.setter
    def type(self, value: Literal['NONE', 'BOID', 'CHARGE', 'GUIDE', 'DRAG', 'FLUID_FLOW', 'FORCE', 'HARMONIC', 'LENNARDJ', 'MAGNET', 'TEXTURE', 'TURBULENCE', 'VORTEX', 'WIND']):
        ...
    @property
    def shape(self) -> Literal['POINT', 'LINE', 'PLANE', 'SURFACE', 'POINTS']:
        ...
        ...
    @shape.setter
    def shape(self, value: Literal['POINT', 'LINE', 'PLANE', 'SURFACE', 'POINTS']):
        ...
    @property
    def falloff_type(self) -> Literal['CONE', 'SPHERE', 'TUBE']:
        ...
        ...
    @falloff_type.setter
    def falloff_type(self, value: Literal['CONE', 'SPHERE', 'TUBE']):
        ...
    @property
    def texture_mode(self) -> Literal['CURL', 'GRADIENT', 'RGB']:
        ...
        ...
    @texture_mode.setter
    def texture_mode(self, value: Literal['CURL', 'GRADIENT', 'RGB']):
        ...
    @property
    def z_direction(self) -> Literal['POSITIVE', 'NEGATIVE', 'BOTH']:
        ...
        ...
    @z_direction.setter
    def z_direction(self, value: Literal['POSITIVE', 'NEGATIVE', 'BOTH']):
        ...
    @property
    ...
    def linear_drag(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @linear_drag.setter
    def linear_drag(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def harmonic_damping(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def quadratic_drag(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def flow(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @flow.setter
    def flow(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def wind_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @wind_factor.setter
    def wind_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def inflow(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @inflow.setter
    def inflow(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def size(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @size.setter
    def size(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def falloff_power(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def distance_max(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        ...
        ...
    @distance_max.setter
    def distance_max(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]):
        ...
    @property
    def radial_min(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @radial_min.setter
    def radial_min(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def radial_max(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @radial_max.setter
    def radial_max(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def radial_falloff(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def texture_nabla(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def noise(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @noise.setter
    def noise(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_min_distance(self, value: bool):
        ...
    @property
    ...
    def use_radial_min(self, value: bool):
        ...
    @property
    ...
    def use_radial_max(self, value: bool):
        ...
    @property
    ...
    def use_object_coords(self, value: bool):
        ...
    @property
    ...
    def use_global_coords(self, value: bool):
        ...
    @property
    def use_2d_force(self) -> bool:
        ...
        ...
    @use_2d_force.setter
    def use_2d_force(self, value: bool):
        ...
    @property
    ...
    def use_root_coords(self, value: bool):
        ...
    @property
    ...
    def apply_to_location(self, value: bool):
        ...
    @property
    ...
    def apply_to_rotation(self, value: bool):
        ...
    @property
    ...
    def use_absorption(self, value: bool):
        ...
    @property
    ...
    def use_multiple_springs(self, value: bool):
        ...
    @property
    ...
    def use_smoke_density(self, value: bool):
        ...
    @property
    ...
    def use_gravity_falloff(self, value: bool):
        ...
    @property
    ...
    def guide_minimum(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def guide_free(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @guide_free.setter
    def guide_free(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_guide_path_add(self, value: bool):
        ...
    @property
    ...
    def use_guide_path_weight(self, value: bool):
        ...
    @property
    ...
    def guide_clump_amount(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def guide_clump_shape(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def guide_kink_type(self, value: Literal['NONE', 'BRAID', 'CURL', 'RADIAL', 'ROLL', 'ROTATION', 'WAVE']):
        ...
    @property
    ...
    def guide_kink_axis(self, value: Literal['X', 'Y', 'Z']):
        ...
    @property
    ...
    def guide_kink_frequency(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def guide_kink_shape(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def guide_kink_amplitude(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...