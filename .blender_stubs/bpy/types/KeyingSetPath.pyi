...
class KeyingSetPath(bpy_struct):
    ...
    def group(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @group.setter
    def group(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def group_method(self) -> Literal['NAMED', 'NONE', 'KEYINGSET']:
        ...
        ...
    @group_method.setter
    def group_method(self, value: Literal['NAMED', 'NONE', 'KEYINGSET']):
        ...
    @property
    ...
    def array_index(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @array_index.setter
    def array_index(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_entire_array(self, value: bool):
        ...
    @property
