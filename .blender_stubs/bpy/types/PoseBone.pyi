...
class PoseBone(bpy_struct, _GenericBone):
    ...
    def use_ik_limit_x(self, value: bool):
        ...
    @property
    ...
    def use_ik_limit_y(self, value: bool):
        ...
    @property
    ...
    def use_ik_limit_z(self, value: bool):
        ...
    @property
    ...
    def use_ik_rotation_control(self, value: bool):
        ...
    @property
    ...
    def use_ik_linear_control(self, value: bool):
        ...
    @property
    def ik_min_x(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_min_x.setter
    def ik_min_x(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def ik_max_x(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_max_x.setter
    def ik_max_x(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def ik_min_y(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_min_y.setter
    def ik_min_y(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def ik_max_y(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_max_y.setter
    def ik_max_y(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def ik_min_z(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_min_z.setter
    def ik_min_z(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    def ik_max_z(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_max_z.setter
    def ik_max_z(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def ik_stiffness_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def ik_stiffness_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def ik_stiffness_z(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def ik_stretch(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @ik_stretch.setter
    def ik_stretch(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def ik_rotation_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def ik_linear_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def custom_shape(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @custom_shape.setter
    def custom_shape(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def custom_shape_scale_xyz(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def custom_shape_translation(self, value: Annotated[list[float], "subtype='XYZ'", "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def custom_shape_rotation_euler(self, value: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=100.0", "precision=5"]):
        ...
    @property
    ...
    def use_transform_at_custom_shape(self, value: bool):
        ...
    @property
    ...
    def use_transform_around_custom_shape(self, value: bool):
        ...
    @property
    ...
    def use_custom_shape_bone_size(self, value: bool):
        ...
    @property
    def hide(self) -> bool:
    ...
    def custom_shape_transform(self, value: Annotated[Optional['PoseBone'], "is_animatable=False"]):
        ...
    @property
    ...
    def custom_shape_wire_width(self, value: Annotated[float, "step=1.0", "precision=1"]):
        ...
    @property
