...
https://docs.blender.org/api/current/bpy.types.GeometryNodeIndexSwitch.html
"""
...
class GeometryNodeIndexSwitch(GeometryNode):
    ...
    @property
    def index_switch_items(self) -> Annotated['NodeIndexSwitchItems', "is_animatable=False"]:
