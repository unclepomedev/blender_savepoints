...
class LineStyleTextureSlot(TextureSlot):
    ...
    def use_map_color_diffuse(self, value: bool):
        ...
    @property
    ...
    def use_map_alpha(self, value: bool):
        ...
    @property
    ...
    def texture_coords(self, value: Literal['WINDOW', 'GLOBAL', 'ALONG_STROKE', 'ORCO']):
        ...
    @property
    def alpha_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @alpha_factor.setter
    def alpha_factor(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def diffuse_color_factor(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...