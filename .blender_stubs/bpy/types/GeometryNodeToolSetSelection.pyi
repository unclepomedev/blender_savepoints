...
https://docs.blender.org/api/current/bpy.types.GeometryNodeToolSetSelection.html
"""
...
class GeometryNodeToolSetSelection(GeometryNode):
    ...
    domain: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE'], "is_animatable=False"]

    selection_type: Annotated[Literal['BOOLEAN', 'FLOAT'], "is_animatable=False"]
