...
class GeometryNodeToolSetSelection(GeometryNode):
    ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE'], "is_animatable=False"]:

        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE'], "is_animatable=False"]) -> None:
        ...
    @property
    def selection_type(self) -> Annotated[Literal['BOOLEAN', 'FLOAT'], "is_animatable=False"]:

        ...
    @selection_type.setter
    def selection_type(self, value: Annotated[Literal['BOOLEAN', 'FLOAT'], "is_animatable=False"]) -> None:
        ...
