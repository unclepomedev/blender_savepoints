...
class GeometryNodeToolSetSelection(GeometryNode):
    ...
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE'], "is_animatable=False"]:
        ...
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CURVE'], "is_animatable=False"]):
        ...
    @property
    ...
    def selection_type(self, value: Annotated[Literal['BOOLEAN', 'FLOAT'], "is_animatable=False"]):
        ...
