...
class NormalEditModifier(Modifier):
    ...
    def mode(self) -> Literal['RADIAL', 'DIRECTIONAL']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['RADIAL', 'DIRECTIONAL']) -> None:
        ...
    @property
    def offset(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=1.0", "precision=3"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def mix_mode(self) -> Literal['COPY', 'ADD', 'SUB', 'MUL']:
        ...
        ...
    @mix_mode.setter
    def mix_mode(self, value: Literal['COPY', 'ADD', 'SUB', 'MUL']) -> None:
        ...
    @property
    ...
    def mix_limit(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @mix_limit.setter
    def mix_limit(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def no_polynors_fix(self, value: bool) -> None:
        ...
    @property
    ...
    def use_direction_parallel(self, value: bool) -> None:
        ...