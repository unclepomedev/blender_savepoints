...
class GeometryNodeStoreNamedAttribute(GeometryNode):
    ...
    def data_type(self, value: Annotated[Literal['FLOAT', 'INT', 'BOOLEAN', 'FLOAT_VECTOR', 'FLOAT_COLOR', 'QUATERNION', 'FLOAT4X4', 'STRING', 'INT8', 'INT16_2D', 'INT32_2D', 'FLOAT2', 'BYTE_COLOR'], "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]:
        """Which domain to store the data in"""
        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]) -> None:
        ...
