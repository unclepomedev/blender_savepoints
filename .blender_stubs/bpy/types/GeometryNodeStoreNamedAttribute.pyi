...
https://docs.blender.org/api/current/bpy.types.GeometryNodeStoreNamedAttribute.html
"""
...
class GeometryNodeStoreNamedAttribute(GeometryNode):
    ...
    domain: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER'], "is_animatable=False"]
