...
class GeometryNodeCollectionInfo(GeometryNode):
    ...
    @property
    def transform_space(self) -> Annotated[Literal['ORIGINAL', 'RELATIVE'], "is_animatable=False"]:
        """The transformation of the instances output. Does not affect the internal geometry"""
        ...
    @transform_space.setter
    def transform_space(self, value: Annotated[Literal['ORIGINAL', 'RELATIVE'], "is_animatable=False"]) -> None:
        ...
