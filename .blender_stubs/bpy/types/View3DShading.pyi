...
class View3DShading(bpy_struct):
    ...
    def type(self) -> Literal['WIREFRAME', 'SOLID', 'MATERIAL', 'RENDERED']:
        ...
        ...
    @type.setter
    def type(self, value: Literal['WIREFRAME', 'SOLID', 'MATERIAL', 'RENDERED']) -> None:
        ...
    @property
    def light(self) -> Literal['STUDIO', 'MATCAP', 'FLAT']:
        ...
        ...
    @light.setter
    def light(self, value: Literal['STUDIO', 'MATCAP', 'FLAT']) -> None:
        ...
    @property
    ...
    def show_object_outline(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def studio_light(self) -> Literal['DEFAULT']:
        ...
        ...
    @studio_light.setter
    def studio_light(self, value: Literal['DEFAULT']) -> None:
        ...
    @property
    ...
    def use_world_space_lighting(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def show_backface_culling(self, value: bool) -> None:
        ...
    @property
    def show_cavity(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @show_cavity.setter
    def show_cavity(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def cavity_type(self) -> Literal['WORLD', 'SCREEN', 'BOTH']:
        ...
        ...
    @cavity_type.setter
    def cavity_type(self, value: Literal['WORLD', 'SCREEN', 'BOTH']) -> None:
        ...
    @property
    ...
    def curvature_ridge_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def curvature_valley_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def cavity_ridge_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def cavity_valley_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def studiolight_rotate_z(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def studiolight_intensity(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def studiolight_background_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def studiolight_background_blur(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_studiolight_view_rotation(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def color_type(self) -> Annotated[Literal['MATERIAL', 'OBJECT', 'RANDOM', 'VERTEX', 'TEXTURE', 'SINGLE'], "is_animatable=False"]:
        ...
        ...
    @color_type.setter
    def color_type(self, value: Annotated[Literal['MATERIAL', 'OBJECT', 'RANDOM', 'VERTEX', 'TEXTURE', 'SINGLE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def wireframe_color_type(self, value: Literal['THEME', 'OBJECT', 'RANDOM']) -> None:
        ...
    @property
    def single_color(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @single_color.setter
    def single_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def background_type(self, value: Literal['THEME', 'WORLD', 'VIEWPORT']) -> None:
        ...
    @property
    ...
    def background_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def show_xray(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @show_xray.setter
    def show_xray(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def show_xray_wireframe(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def xray_alpha(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @xray_alpha.setter
    def xray_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def xray_alpha_wireframe(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def use_dof(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_dof.setter
    def use_dof(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_scene_lights(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_scene_world(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_scene_lights_render(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_scene_world_render(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def show_specular_highlight(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def object_outline_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shadow_intensity(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def render_pass(self) -> Literal['COMBINED', 'EMISSION', 'ENVIRONMENT', 'AO', 'SHADOW', 'TRANSPARENT', 'DIFFUSE_LIGHT', 'DIFFUSE_COLOR', 'SPECULAR_LIGHT', 'SPECULAR_COLOR', 'VOLUME_LIGHT', 'POSITION', 'NORMAL', 'MIST', 'CryptoObject', 'CryptoAsset', 'CryptoMaterial', 'AOV']:
        ...
        ...
    @render_pass.setter
    def render_pass(self, value: Literal['COMBINED', 'EMISSION', 'ENVIRONMENT', 'AO', 'SHADOW', 'TRANSPARENT', 'DIFFUSE_LIGHT', 'DIFFUSE_COLOR', 'SPECULAR_LIGHT', 'SPECULAR_COLOR', 'VOLUME_LIGHT', 'POSITION', 'NORMAL', 'MIST', 'CryptoObject', 'CryptoAsset', 'CryptoMaterial', 'AOV']) -> None:
        ...
    @property
    def aov_name(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @aov_name.setter
    def aov_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_compositor(self, value: Annotated[Literal['DISABLED', 'CAMERA', 'ALWAYS'], "is_animatable=False"]) -> None:
        ...
    @property
