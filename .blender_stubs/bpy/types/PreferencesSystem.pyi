...
class PreferencesSystem(bpy_struct):
    ...
    def memory_cache_limit(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def sequencer_proxy_setup(self, value: Literal['MANUAL', 'AUTOMATIC']):
        ...
    @property
    def scrollback(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @scrollback.setter
    def scrollback(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def use_overlay_smooth_wire(self, value: bool):
        ...
    @property
    ...
    def use_edit_mode_smooth_wire(self, value: bool):
        ...
    @property
    ...
    def use_region_overlap(self, value: bool):
        ...
    @property
    ...
    def light_ambient(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_studio_light_edit(self, value: bool):
        ...
    @property
    ...
    def gl_clip_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def image_draw_method(self, value: Literal['AUTO', '2DTEXTURE', 'GLSL']):
        ...
    @property
    ...
    def anisotropic_filter(self, value: Literal['FILTER_0', 'FILTER_2', 'FILTER_4', 'FILTER_8', 'FILTER_16']):
        ...
    @property
    ...
    def gl_texture_limit(self, value: Literal['CLAMP_OFF', 'CLAMP_8192', 'CLAMP_4096', 'CLAMP_2048', 'CLAMP_1024', 'CLAMP_512', 'CLAMP_256', 'CLAMP_128']):
        ...
    @property
    ...
    def texture_time_out(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def texture_collection_rate(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def vbo_time_out(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @vbo_time_out.setter
    def vbo_time_out(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def vbo_collection_rate(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_gpu_subdivision(self, value: bool):
        ...
    @property
    def gpu_backend(self) -> Literal['OPENGL', 'METAL', 'VULKAN']:
        ...
        ...
    @gpu_backend.setter
    def gpu_backend(self, value: Literal['OPENGL', 'METAL', 'VULKAN']):
        ...
    @property
    ...
    def gpu_preferred_device(self, value: Literal['AUTO']):
        ...
    @property
    ...
    def gpu_shader_workers(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def shader_compilation_method(self, value: Literal['THREAD', 'SUBPROCESS']):
        ...
    @property
    ...
    def use_online_access(self, value: bool):
        ...
    @property
    ...
    def network_timeout(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def network_connection_limit(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def audio_mixing_buffer(self, value: Literal['SAMPLES_256', 'SAMPLES_512', 'SAMPLES_1024', 'SAMPLES_2048', 'SAMPLES_4096', 'SAMPLES_8192', 'SAMPLES_16384', 'SAMPLES_32768']):
        ...
    @property
    def audio_device(self) -> Literal['None']:
        ...
        ...
    @audio_device.setter
    def audio_device(self, value: Literal['None']):
        ...
    @property
    ...
    def audio_sample_rate(self, value: Literal['RATE_44100', 'RATE_48000', 'RATE_96000', 'RATE_192000']):
        ...
    @property
    ...
    def audio_sample_format(self, value: Literal['U8', 'S16', 'S24', 'S32', 'FLOAT', 'DOUBLE']):
        ...
    @property
    ...
    def audio_channels(self, value: Literal['MONO', 'STEREO', 'SURROUND4', 'SURROUND51', 'SURROUND71']):
        ...
    @property
    ...
    def register_all_users(self, value: bool):
        ...
    @property
