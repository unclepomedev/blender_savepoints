...
https://docs.blender.org/api/current/bpy.types.GreasePencilArmatureModifier.html
"""
...
class GreasePencilArmatureModifier(Modifier):
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_bone_envelopes(self) -> bool:
        """Bind Bone envelopes to armature modifier"""
        ...
    @use_bone_envelopes.setter
    def use_bone_envelopes(self, value: bool) -> None:
        ...
    @property
    def use_vertex_groups(self) -> bool:
        """Bind vertex groups to armature modifier"""
        ...
    @use_vertex_groups.setter
    def use_vertex_groups(self, value: bool) -> None:
        ...
    @property
