...
https://docs.blender.org/api/current/bpy.types.MulticamStrip.html
"""
...
class MulticamStrip(EffectStrip):
    ...
    def input_count(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @property
    def multicam_source(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:

        ...
    @multicam_source.setter
    def multicam_source(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
