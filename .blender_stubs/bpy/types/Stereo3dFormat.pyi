...
class Stereo3dFormat(bpy_struct):
    ...
    def display_mode(self) -> Annotated[Literal['ANAGLYPH', 'INTERLACE', 'SIDEBYSIDE', 'TOPBOTTOM'], "is_animatable=False"]:
        ...
        ...
    @display_mode.setter
    def display_mode(self, value: Annotated[Literal['ANAGLYPH', 'INTERLACE', 'SIDEBYSIDE', 'TOPBOTTOM'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def anaglyph_type(self, value: Annotated[Literal['RED_CYAN', 'GREEN_MAGENTA', 'YELLOW_BLUE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def interlace_type(self, value: Annotated[Literal['ROW_INTERLEAVED', 'COLUMN_INTERLEAVED', 'CHECKERBOARD_INTERLEAVED'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_interlace_swap(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_sidebyside_crosseyed(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_squeezed_frame(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...