...
class FModifierNoise(FModifier):
    ...
    def blend_type(self) -> Literal['REPLACE', 'ADD', 'SUBTRACT', 'MULTIPLY']:
        ...
        ...
    @blend_type.setter
    def blend_type(self, value: Literal['REPLACE', 'ADD', 'SUBTRACT', 'MULTIPLY']):
        ...
    @property
    ...
    def lacunarity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @lacunarity.setter
    def lacunarity(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def roughness(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @roughness.setter
    def roughness(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def depth(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @depth.setter
    def depth(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def use_legacy_noise(self, value: bool):
        ...