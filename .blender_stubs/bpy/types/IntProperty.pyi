...
class IntProperty(Property):
    ...
    def tags(self) -> set[str]:
        ...
        ...
    @property
    def default(self) -> Annotated[int, "step=1"]:
        """Default value for this number"""
        ...
    @property
    def default_array(self) -> Annotated[list[int], "step=1"]:
    ...
    def hard_min(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def hard_max(self) -> Annotated[int, "step=1"]:
        """Maximum value used by buttons"""
        ...
    @property
    def soft_min(self) -> Annotated[int, "step=1"]:
        """Minimum value used by buttons"""
        ...
    @property
    def soft_max(self) -> Annotated[int, "step=1"]:
        """Maximum value used by buttons"""
        ...
    @property
