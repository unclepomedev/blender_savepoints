...
class ObjectLineArt(bpy_struct):
    ...
    def usage(self) -> Annotated[Literal['INHERIT', 'INCLUDE', 'OCCLUSION_ONLY', 'EXCLUDE', 'INTERSECTION_ONLY', 'NO_INTERSECTION', 'FORCE_INTERSECTION'], "is_animatable=False"]:
        ...
        ...
    @usage.setter
    def usage(self, value: Annotated[Literal['INHERIT', 'INCLUDE', 'OCCLUSION_ONLY', 'EXCLUDE', 'INTERSECTION_ONLY', 'NO_INTERSECTION', 'FORCE_INTERSECTION'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_crease_override(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def crease_threshold(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=0.009999999776482582", "precision=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_intersection_priority_override(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def intersection_priority(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...