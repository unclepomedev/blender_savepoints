...
class RenderSettings(bpy_struct):
    ...
    def resolution_x(self) -> Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]:
        ...
        ...
    @resolution_x.setter
    def resolution_x(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]):
        ...
    @property
    def resolution_y(self) -> Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]:
        ...
        ...
    @resolution_y.setter
    def resolution_y(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def resolution_percentage(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=10", "is_animatable=False"]):
        ...
    @property
    ...
    def preview_pixel_size(self, value: Literal['AUTO', '1', '2', '4', '8']):
        ...
    @property
    ...
    def pixel_aspect_x(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def pixel_aspect_y(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def ppm_factor(self) -> Annotated[float, "step=2.0", "precision=2", "is_animatable=False"]:
        ...
        ...
    @ppm_factor.setter
    def ppm_factor(self, value: Annotated[float, "step=2.0", "precision=2", "is_animatable=False"]):
        ...
    @property
    def ppm_base(self) -> Annotated[float, "step=2.0", "precision=4", "is_animatable=False"]:
        ...
        ...
    @ppm_base.setter
    def ppm_base(self, value: Annotated[float, "step=2.0", "precision=4", "is_animatable=False"]):
        ...
    @property
    ...
    def fps(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @fps.setter
    def fps(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def fps_base(self) -> Annotated[float, "step=2.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @fps_base.setter
    def fps_base(self, value: Annotated[float, "step=2.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def frame_map_old(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def frame_map_new(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def dither_intensity(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def filter_size(self) -> Annotated[float, "subtype='PIXEL'", "step=1.0", "precision=2"]:
        ...
        ...
    @filter_size.setter
    def filter_size(self, value: Annotated[float, "subtype='PIXEL'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def film_transparent(self, value: bool):
        ...
    @property
    ...
    def use_freestyle(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def threads(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @threads.setter
    def threads(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def threads_mode(self) -> Literal['AUTO', 'FIXED']:
        ...
        ...
    @threads_mode.setter
    def threads_mode(self, value: Literal['AUTO', 'FIXED']):
        ...
    @property
    ...
    def use_motion_blur(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def motion_blur_shutter(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=2"]):
        ...
    @property
    ...
    def motion_blur_position(self, value: Literal['START', 'CENTER', 'END']):
        ...
    @property
    ...
    def hair_type(self) -> Literal['STRAND', 'STRIP', 'CYLINDER']:
        ...
        ...
    @hair_type.setter
    def hair_type(self, value: Literal['STRAND', 'STRIP', 'CYLINDER']):
        ...
    @property
    def hair_subdiv(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @hair_subdiv.setter
    def hair_subdiv(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_high_quality_normals(self, value: bool):
        ...
    @property
    def use_border(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_border.setter
    def use_border(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    def border_min_x(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @border_min_x.setter
    def border_min_x(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def border_min_y(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @border_min_y.setter
    def border_min_y(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def border_max_x(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @border_max_x.setter
    def border_max_x(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    def border_max_y(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @border_max_y.setter
    def border_max_y(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def use_crop_to_border(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_placeholder(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_compositing(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_sequencer(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_file_extension(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_lock_interface(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_render_cache(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stamp_time(self, value: bool):
        ...
    @property
    ...
    def use_stamp_date(self, value: bool):
        ...
    @property
    ...
    def use_stamp_frame(self, value: bool):
        ...
    @property
    ...
    def use_stamp_frame_range(self, value: bool):
        ...
    @property
    ...
    def use_stamp_camera(self, value: bool):
        ...
    @property
    ...
    def use_stamp_lens(self, value: bool):
        ...
    @property
    ...
    def use_stamp_scene(self, value: bool):
        ...
    @property
    ...
    def use_stamp_note(self, value: bool):
        ...
    @property
    ...
    def use_stamp_marker(self, value: bool):
        ...
    @property
    ...
    def use_stamp_filename(self, value: bool):
        ...
    @property
    ...
    def use_stamp_sequencer_strip(self, value: bool):
        ...
    @property
    ...
    def use_stamp_render_time(self, value: bool):
        ...
    @property
    ...
    def stamp_note_text(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def use_stamp_labels(self, value: bool):
        ...
    @property
    ...
    def metadata_input(self, value: Literal['SCENE', 'STRIPS']):
        ...
    @property
    ...
    def use_stamp_memory(self, value: bool):
        ...
    @property
    ...
    def use_stamp_hostname(self, value: bool):
        ...
    @property
    ...
    def stamp_font_size(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def stamp_foreground(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def stamp_background(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def sequencer_gl_preview(self, value: Literal['WIREFRAME', 'SOLID', 'MATERIAL', 'RENDERED']):
        ...
    @property
    ...
    def use_sequencer_override_scene_strip(self, value: bool):
        ...
    @property
    ...
    def use_single_layer(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def views_format(self) -> Annotated[Literal['STEREO_3D', 'MULTIVIEW'], "is_animatable=False"]:
        ...
        ...
    @views_format.setter
    def views_format(self, value: Annotated[Literal['STEREO_3D', 'MULTIVIEW'], "is_animatable=False"]):
        ...
    @property
    def engine(self) -> Annotated[Literal['BLENDER_EEVEE'], "is_animatable=False"]:
        ...
        ...
    @engine.setter
    def engine(self, value: Annotated[Literal['BLENDER_EEVEE'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_simplify(self) -> bool:
        ...
        ...
    @use_simplify.setter
    def use_simplify(self, value: bool):
        ...
    @property
    ...
    def simplify_subdivision(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def simplify_child_particles(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def simplify_subdivision_render(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def simplify_child_particles_render(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def simplify_volumes(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_simplify_normals(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_onplay(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_antialiasing(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_view_fill(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_modifier(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_shader_fx(self, value: bool):
        ...
    @property
    ...
    def simplify_gpencil_tint(self, value: bool):
        ...
    @property
    ...
    def use_persistent_data(self, value: bool):
        ...
    @property
    ...
    def line_thickness_mode(self, value: Literal['ABSOLUTE', 'RELATIVE']):
        ...
    @property
    ...
    def line_thickness(self, value: Annotated[float, "subtype='PIXEL'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def compositor_device(self, value: Literal['CPU', 'GPU']):
        ...
    @property
    ...
    def compositor_precision(self, value: Literal['AUTO', 'FULL']):
        ...
    @property
    ...
    def compositor_denoise_device(self, value: Literal['AUTO', 'CPU', 'GPU']):
        ...
    @property
    ...
    def compositor_denoise_preview_quality(self, value: Literal['HIGH', 'BALANCED', 'FAST']):
        ...
    @property
    ...
    def compositor_denoise_final_quality(self, value: Literal['HIGH', 'BALANCED', 'FAST']):
        ...
