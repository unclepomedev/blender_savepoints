...
class ShaderNodeTexBrick(ShaderNode):
    ...
    def color_mapping(self) -> Annotated['ColorMapping', "is_animatable=False"]:
        ...
        ...
    @property
    def offset_frequency(self) -> Annotated[int, "step=1"]:
        """How often rows are offset. A value of 2 gives an even/uneven pattern of rows."""
        ...
    @offset_frequency.setter
    def offset_frequency(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def squash_frequency(self) -> Annotated[int, "step=1"]:
        """How often rows consist of "squished" bricks"""
        ...
    @squash_frequency.setter
    def squash_frequency(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def offset(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def squash(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Factor to adjust the brick's width for particular rows determined by the Offset Frequency"""
        ...
    @squash.setter
    def squash(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
