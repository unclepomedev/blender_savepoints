...
class ShaderNodeTexBrick(ShaderNode):
    ...
    def offset_frequency(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def squash_frequency(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def squash(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @squash.setter
    def squash(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
