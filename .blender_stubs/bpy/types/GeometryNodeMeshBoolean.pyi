...
https://docs.blender.org/api/current/bpy.types.GeometryNodeMeshBoolean.html
"""
...
class GeometryNodeMeshBoolean(GeometryNode):
    ...
    operation: Annotated[Literal['INTERSECT', 'UNION', 'DIFFERENCE'], "is_animatable=False"]

    solver: Annotated[Literal['EXACT', 'FLOAT', 'MANIFOLD'], "is_animatable=False"]
