...
class GeometryNodeMeshBoolean(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def operation(self) -> Annotated[Literal['INTERSECT', 'UNION', 'DIFFERENCE'], "is_animatable=False"]:

        ...
    @operation.setter
    def operation(self, value: Annotated[Literal['INTERSECT', 'UNION', 'DIFFERENCE'], "is_animatable=False"]) -> None:
        ...
    @property
    def solver(self) -> Annotated[Literal['EXACT', 'FLOAT', 'MANIFOLD'], "is_animatable=False"]:

        ...
    @solver.setter
    def solver(self, value: Annotated[Literal['EXACT', 'FLOAT', 'MANIFOLD'], "is_animatable=False"]) -> None:
        ...
