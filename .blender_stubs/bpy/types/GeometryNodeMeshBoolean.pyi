...
class GeometryNodeMeshBoolean(GeometryNode):
    ...
    def operation(self) -> Annotated[Literal['INTERSECT', 'UNION', 'DIFFERENCE'], "is_animatable=False"]:
        ...
        ...
    @operation.setter
    def operation(self, value: Annotated[Literal['INTERSECT', 'UNION', 'DIFFERENCE'], "is_animatable=False"]):
        ...
    @property
    def solver(self) -> Annotated[Literal['EXACT', 'FLOAT', 'MANIFOLD'], "is_animatable=False"]:
        ...
        ...
    @solver.setter
    def solver(self, value: Annotated[Literal['EXACT', 'FLOAT', 'MANIFOLD'], "is_animatable=False"]):
        ...
