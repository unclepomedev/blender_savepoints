...
class FileAssetSelectParams(FileSelectParams):
    ...
    def directory(self) -> Annotated[str, "subtype='BYTE_STRING'", "is_animatable=False"]:
        ...
        ...
    @directory.setter
    def directory(self, value: Annotated[str, "subtype='BYTE_STRING'", "is_animatable=False"]):
        ...
    @property
    ...
    def display_type(self) -> Literal['LIST_VERTICAL', 'LIST_HORIZONTAL', 'THUMBNAIL']:
        ...
        ...
    @display_type.setter
    def display_type(self, value: Literal['LIST_VERTICAL', 'LIST_HORIZONTAL', 'THUMBNAIL']):
        ...
    @property
    ...
    def recursion_level(self, value: Literal['NONE', 'BLEND', 'ALL_1', 'ALL_2', 'ALL_3']):
        ...
    @property
    ...
    def show_details_size(self, value: bool):
        ...
    @property
    ...
    def show_details_datetime(self, value: bool):
        ...
    @property
    ...
    def sort_method(self) -> Literal['FILE_SORT_ALPHA', 'FILE_SORT_EXTENSION', 'FILE_SORT_TIME', 'FILE_SORT_SIZE', 'ASSET_CATALOG']:
        ...
        ...
    @sort_method.setter
    def sort_method(self, value: Literal['FILE_SORT_ALPHA', 'FILE_SORT_EXTENSION', 'FILE_SORT_TIME', 'FILE_SORT_SIZE', 'ASSET_CATALOG']):
        ...
    @property
    ...
    def use_sort_invert(self, value: bool):
        ...
    @property
    ...
    def use_filter_image(self, value: bool):
        ...
    @property
    ...
    def use_filter_blender(self, value: bool):
        ...
    @property
    ...
    def use_filter_backup(self, value: bool):
        ...
    @property
    ...
    def use_filter_movie(self, value: bool):
        ...
    @property
    ...
    def use_filter_script(self, value: bool):
        ...
    @property
    ...
    def use_filter_font(self, value: bool):
        ...
    @property
    ...
    def use_filter_sound(self, value: bool):
        ...
    @property
    ...
    def use_filter_text(self, value: bool):
        ...
    @property
    ...
    def use_filter_volume(self, value: bool):
        ...
    @property
    ...
    def use_filter_folder(self, value: bool):
        ...
    @property
    ...
    def use_filter_blendid(self, value: bool):
        ...
    @property
    ...
    def use_filter_asset_only(self, value: bool):
        ...
    @property
    ...
    def filter_glob(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @filter_glob.setter
    def filter_glob(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def filter_search(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    def display_size(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @display_size.setter
    def display_size(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def display_size_discrete(self, value: Literal['TINY', 'SMALL', 'NORMAL', 'BIG', 'LARGE']):
        ...
    @property
    ...
    def list_display_size(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def list_column_size(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def import_method(self, value: Literal['FOLLOW_PREFS', 'LINK', 'APPEND', 'APPEND_REUSE', 'PACK']):
        ...
    @property
    ...
    def instance_collections_on_link(self, value: bool):
        ...
    @property
    ...
    def instance_collections_on_append(self, value: bool):
        ...