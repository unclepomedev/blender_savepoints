...
class BlendTexture(Texture):
    ...
    def animation_data(self) -> Annotated[Optional['AnimData'], "is_animatable=False"]:
        ...
        ...
    @property
    def progression(self) -> Literal['LINEAR', 'QUADRATIC', 'EASING', 'DIAGONAL', 'SPHERICAL', 'QUADRATIC_SPHERE', 'RADIAL']:
        """Style of the color blending"""
        ...
    @progression.setter
    def progression(self, value: Literal['LINEAR', 'QUADRATIC', 'EASING', 'DIAGONAL', 'SPHERICAL', 'QUADRATIC_SPHERE', 'RADIAL']) -> None:
        ...
    @property
    def use_flip_axis(self) -> Literal['HORIZONTAL', 'VERTICAL']:
        """Flip the texture's X and Y axis"""
        ...
    @use_flip_axis.setter
    def use_flip_axis(self, value: Literal['HORIZONTAL', 'VERTICAL']) -> None:
        ...
