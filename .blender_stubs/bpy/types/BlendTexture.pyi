...
class BlendTexture(Texture):
    ...
    def progression(self) -> Literal['LINEAR', 'QUADRATIC', 'EASING', 'DIAGONAL', 'SPHERICAL', 'QUADRATIC_SPHERE', 'RADIAL']:
        ...
        ...
    @progression.setter
    def progression(self, value: Literal['LINEAR', 'QUADRATIC', 'EASING', 'DIAGONAL', 'SPHERICAL', 'QUADRATIC_SPHERE', 'RADIAL']):
        ...
    @property
    ...
    def use_flip_axis(self, value: Literal['HORIZONTAL', 'VERTICAL']):
        ...
