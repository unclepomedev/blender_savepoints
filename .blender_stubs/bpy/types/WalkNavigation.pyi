...
class WalkNavigation(bpy_struct):
    ...
    def mouse_speed(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @mouse_speed.setter
    def mouse_speed(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def walk_speed(self) -> Annotated[float, "subtype='VELOCITY'", "unit='VELOCITY'", "step=10.0", "precision=3"]:
        ...
        ...
    @walk_speed.setter
    def walk_speed(self, value: Annotated[float, "subtype='VELOCITY'", "unit='VELOCITY'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def walk_speed_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def view_height(self) -> Annotated[float, "subtype=''", "unit='LENGTH'", "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @view_height.setter
    def view_height(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    def jump_height(self) -> Annotated[float, "subtype=''", "unit='LENGTH'", "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @jump_height.setter
    def jump_height(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=0.10000000149011612", "precision=2"]) -> None:
        ...
    @property
    ...
    def teleport_time(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_mouse_reverse(self, value: bool) -> None:
        ...