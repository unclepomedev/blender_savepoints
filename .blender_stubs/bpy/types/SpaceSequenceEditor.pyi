...
class SpaceSequenceEditor(Space):
    ...
    def view_type(self) -> Literal['SEQUENCER', 'PREVIEW', 'SEQUENCER_PREVIEW']:
        ...
        ...
    @view_type.setter
    def view_type(self, value: Literal['SEQUENCER', 'PREVIEW', 'SEQUENCER_PREVIEW']) -> None:
        ...
    @property
    def display_mode(self) -> Literal['IMAGE', 'WAVEFORM', 'RGB_PARADE', 'VECTOR_SCOPE', 'HISTOGRAM']:
        ...
        ...
    @display_mode.setter
    def display_mode(self, value: Literal['IMAGE', 'WAVEFORM', 'RGB_PARADE', 'VECTOR_SCOPE', 'HISTOGRAM']) -> None:
        ...
    @property
    def show_frames(self) -> bool:
        ...
        ...
    @show_frames.setter
    def show_frames(self, value: bool) -> None:
        ...
    @property
    ...
    def use_marker_sync(self, value: bool) -> None:
        ...
    @property
    ...
    def display_channel(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def preview_channels(self, value: Literal['COLOR_ALPHA', 'COLOR']) -> None:
        ...
    @property
    ...
    def use_zoom_to_fit(self, value: bool) -> None:
        ...
    @property
    ...
    def show_overexposed(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def proxy_render_size(self, value: Literal['NONE', 'SCENE', 'PROXY_25', 'PROXY_50', 'PROXY_75', 'PROXY_100']) -> None:
        ...
    @property
    ...
    def use_clamp_view(self, value: bool) -> None:
        ...
    @property
    ...
    def overlay_frame_type(self, value: Literal['RECTANGLE', 'REFERENCE', 'CURRENT']) -> None:
        ...
    @property
    ...
    def show_transform_preview(self, value: bool) -> None:
        ...
    @property
