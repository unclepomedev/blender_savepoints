...
class SpaceGraphEditor(Space):
    ...
    def mode(self) -> Literal['FCURVES', 'DRIVERS']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['FCURVES', 'DRIVERS']):
        ...
    @property
    ...
    def show_handles(self) -> bool:
        ...
        ...
    @show_handles.setter
    def show_handles(self, value: bool):
        ...
    @property
    ...
    def use_auto_lock_translation_axis(self, value: bool):
        ...
    @property
    ...
    def use_only_selected_keyframe_handles(self, value: bool):
        ...
    @property
    ...
    def show_extrapolation(self, value: bool):
        ...
    @property
    ...
    def cursor_position_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def cursor_position_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def pivot_point(self) -> Literal['BOUNDING_BOX_CENTER', 'CURSOR', 'INDIVIDUAL_ORIGINS']:
        ...
        ...
    @pivot_point.setter
    def pivot_point(self, value: Literal['BOUNDING_BOX_CENTER', 'CURSOR', 'INDIVIDUAL_ORIGINS']):
        ...
    @property
    ...
    def use_normalization(self, value: bool):
        ...
    @property
    ...
    def use_auto_normalization(self, value: bool):
        ...