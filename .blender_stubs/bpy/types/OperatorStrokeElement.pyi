...
class OperatorStrokeElement(PropertyGroup):
    ...
    def mouse(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]:
        ...
        ...
    @mouse.setter
    def mouse(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]):
        ...
    @property
    def mouse_event(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]:
        ...
        ...
    @mouse_event.setter
    def mouse_event(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]):
        ...
    @property
    def pressure(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @pressure.setter
    def pressure(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def x_tilt(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @x_tilt.setter
    def x_tilt(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def y_tilt(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @y_tilt.setter
    def y_tilt(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
