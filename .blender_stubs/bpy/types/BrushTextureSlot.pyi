...
class BrushTextureSlot(TextureSlot):
    ...
    def angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def map_mode(self) -> Literal['VIEW_PLANE', 'AREA_PLANE', 'TILED', '3D', 'RANDOM', 'STENCIL']:

        ...
    @map_mode.setter
    def map_mode(self, value: Literal['VIEW_PLANE', 'AREA_PLANE', 'TILED', '3D', 'RANDOM', 'STENCIL']) -> None:
        ...
    @property
    def mask_map_mode(self) -> Literal['VIEW_PLANE', 'TILED', 'RANDOM', 'STENCIL']:

        ...
    @mask_map_mode.setter
    def mask_map_mode(self, value: Literal['VIEW_PLANE', 'TILED', 'RANDOM', 'STENCIL']) -> None:
        ...
    @property
    def use_rake(self) -> bool:

        ...
    @use_rake.setter
    def use_rake(self, value: bool) -> None:
        ...
    @property
    ...
    def use_random(self, value: bool) -> None:
        ...
    @property
    def random_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        """Brush texture random angle"""
        ...
    @random_angle.setter
    def random_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
