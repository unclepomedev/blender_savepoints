...
class BrushTextureSlot(TextureSlot):
    ...
    def map_mode(self) -> Literal['VIEW_PLANE', 'AREA_PLANE', 'TILED', '3D', 'RANDOM', 'STENCIL']:
        ...
        ...
    @map_mode.setter
    def map_mode(self, value: Literal['VIEW_PLANE', 'AREA_PLANE', 'TILED', '3D', 'RANDOM', 'STENCIL']):
        ...
    @property
    ...
    def mask_map_mode(self, value: Literal['VIEW_PLANE', 'TILED', 'RANDOM', 'STENCIL']):
        ...
    @property
    ...
    def random_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]:
        ...
        ...
    @random_angle.setter
    def random_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
