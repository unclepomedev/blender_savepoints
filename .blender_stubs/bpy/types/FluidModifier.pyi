...
class FluidModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def domain_settings(self) -> Annotated[Optional['FluidDomainSettings'], "is_animatable=False"]:

        ...
    @property
    def flow_settings(self) -> Annotated[Optional['FluidFlowSettings'], "is_animatable=False"]:

        ...
    @property
    def effector_settings(self) -> Annotated[Optional['FluidEffectorSettings'], "is_animatable=False"]:

        ...
    @property
    def fluid_type(self) -> Annotated[Literal['NONE', 'DOMAIN', 'FLOW', 'EFFECTOR'], "is_animatable=False"]:

        ...
    @fluid_type.setter
    def fluid_type(self, value: Annotated[Literal['NONE', 'DOMAIN', 'FLOW', 'EFFECTOR'], "is_animatable=False"]) -> None:
        ...