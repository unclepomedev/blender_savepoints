...
class GreasePencilColorModifier(Modifier):
    ...
    color_mode: Literal['BOTH', 'STROKE', 'FILL']
    """Attributes to modify"""
    hue: Annotated[float, "step=0.10000000149011612", "precision=3"]
    """Color hue offset"""
    saturation: Annotated[float, "step=0.10000000149011612", "precision=3"]
    """Color saturation factor"""
    value: Annotated[float, "step=0.10000000149011612", "precision=3"]
    """Color value factor"""