...
https://docs.blender.org/api/current/bpy.types.GreasePencilColorModifier.html
"""
...
class GreasePencilColorModifier(Modifier):
    ...
    def color_mode(self, value: Literal['BOTH', 'STROKE', 'FILL']) -> None:
        ...
    @property
    def hue(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Color hue offset"""
        ...
    @hue.setter
    def hue(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    def saturation(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Color saturation factor"""
        ...
    @saturation.setter
    def saturation(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    def value(self) -> Annotated[float, "step=0.10000000149011612", "precision=3"]:
        """Color value factor"""
        ...
    @value.setter
    def value(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]) -> None:
        ...