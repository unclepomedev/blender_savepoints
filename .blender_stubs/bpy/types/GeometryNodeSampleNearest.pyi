...
class GeometryNodeSampleNearest(GeometryNode):
    ...
    @property
    def domain(self) -> Annotated[Literal['POINT', 'EDGE', 'FACE', 'CORNER'], "is_animatable=False"]:

        ...
    @domain.setter
    def domain(self, value: Annotated[Literal['POINT', 'EDGE', 'FACE', 'CORNER'], "is_animatable=False"]) -> None:
        ...
