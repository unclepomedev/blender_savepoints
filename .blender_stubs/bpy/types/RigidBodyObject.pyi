...
class RigidBodyObject(bpy_struct):
    ...
    def type(self) -> Annotated[Literal['ACTIVE', 'PASSIVE'], "is_animatable=False"]:
        ...
        ...
    @type.setter
    def type(self, value: Annotated[Literal['ACTIVE', 'PASSIVE'], "is_animatable=False"]):
        ...
    @property
    def mesh_source(self) -> Annotated[Literal['BASE', 'DEFORM', 'FINAL'], "is_animatable=False"]:
        ...
        ...
    @mesh_source.setter
    def mesh_source(self, value: Annotated[Literal['BASE', 'DEFORM', 'FINAL'], "is_animatable=False"]):
        ...
    @property
    ...
    def collision_shape(self, value: Annotated[Literal['BOX', 'SPHERE', 'CAPSULE', 'CYLINDER', 'CONE', 'CONVEX_HULL', 'MESH', 'COMPOUND'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_deactivation(self, value: bool):
        ...
    @property
    ...
    def use_start_deactivated(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def deactivate_linear_velocity(self, value: Annotated[float, "subtype=''", "unit='VELOCITY'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def deactivate_angular_velocity(self, value: Annotated[float, "subtype=''", "unit='VELOCITY'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def linear_damping(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def angular_damping(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def friction(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @friction.setter
    def friction(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]):
        ...
    @property
    def restitution(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @restitution.setter
    def restitution(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]):
        ...
    @property
    def use_margin(self) -> bool:
        ...
        ...
    @use_margin.setter
    def use_margin(self, value: bool):
        ...
    @property
    ...
    def collision_margin(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=0.009999999776482582", "precision=3"]):
        ...
    @property
    ...
    def collision_collections(self, value: Annotated[list[bool], "subtype='LAYER_MEMBER'"]):
        ...