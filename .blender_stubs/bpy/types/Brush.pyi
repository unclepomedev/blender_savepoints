...
class Brush(ID):
    ...
    def blend(self) -> Literal['MIX', 'DARKEN', 'MUL', 'COLORBURN', 'LINEARBURN', 'LIGHTEN', 'SCREEN', 'COLORDODGE', 'ADD', 'OVERLAY', 'SOFTLIGHT', 'HARDLIGHT', 'VIVIDLIGHT', 'LINEARLIGHT', 'PINLIGHT', 'DIFFERENCE', 'EXCLUSION', 'SUB', 'HUE', 'SATURATION', 'COLOR', 'LUMINOSITY', 'ERASE_ALPHA', 'ADD_ALPHA']:
        ...
        ...
    @blend.setter
    def blend(self, value: Literal['MIX', 'DARKEN', 'MUL', 'COLORBURN', 'LINEARBURN', 'LIGHTEN', 'SCREEN', 'COLORDODGE', 'ADD', 'OVERLAY', 'SOFTLIGHT', 'HARDLIGHT', 'VIVIDLIGHT', 'LINEARLIGHT', 'PINLIGHT', 'DIFFERENCE', 'EXCLUSION', 'SUB', 'HUE', 'SATURATION', 'COLOR', 'LUMINOSITY', 'ERASE_ALPHA', 'ADD_ALPHA']) -> None:
        ...
    @property
    ...
    def sculpt_brush_type(self, value: Literal['DRAW', 'DRAW_SHARP', 'CLAY', 'CLAY_STRIPS', 'CLAY_THUMB', 'LAYER', 'INFLATE', 'BLOB', 'CREASE', 'SMOOTH', 'PLANE', 'MULTIPLANE_SCRAPE', 'PINCH', 'GRAB', 'ELASTIC_DEFORM', 'SNAKE_HOOK', 'THUMB', 'POSE', 'NUDGE', 'ROTATE', 'TOPOLOGY', 'BOUNDARY', 'CLOTH', 'SIMPLIFY', 'MASK', 'DRAW_FACE_SETS', 'DISPLACEMENT_ERASER', 'DISPLACEMENT_SMEAR', 'PAINT', 'SMEAR']) -> None:
        ...
    @property
    ...
    def vertex_brush_type(self, value: Literal['DRAW', 'BLUR', 'AVERAGE', 'SMEAR']) -> None:
        ...
    @property
    ...
    def weight_brush_type(self, value: Literal['DRAW', 'BLUR', 'AVERAGE', 'SMEAR']) -> None:
        ...
    @property
    ...
    def image_brush_type(self, value: Literal['DRAW', 'SOFTEN', 'SMEAR', 'CLONE', 'FILL', 'MASK']) -> None:
        ...
    @property
    ...
    def gpencil_brush_type(self, value: Annotated[Literal['DRAW', 'FILL', 'ERASE', 'TINT'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gpencil_vertex_brush_type(self, value: Annotated[Literal['DRAW', 'BLUR', 'AVERAGE', 'SMEAR', 'REPLACE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gpencil_sculpt_brush_type(self, value: Annotated[Literal['SMOOTH', 'THICKNESS', 'STRENGTH', 'RANDOMIZE', 'GRAB', 'PUSH', 'TWIST', 'PINCH', 'CLONE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gpencil_weight_brush_type(self, value: Annotated[Literal['WEIGHT', 'BLUR', 'AVERAGE', 'SMEAR'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def curves_sculpt_brush_type(self, value: Annotated[Literal['SELECTION_PAINT', 'ADD', 'DELETE', 'DENSITY', 'COMB', 'SNAKE_HOOK', 'GROW_SHRINK', 'PINCH', 'PUFF', 'SMOOTH', 'SLIDE'], "is_animatable=False"]) -> None:
        ...
    @property
    def direction(self) -> Literal['ADD', 'SUBTRACT']:
        ...
        ...
    @direction.setter
    def direction(self, value: Literal['ADD', 'SUBTRACT']) -> None:
        ...
    @property
    ...
    def stroke_method(self, value: Literal['DOTS', 'DRAG_DOT', 'SPACE', 'AIRBRUSH', 'ANCHORED', 'LINE', 'CURVE']) -> None:
        ...
    @property
    def sculpt_plane(self) -> Literal['AREA', 'VIEW', 'X', 'Y', 'Z']:
        ...
        ...
    @sculpt_plane.setter
    def sculpt_plane(self, value: Literal['AREA', 'VIEW', 'X', 'Y', 'Z']) -> None:
        ...
    @property
    def mask_tool(self) -> Literal['DRAW', 'SMOOTH']:
        ...
        ...
    @mask_tool.setter
    def mask_tool(self, value: Literal['DRAW', 'SMOOTH']) -> None:
        ...
    @property
    ...
    def curve_distance_falloff_preset(self, value: Literal['CUSTOM', 'SMOOTH', 'SMOOTHER', 'SPHERE', 'ROOT', 'SHARP', 'LIN', 'POW4', 'INVSQUARE', 'CONSTANT']) -> None:
        ...
    @property
    ...
    def deform_target(self, value: Literal['GEOMETRY', 'CLOTH_SIM']) -> None:
        ...
    @property
    ...
    def elastic_deform_type(self, value: Literal['GRAB', 'GRAB_BISCALE', 'GRAB_TRISCALE', 'SCALE', 'TWIST']) -> None:
        ...
    @property
    ...
    def snake_hook_deform_type(self, value: Literal['FALLOFF', 'ELASTIC']) -> None:
        ...
    @property
    ...
    def plane_inversion_mode(self, value: Literal['INVERT_DISPLACEMENT', 'SWAP_DEPTH_AND_HEIGHT']) -> None:
        ...
    @property
    ...
    def cloth_deform_type(self, value: Literal['DRAG', 'PUSH', 'PINCH_POINT', 'PINCH_PERPENDICULAR', 'INFLATE', 'GRAB', 'EXPAND', 'SNAKE_HOOK']) -> None:
        ...
    @property
    ...
    def cloth_force_falloff_type(self, value: Literal['RADIAL', 'PLANE']) -> None:
        ...
    @property
    ...
    def cloth_simulation_area_type(self, value: Literal['LOCAL', 'GLOBAL', 'DYNAMIC']) -> None:
        ...
    @property
    ...
    def boundary_falloff_type(self, value: Literal['CONSTANT', 'RADIUS', 'LOOP', 'LOOP_INVERT']) -> None:
        ...
    @property
    ...
    def smooth_deform_type(self, value: Literal['LAPLACIAN', 'SURFACE']) -> None:
        ...
    @property
    ...
    def smear_deform_type(self, value: Literal['DRAG', 'PINCH', 'EXPAND']) -> None:
        ...
    @property
    ...
    def slide_deform_type(self, value: Literal['DRAG', 'PINCH', 'EXPAND']) -> None:
        ...
    @property
    ...
    def boundary_deform_type(self, value: Literal['BEND', 'EXPAND', 'INFLATE', 'GRAB', 'TWIST', 'SMOOTH']) -> None:
        ...
    @property
    ...
    def pose_deform_type(self, value: Literal['ROTATE_TWIST', 'SCALE_TRANSLATE', 'SQUASH_STRETCH']) -> None:
        ...
    @property
    ...
    def pose_origin_type(self, value: Literal['TOPOLOGY', 'FACE_SETS', 'FACE_SETS_FK']) -> None:
        ...
    @property
    def jitter_unit(self) -> Literal['VIEW', 'BRUSH']:
        ...
        ...
    @jitter_unit.setter
    def jitter_unit(self, value: Literal['VIEW', 'BRUSH']) -> None:
        ...
    @property
    ...
    def falloff_shape(self, value: Literal['SPHERE', 'PROJECTED']) -> None:
        ...
    @property
    def size(self) -> Annotated[int, "subtype='PIXEL_DIAMETER'", "step=1"]:
        ...
        ...
    @size.setter
    def size(self, value: Annotated[int, "subtype='PIXEL_DIAMETER'", "step=1"]) -> None:
        ...
    @property
    ...
    def unprojected_size(self, value: Annotated[float, "subtype='DISTANCE_DIAMETER'", "unit='LENGTH'", "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    ...
    def input_samples(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    def jitter(self) -> Annotated[float, "step=0.10000000149011612", "precision=4"]:
        ...
        ...
    @jitter.setter
    def jitter(self, value: Annotated[float, "step=0.10000000149011612", "precision=4"]) -> None:
        ...
    @property
    ...
    def jitter_absolute(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    def spacing(self) -> Annotated[int, "subtype='PERCENTAGE'", "step=5"]:
        ...
        ...
    @spacing.setter
    def spacing(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=5"]) -> None:
        ...
    @property
    def grad_spacing(self) -> Annotated[int, "subtype='PIXEL'", "step=5"]:
        ...
        ...
    @grad_spacing.setter
    def grad_spacing(self, value: Annotated[int, "subtype='PIXEL'", "step=5"]) -> None:
        ...
    @property
    ...
    def hue_jitter(self) -> Annotated[float, "step=0.05000000074505806", "precision=2"]:
        ...
        ...
    @hue_jitter.setter
    def hue_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2"]) -> None:
        ...
    @property
    ...
    def saturation_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2"]) -> None:
        ...
    @property
    def value_jitter(self) -> Annotated[float, "step=0.05000000074505806", "precision=2"]:
        ...
        ...
    @value_jitter.setter
    def value_jitter(self, value: Annotated[float, "step=0.05000000074505806", "precision=2"]) -> None:
        ...
    @property
    ...
    def smooth_stroke_radius(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]) -> None:
        ...
    @property
    ...
    def smooth_stroke_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def rate(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @rate.setter
    def rate(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def color(self) -> Annotated[list[float], "subtype='COLOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @color.setter
    def color(self, value: Annotated[list[float], "subtype='COLOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def secondary_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def weight(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @weight.setter
    def weight(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def strength(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def flow(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @flow.setter
    def flow(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def wet_mix(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @wet_mix.setter
    def wet_mix(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def wet_persistence(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def density(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @density.setter
    def density(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def tip_scale_x(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @tip_scale_x.setter
    def tip_scale_x(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_hardness_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def invert_hardness_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_flow_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def invert_flow_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_wet_mix_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def invert_wet_mix_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_wet_persistence_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def invert_wet_persistence_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_density_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def invert_density_pressure(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def dash_ratio(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @dash_ratio.setter
    def dash_ratio(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def dash_samples(self) -> Annotated[int, "subtype='UNSIGNED'", "step=5"]:
        ...
        ...
    @dash_samples.setter
    def dash_samples(self, value: Annotated[int, "subtype='UNSIGNED'", "step=5"]) -> None:
        ...
    @property
    def plane_offset(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @plane_offset.setter
    def plane_offset(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def plane_trim(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @plane_trim.setter
    def plane_trim(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def height(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        ...
        ...
    @height.setter
    def height(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def plane_depth(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @plane_depth.setter
    def plane_depth(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def plane_height(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @plane_height.setter
    def plane_height(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def stabilize_normal(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def stabilize_plane(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def texture_sample_bias(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_color_as_displacement(self, value: bool) -> None:
        ...
    @property
    ...
    def normal_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def elastic_deform_volume_preservation(self, value: Annotated[float, "step=0.009999999776482582", "precision=3"]) -> None:
        ...
    @property
    def rake_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]:
        ...
        ...
    @rake_factor.setter
    def rake_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def crease_pinch_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def pose_offset(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @pose_offset.setter
    def pose_offset(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def disconnected_distance_max(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def boundary_offset(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def surface_smooth_shape_preservation(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def surface_smooth_current_vertex(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def surface_smooth_iterations(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    ...
    def multiplane_scrape_angle(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def pose_smooth_iterations(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    ...
    def pose_ik_segments(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    ...
    def tip_roundness(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def cloth_mass(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @cloth_mass.setter
    def cloth_mass(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def cloth_damping(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def cloth_sim_limit(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def cloth_sim_falloff(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def cloth_constraint_softbody_strength(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def hardness(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @hardness.setter
    def hardness(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def automasking_boundary_edges_propagation_steps(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    ...
    def auto_smooth_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def topology_rake_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def tilt_strength_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def normal_radius_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def area_radius_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    ...
    def wet_paint_radius_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.0010000000474974513", "precision=3"]) -> None:
        ...
    @property
    def stencil_pos(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]:
        ...
        ...
    @stencil_pos.setter
    def stencil_pos(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def stencil_dimension(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def mask_stencil_pos(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def mask_stencil_dimension(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def sharp_threshold(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def fill_threshold(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def blur_kernel_radius(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def blur_mode(self) -> Literal['BOX', 'GAUSSIAN']:
        ...
        ...
    @blur_mode.setter
    def blur_mode(self, value: Literal['BOX', 'GAUSSIAN']) -> None:
        ...
    @property
    ...
    def falloff_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_automasking_cavity(self, value: bool) -> None:
        ...
    @property
    ...
    def use_automasking_cavity_inverted(self, value: bool) -> None:
        ...
    @property
    ...
    def use_automasking_custom_cavity_curve(self, value: bool) -> None:
        ...
    @property
    ...
    def automasking_cavity_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3"]) -> None:
        ...
    @property
    ...
    def automasking_cavity_blur_steps(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def use_automasking_start_normal(self, value: bool) -> None:
        ...
    @property
    ...
    def automasking_start_normal_limit(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def automasking_start_normal_falloff(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_automasking_view_normal(self, value: bool) -> None:
        ...
    @property
    ...
    def use_automasking_view_occlusion(self, value: bool) -> None:
        ...
    @property
    ...
    def automasking_view_normal_limit(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def automasking_view_normal_falloff(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_scene_spacing(self, value: Literal['VIEW', 'SCENE']) -> None:
        ...
    @property
    ...
    def use_paint_antialiasing(self, value: bool) -> None:
        ...
    @property
    ...
    def use_pressure_masking(self, value: Literal['NONE', 'RAMP', 'CUTOFF']) -> None:
        ...
    @property
    ...
    def use_locked_size(self, value: Literal['VIEW', 'SCENE']) -> None:
        ...
    @property
    def color_type(self) -> Literal['COLOR', 'GRADIENT']:
        ...
        ...
    @color_type.setter
    def color_type(self, value: Literal['COLOR', 'GRADIENT']) -> None:
        ...
    @property
    ...
    def paint_curve(self) -> Annotated[Optional['PaintCurve'], "is_animatable=False"]:
        ...
        ...
    @paint_curve.setter
    def paint_curve(self, value: Annotated[Optional['PaintCurve'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gradient_stroke_mode(self, value: Literal['PRESSURE', 'SPACING_REPEAT', 'SPACING_CLAMP']) -> None:
        ...
    @property
    ...
    def gradient_fill_mode(self, value: Literal['LINEAR', 'RADIAL']) -> None:
        ...
    @property
    ...
    def use_primary_overlay(self, value: bool) -> None:
        ...
    @property
    ...
    def use_secondary_overlay(self, value: bool) -> None:
        ...
    @property
    ...
    def use_cursor_overlay(self, value: bool) -> None:
        ...
    @property
    ...
    def use_cursor_overlay_override(self, value: bool) -> None:
        ...
    @property
    ...
    def use_primary_overlay_override(self, value: bool) -> None:
        ...
    @property
    ...
    def use_secondary_overlay_override(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_sculpt(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_uv_sculpt(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_vertex(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_weight(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_image(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_grease_pencil(self, value: bool) -> None:
        ...
    @property
    ...
    def use_vertex_grease_pencil(self, value: bool) -> None:
        ...
    @property
    ...
    def use_paint_sculpt_curves(self, value: bool) -> None:
        ...
    @property
    ...
    def texture_overlay_alpha(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=1"]) -> None:
        ...
    @property
    ...
    def mask_overlay_alpha(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=1"]) -> None:
        ...
    @property
    ...
    def cursor_overlay_alpha(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=1"]) -> None:
        ...
    @property
    ...
    def cursor_color_add(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def cursor_color_subtract(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
