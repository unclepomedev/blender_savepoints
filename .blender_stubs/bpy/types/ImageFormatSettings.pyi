...
class ImageFormatSettings(bpy_struct):
    ...
    def media_type(self) -> Annotated[Literal['IMAGE', 'MULTI_LAYER_IMAGE', 'VIDEO'], "is_animatable=False"]:
        ...
        ...
    @media_type.setter
    def media_type(self, value: Annotated[Literal['IMAGE', 'MULTI_LAYER_IMAGE', 'VIDEO'], "is_animatable=False"]) -> None:
        ...
    @property
    def file_format(self) -> Annotated[Literal['JPEG', 'OPEN_EXR', 'PNG', 'WEBP', 'BMP', 'CINEON', 'DPX', 'IRIS', 'JPEG2000', 'HDR', 'TARGA', 'TARGA_RAW', 'TIFF', 'OPEN_EXR_MULTILAYER', 'FFMPEG'], "is_animatable=False"]:
        ...
        ...
    @file_format.setter
    def file_format(self, value: Annotated[Literal['JPEG', 'OPEN_EXR', 'PNG', 'WEBP', 'BMP', 'CINEON', 'DPX', 'IRIS', 'JPEG2000', 'HDR', 'TARGA', 'TARGA_RAW', 'TIFF', 'OPEN_EXR_MULTILAYER', 'FFMPEG'], "is_animatable=False"]) -> None:
        ...
    @property
    def color_mode(self) -> Annotated[Literal['BW', 'RGB', 'RGBA'], "is_animatable=False"]:
        ...
        ...
    @color_mode.setter
    def color_mode(self, value: Annotated[Literal['BW', 'RGB', 'RGBA'], "is_animatable=False"]) -> None:
        ...
    @property
    def color_depth(self) -> Annotated[Literal['8', '10', '12', '16', '32'], "is_animatable=False"]:
        ...
        ...
    @color_depth.setter
    def color_depth(self, value: Annotated[Literal['8', '10', '12', '16', '32'], "is_animatable=False"]) -> None:
        ...
    @property
    def quality(self) -> Annotated[int, "subtype='PERCENTAGE'", "step=1", "is_animatable=False"]:
        ...
        ...
    @quality.setter
    def quality(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def compression(self) -> Annotated[int, "subtype='PERCENTAGE'", "step=1", "is_animatable=False"]:
        ...
        ...
    @compression.setter
    def compression(self, value: Annotated[int, "subtype='PERCENTAGE'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def use_preview(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_preview.setter
    def use_preview(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def exr_codec(self) -> Annotated[Literal['NONE', 'ZIP', 'PIZ', 'DWAA', 'DWAB', 'ZIPS', 'RLE', 'PXR24', 'B44', 'B44A'], "is_animatable=False"]:
        ...
        ...
    @exr_codec.setter
    def exr_codec(self, value: Annotated[Literal['NONE', 'ZIP', 'PIZ', 'DWAA', 'DWAB', 'ZIPS', 'RLE', 'PXR24', 'B44', 'B44A'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_exr_interleave(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_jpeg2k_ycc(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_jpeg2k_cinema_preset(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_jpeg2k_cinema_48(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def jpeg2k_codec(self) -> Annotated[Literal['JP2', 'J2K'], "is_animatable=False"]:
        ...
        ...
    @jpeg2k_codec.setter
    def jpeg2k_codec(self, value: Annotated[Literal['JP2', 'J2K'], "is_animatable=False"]) -> None:
        ...
    @property
    def tiff_codec(self) -> Annotated[Literal['NONE', 'DEFLATE', 'LZW', 'PACKBITS'], "is_animatable=False"]:
        ...
        ...
    @tiff_codec.setter
    def tiff_codec(self, value: Annotated[Literal['NONE', 'DEFLATE', 'LZW', 'PACKBITS'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_cineon_log(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def cineon_black(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @cineon_black.setter
    def cineon_black(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def cineon_white(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @cineon_white.setter
    def cineon_white(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def cineon_gamma(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @cineon_gamma.setter
    def cineon_gamma(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def views_format(self) -> Annotated[Literal['INDIVIDUAL', 'STEREO_3D', 'MULTIVIEW'], "is_animatable=False"]:
        ...
        ...
    @views_format.setter
    def views_format(self, value: Annotated[Literal['INDIVIDUAL', 'STEREO_3D', 'MULTIVIEW'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def color_management(self, value: Annotated[Literal['FOLLOW_SCENE', 'OVERRIDE'], "is_animatable=False"]) -> None:
        ...
    @property
