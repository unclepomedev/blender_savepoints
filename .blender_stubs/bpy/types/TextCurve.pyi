...
class TextCurve(Curve):
    ...
    def align_y(self) -> Literal['TOP', 'TOP_BASELINE', 'CENTER', 'BOTTOM_BASELINE', 'BOTTOM']:
        ...
        ...
    @align_y.setter
    def align_y(self, value: Literal['TOP', 'TOP_BASELINE', 'CENTER', 'BOTTOM_BASELINE', 'BOTTOM']):
        ...
    @property
    def overflow(self) -> Literal['NONE', 'SCALE', 'TRUNCATE']:
        ...
        ...
    @overflow.setter
    def overflow(self, value: Literal['NONE', 'SCALE', 'TRUNCATE']):
        ...
    @property
    ...
    def small_caps_scale(self, value: Annotated[float, "step=1.0", "precision=2"]):
        ...
    @property
    def space_line(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @space_line.setter
    def space_line(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def space_word(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @space_word.setter
    def space_word(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def space_character(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def shear(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @shear.setter
    def shear(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def offset_x(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @offset_x.setter
    def offset_x(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    def offset_y(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @offset_y.setter
    def offset_y(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def underline_position(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def underline_height(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def active_textbox(self, value: Annotated[int, "step=1"]):
        ...
    @property
    def family(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @family.setter
    def family(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def follow_curve(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @follow_curve.setter
    def follow_curve(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def font_bold(self) -> Annotated[Optional['VectorFont'], "is_animatable=False"]:
        ...
        ...
    @font_bold.setter
    def font_bold(self, value: Annotated[Optional['VectorFont'], "is_animatable=False"]):
        ...
    @property
    def font_italic(self) -> Annotated[Optional['VectorFont'], "is_animatable=False"]:
        ...
        ...
    @font_italic.setter
    def font_italic(self, value: Annotated[Optional['VectorFont'], "is_animatable=False"]):
        ...
    @property
    ...
    def font_bold_italic(self, value: Annotated[Optional['VectorFont'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_fast_edit(self, value: bool):
        ...
    @property
