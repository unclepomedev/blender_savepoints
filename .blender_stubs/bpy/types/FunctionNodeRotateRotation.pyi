...
class FunctionNodeRotateRotation(FunctionNode):
    ...
    @property
    def rotation_space(self) -> Annotated[Literal['GLOBAL', 'LOCAL'], "is_animatable=False"]:
        """Base orientation for the rotation"""
        ...
    @rotation_space.setter
    def rotation_space(self, value: Annotated[Literal['GLOBAL', 'LOCAL'], "is_animatable=False"]) -> None:
        ...
