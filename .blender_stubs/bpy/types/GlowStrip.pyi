...
class GlowStrip(EffectStrip):
    ...
    threshold: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Minimum intensity to trigger a glow"""
    clamp: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Brightness limit of intensity"""
    boost_factor: Annotated[float, "step=10.0", "precision=3"]
    """Brightness multiplier"""
    blur_radius: Annotated[float, "step=10.0", "precision=3"]
