...
https://docs.blender.org/api/current/bpy.types.GlowStrip.html
"""
...
class GlowStrip(EffectStrip):
    ...
    def input_1(self, value: Annotated['Strip', "is_animatable=False"]) -> None:
        ...
    @property
    def threshold(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Minimum intensity to trigger a glow"""
        ...
    @threshold.setter
    def threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def clamp(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Brightness limit of intensity"""
        ...
    @clamp.setter
    def clamp(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def boost_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Brightness multiplier"""
        ...
    @boost_factor.setter
    def boost_factor(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def blur_radius(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Radius of glow effect"""
        ...
    @blur_radius.setter
    def blur_radius(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def quality(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def use_only_boost(self) -> bool:
        """Show the glow buffer only"""
        ...
    @use_only_boost.setter
    def use_only_boost(self, value: bool) -> None:
        ...
