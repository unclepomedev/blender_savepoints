...
class GlowStrip(EffectStrip):
    ...
    def threshold(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @threshold.setter
    def threshold(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def clamp(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @clamp.setter
    def clamp(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def boost_factor(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @boost_factor.setter
    def boost_factor(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def blur_radius(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @blur_radius.setter
    def blur_radius(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_only_boost(self, value: bool):
        ...
