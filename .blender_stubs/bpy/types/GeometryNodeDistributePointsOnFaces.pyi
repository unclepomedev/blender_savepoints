...
https://docs.blender.org/api/current/bpy.types.GeometryNodeDistributePointsOnFaces.html
"""
...
class GeometryNodeDistributePointsOnFaces(GeometryNode):
    ...
    distribute_method: Annotated[Literal['RANDOM', 'POISSON'], "is_animatable=False"]
    """Method to use for scattering points"""
    use_legacy_normal: Annotated[bool, "is_animatable=False"]
