...
class GeometryNodeDistributePointsOnFaces(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def distribute_method(self) -> Annotated[Literal['RANDOM', 'POISSON'], "is_animatable=False"]:
        """Method to use for scattering points"""
        ...
    @distribute_method.setter
    def distribute_method(self, value: Annotated[Literal['RANDOM', 'POISSON'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_legacy_normal(self) -> Annotated[bool, "is_animatable=False"]:
    ...
    def use_legacy_normal(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
