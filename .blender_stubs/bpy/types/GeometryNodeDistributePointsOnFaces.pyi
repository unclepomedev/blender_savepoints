...
class GeometryNodeDistributePointsOnFaces(GeometryNode):
    ...
    def distribute_method(self, value: Annotated[Literal['RANDOM', 'POISSON'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_legacy_normal(self, value: Annotated[bool, "is_animatable=False"]):
        ...
