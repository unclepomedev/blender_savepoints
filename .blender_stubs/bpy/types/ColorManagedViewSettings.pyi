...
class ColorManagedViewSettings(bpy_struct):
    ...
    def look(self) -> Literal['NONE']:
        ...
        ...
    @look.setter
    def look(self, value: Literal['NONE']):
        ...
    @property
    ...
    def view_transform(self, value: Literal['NONE']):
        ...
    @property
    ...
    def gamma(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @gamma.setter
    def gamma(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_curve_mapping(self, value: bool):
        ...
    @property
    ...
    def use_white_balance(self, value: bool):
        ...
    @property
    ...
    def white_balance_temperature(self, value: Annotated[float, "subtype='COLOR_TEMPERATURE'", "unit='COLOR_TEMPERATURE'", "step=100.0", "precision=0"]):
        ...
    @property
    ...
    def white_balance_tint(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=1"]):
        ...
    @property
    ...
    def white_balance_whitepoint(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
