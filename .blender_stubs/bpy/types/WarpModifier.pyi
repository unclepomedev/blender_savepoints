...
class WarpModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    object_from: Annotated[Optional['Object'], "is_animatable=False"]
    """Object to transform from"""
    bone_from: Annotated[str, "is_animatable=False"]
    """Bone to transform from"""
    object_to: Annotated[Optional['Object'], "is_animatable=False"]
    """Object to transform to"""
    bone_to: Annotated[str, "is_animatable=False"]
    """Bone defining offset"""
    strength: Annotated[float, "step=10.0", "precision=2"]

    falloff_type: Literal['NONE', 'CURVE', 'SMOOTH', 'SPHERE', 'ROOT', 'INVERSE_SQUARE', 'SHARP', 'LINEAR', 'CONSTANT']

    falloff_radius: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]
    """Radius to apply"""
    @property
