...
class WarpModifier(Modifier):
    ...
    def strength(self) -> Annotated[float, "step=10.0", "precision=2"]:
        ...
        ...
    @strength.setter
    def strength(self, value: Annotated[float, "step=10.0", "precision=2"]):
        ...
    @property
    ...
    def falloff_radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_volume_preserve(self, value: bool):
        ...
    @property
