...
class MaintainVolumeConstraint(Constraint):
    ...
    def error_rotation(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @property
    def free_axis(self) -> Literal['SAMEVOL_X', 'SAMEVOL_Y', 'SAMEVOL_Z']:
        """The free scaling axis of the object"""
        ...
    @free_axis.setter
    def free_axis(self, value: Literal['SAMEVOL_X', 'SAMEVOL_Y', 'SAMEVOL_Z']) -> None:
        ...
    @property
    def mode(self) -> Literal['STRICT', 'UNIFORM', 'SINGLE_AXIS']:
        """The way the constraint treats original non-free axis scaling"""
        ...
    @mode.setter
    def mode(self, value: Literal['STRICT', 'UNIFORM', 'SINGLE_AXIS']) -> None:
        ...
    @property
    def volume(self) -> Annotated[float, "step=1.0", "precision=3"]:
        """Volume of the bone at rest"""
        ...
    @volume.setter
    def volume(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...