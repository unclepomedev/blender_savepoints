...
class MaintainVolumeConstraint(Constraint):
    ...
    def free_axis(self) -> Literal['SAMEVOL_X', 'SAMEVOL_Y', 'SAMEVOL_Z']:
        ...
        ...
    @free_axis.setter
    def free_axis(self, value: Literal['SAMEVOL_X', 'SAMEVOL_Y', 'SAMEVOL_Z']):
        ...
    @property
    def mode(self) -> Literal['STRICT', 'UNIFORM', 'SINGLE_AXIS']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['STRICT', 'UNIFORM', 'SINGLE_AXIS']):
        ...
    @property
    def volume(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @volume.setter
    def volume(self, value: Annotated[float, "step=1.0", "precision=3"]):
        ...