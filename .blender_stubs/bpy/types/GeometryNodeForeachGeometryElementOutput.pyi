...
class GeometryNodeForeachGeometryElementOutput(GeometryNode):
    ...
    def generation_items(self) -> Annotated['NodeGeometryForeachGeometryElementGenerationItems', "is_animatable=False"]:
        ...
        ...
    @property
    def active_input_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_input_index.setter
    def active_input_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_generation_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_generation_index.setter
    def active_generation_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_main_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_main_index.setter
    def active_main_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Literal['POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER']:
        ...
        ...
    @domain.setter
    def domain(self, value: Literal['POINT', 'EDGE', 'FACE', 'CORNER', 'CURVE', 'INSTANCE', 'LAYER']) -> None:
        ...
    @property
    def inspection_index(self) -> Annotated[int, "step=1"]:
        """Iteration index that is used by inspection features like the viewer node or socket inspection"""
        ...
    @inspection_index.setter
    def inspection_index(self, value: Annotated[int, "step=1"]) -> None:
        ...
