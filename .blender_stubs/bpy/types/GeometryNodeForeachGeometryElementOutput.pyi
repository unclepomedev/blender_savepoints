...
class GeometryNodeForeachGeometryElementOutput(GeometryNode):
    ...
    def active_generation_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def active_main_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def inspection_index(self, value: Annotated[int, "step=1"]):
        ...
