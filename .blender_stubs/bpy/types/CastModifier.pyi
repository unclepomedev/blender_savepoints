...
class CastModifier(Modifier):
    ...
    factor: Annotated[float, "subtype='FACTOR'", "step=5.0", "precision=2"]

    radius: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=5.0", "precision=2"]
    """Only deform vertices within this distance from the center of the effect (leave as 0 for infinite.)"""
    size: Annotated[float, "step=5.0", "precision=2"]
