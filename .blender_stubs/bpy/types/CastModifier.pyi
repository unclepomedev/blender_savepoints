...
class CastModifier(Modifier):
    ...
    def cast_type(self) -> Literal['SPHERE', 'CYLINDER', 'CUBOID']:
        ...
        ...
    @cast_type.setter
    def cast_type(self, value: Literal['SPHERE', 'CYLINDER', 'CUBOID']):
        ...
    @property
    ...
    def use_radius_as_size(self, value: bool):
        ...
    @property
    ...
    def use_transform(self, value: bool):
        ...
    @property
    def factor(self) -> Annotated[float, "subtype='FACTOR'", "step=5.0", "precision=2"]:
        ...
        ...
    @factor.setter
    def factor(self, value: Annotated[float, "subtype='FACTOR'", "step=5.0", "precision=2"]):
        ...
    @property
    def radius(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=5.0", "precision=2"]:
        ...
        ...
    @radius.setter
    def radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=5.0", "precision=2"]):
        ...
    @property
    def size(self) -> Annotated[float, "step=5.0", "precision=2"]:
        ...
        ...
    @size.setter
    def size(self, value: Annotated[float, "step=5.0", "precision=2"]):
        ...
    @property
