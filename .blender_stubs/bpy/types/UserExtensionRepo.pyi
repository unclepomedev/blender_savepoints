...
class UserExtensionRepo(bpy_struct):
    ...
    def custom_directory(self, value: Annotated[str, "subtype='DIR_PATH'", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def remote_url(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @remote_url.setter
    def remote_url(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def access_token(self) -> Annotated[str, "subtype='PASSWORD'", "is_animatable=False"]:
        ...
        ...
    @access_token.setter
    def access_token(self, value: Annotated[str, "subtype='PASSWORD'", "is_animatable=False"]) -> None:
        ...
    @property
    def source(self) -> Literal['USER', 'SYSTEM']:
        ...
        ...
    @source.setter
    def source(self, value: Literal['USER', 'SYSTEM']) -> None:
        ...
    @property
    ...
    def use_sync_on_startup(self, value: bool) -> None:
        ...
    @property
    ...
    def use_access_token(self, value: bool) -> None:
        ...
    @property
    ...
    def use_custom_directory(self, value: bool) -> None:
        ...
    @property
    ...
    def use_remote_url(self, value: bool) -> None:
        ...