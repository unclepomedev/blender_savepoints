...
https://docs.blender.org/api/current/bpy.types.MovieClipStrip.html
"""
...
class MovieClipStrip(Strip):
    ...
    def undistort(self) -> bool:
        ...
        ...
    @undistort.setter
    def undistort(self, value: bool) -> None:
        ...
    @property
    def stabilize2d(self) -> bool:
        """Use the 2D stabilized version of the clip"""
        ...
    @stabilize2d.setter
    def stabilize2d(self, value: bool) -> None:
        ...
    @property
