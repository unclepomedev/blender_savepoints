...
https://docs.blender.org/api/current/bpy.types.NodeSocketVectorTranslation2D.html
"""
...
class NodeSocketVectorTranslation2D(NodeSocketStandard):
    ...
    def default_value(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
