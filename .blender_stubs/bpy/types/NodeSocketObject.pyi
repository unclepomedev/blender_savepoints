...
https://docs.blender.org/api/current/bpy.types.NodeSocketObject.html
"""
...
class NodeSocketObject(NodeSocketStandard):
    ...
    def bl_subtype_label(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def default_value(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
