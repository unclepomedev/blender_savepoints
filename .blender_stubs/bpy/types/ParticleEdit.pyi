...
class ParticleEdit(bpy_struct):
    ...
    def tool(self) -> Annotated[Literal['COMB', 'SMOOTH', 'ADD', 'LENGTH', 'PUFF', 'CUT', 'WEIGHT'], "is_animatable=False"]:
        ...
        ...
    @tool.setter
    def tool(self, value: Annotated[Literal['COMB', 'SMOOTH', 'ADD', 'LENGTH', 'PUFF', 'CUT', 'WEIGHT'], "is_animatable=False"]):
        ...
    @property
    def select_mode(self) -> Annotated[Literal['PATH', 'POINT', 'TIP'], "is_animatable=False"]:
        ...
        ...
    @select_mode.setter
    def select_mode(self, value: Annotated[Literal['PATH', 'POINT', 'TIP'], "is_animatable=False"]):
        ...
    @property
    ...
    def use_preserve_length(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_preserve_root(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_emitter_deflect(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def emitter_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3", "is_animatable=False"]):
        ...
    @property
    ...
    def use_fade_time(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_auto_velocity(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def show_particles(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def use_default_interpolate(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
    ...
    def default_key_count(self, value: Annotated[int, "step=10", "is_animatable=False"]):
        ...
    @property
    ...
    def display_step(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @display_step.setter
    def display_step(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def fade_frames(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @fade_frames.setter
    def fade_frames(self, value: Annotated[int, "step=1", "is_animatable=False"]):
        ...
    @property
    def type(self) -> Annotated[Literal['PARTICLES', 'SOFT_BODY', 'CLOTH'], "is_animatable=False"]:
        ...
        ...
    @type.setter
    def type(self, value: Annotated[Literal['PARTICLES', 'SOFT_BODY', 'CLOTH'], "is_animatable=False"]):
        ...
    @property
    ...
    def shape_object(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @shape_object.setter
    def shape_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...