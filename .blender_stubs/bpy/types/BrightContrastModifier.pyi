...
class BrightContrastModifier(StripModifier):
    ...
    def bright(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]:
        ...
        ...
    @bright.setter
    def bright(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def contrast(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]:
        ...
        ...
    @contrast.setter
    def contrast(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
