...
class MovieClipProxy(bpy_struct):
    ...
    def build_25(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @build_25.setter
    def build_25(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def build_50(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @build_50.setter
    def build_50(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def build_75(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @build_75.setter
    def build_75(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def build_100(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @build_100.setter
    def build_100(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def build_undistorted_25(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def build_undistorted_50(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def build_undistorted_75(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def build_undistorted_100(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def build_record_run(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def quality(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        ...
        ...
    @quality.setter
    def quality(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def timecode(self) -> Annotated[Literal['NONE', 'RECORD_RUN', 'FREE_RUN_NO_GAPS'], "is_animatable=False"]:
        ...
        ...
    @timecode.setter
    def timecode(self, value: Annotated[Literal['NONE', 'RECORD_RUN', 'FREE_RUN_NO_GAPS'], "is_animatable=False"]) -> None:
        ...
    @property
