...
class GeometryNodeGizmoLinear(GeometryNode):
    ...
    @property
    def color_id(self) -> Annotated[Literal['PRIMARY', 'SECONDARY', 'X', 'Y', 'Z'], "is_animatable=False"]:

        ...
    @color_id.setter
    def color_id(self, value: Annotated[Literal['PRIMARY', 'SECONDARY', 'X', 'Y', 'Z'], "is_animatable=False"]) -> None:
        ...
    @property
    def draw_style(self) -> Annotated[Literal['ARROW', 'CROSS', 'BOX'], "is_animatable=False"]:

        ...
    @draw_style.setter
    def draw_style(self, value: Annotated[Literal['ARROW', 'CROSS', 'BOX'], "is_animatable=False"]) -> None:
        ...
