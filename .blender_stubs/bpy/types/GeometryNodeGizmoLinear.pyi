...
https://docs.blender.org/api/current/bpy.types.GeometryNodeGizmoLinear.html
"""
...
class GeometryNodeGizmoLinear(GeometryNode):
    ...
    color_id: Annotated[Literal['PRIMARY', 'SECONDARY', 'X', 'Y', 'Z'], "is_animatable=False"]

    draw_style: Annotated[Literal['ARROW', 'CROSS', 'BOX'], "is_animatable=False"]
