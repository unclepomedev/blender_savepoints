...
class SpaceClipEditor(Space):
    ...
    def mode(self) -> Literal['TRACKING', 'MASK']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['TRACKING', 'MASK']) -> None:
        ...
    @property
    def view(self) -> Literal['CLIP', 'GRAPH', 'DOPESHEET']:
        ...
        ...
    @view.setter
    def view(self, value: Literal['CLIP', 'GRAPH', 'DOPESHEET']) -> None:
        ...
    @property
    ...
    def show_marker_pattern(self, value: bool) -> None:
        ...
    @property
    ...
    def show_marker_search(self, value: bool) -> None:
        ...
    @property
    ...
    def lock_selection(self, value: bool) -> None:
        ...
    @property
    ...
    def lock_time_cursor(self, value: bool) -> None:
        ...
    @property
    ...
    def show_track_path(self, value: bool) -> None:
        ...
    @property
    def path_length(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @path_length.setter
    def path_length(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def show_tiny_markers(self, value: bool) -> None:
        ...
    @property
    def show_bundles(self) -> bool:
        ...
        ...
    @show_bundles.setter
    def show_bundles(self, value: bool) -> None:
        ...
    @property
    ...
    def use_mute_footage(self, value: bool) -> None:
        ...
    @property
    ...
    def show_disabled(self, value: bool) -> None:
        ...
    @property
    ...
    def show_stable(self) -> bool:
        ...
        ...
    @show_stable.setter
    def show_stable(self, value: bool) -> None:
        ...
    @property
    ...
    def use_manual_calibration(self, value: bool) -> None:
        ...
    @property
    ...
    def show_filters(self) -> bool:
        ...
        ...
    @show_filters.setter
    def show_filters(self, value: bool) -> None:
        ...
    @property
    ...
    def show_graph_frames(self, value: bool) -> None:
        ...
    @property
    ...
    def show_graph_tracks_motion(self, value: bool) -> None:
        ...
    @property
    ...
    def show_graph_tracks_error(self, value: bool) -> None:
        ...
    @property
    ...
    def show_graph_only_selected(self, value: bool) -> None:
        ...
    @property
    ...
    def show_graph_hidden(self, value: bool) -> None:
        ...
    @property
    ...
    def show_red_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def show_green_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def show_blue_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def use_grayscale_preview(self, value: bool) -> None:
        ...
    @property
    ...
    def annotation_source(self, value: Literal['CLIP', 'TRACK']) -> None:
        ...
    @property
    ...
    def pivot_point(self) -> Literal['BOUNDING_BOX_CENTER', 'CURSOR', 'INDIVIDUAL_ORIGINS', 'MEDIAN_POINT']:
        ...
        ...
    @pivot_point.setter
    def pivot_point(self, value: Literal['BOUNDING_BOX_CENTER', 'CURSOR', 'INDIVIDUAL_ORIGINS', 'MEDIAN_POINT']) -> None:
        ...
    @property
