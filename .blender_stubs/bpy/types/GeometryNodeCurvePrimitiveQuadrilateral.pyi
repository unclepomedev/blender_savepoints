...
https://docs.blender.org/api/current/bpy.types.GeometryNodeCurvePrimitiveQuadrilateral.html
"""
...
class GeometryNodeCurvePrimitiveQuadrilateral(GeometryNode):
    ...
    mode: Annotated[Literal['RECTANGLE', 'PARALLELOGRAM', 'TRAPEZOID', 'KITE', 'POINTS'], "is_animatable=False"]
