...
class GeometryNodeCurvePrimitiveQuadrilateral(GeometryNode):
    ...
    @property
    def mode(self) -> Annotated[Literal['RECTANGLE', 'PARALLELOGRAM', 'TRAPEZOID', 'KITE', 'POINTS'], "is_animatable=False"]:

        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['RECTANGLE', 'PARALLELOGRAM', 'TRAPEZOID', 'KITE', 'POINTS'], "is_animatable=False"]) -> None:
        ...
