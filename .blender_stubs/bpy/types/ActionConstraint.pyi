...
class ActionConstraint(Constraint):
    ...
    def mix_mode(self) -> Literal['REPLACE', 'BEFORE_FULL', 'BEFORE', 'BEFORE_SPLIT', 'AFTER_FULL', 'AFTER', 'AFTER_SPLIT']:
        ...
        ...
    @mix_mode.setter
    def mix_mode(self, value: Literal['REPLACE', 'BEFORE_FULL', 'BEFORE', 'BEFORE_SPLIT', 'AFTER_FULL', 'AFTER', 'AFTER_SPLIT']) -> None:
        ...
    @property
    ...
    def transform_channel(self, value: Literal['LOCATION_X', 'LOCATION_Y', 'LOCATION_Z', 'ROTATION_X', 'ROTATION_Y', 'ROTATION_Z', 'SCALE_X', 'SCALE_Y', 'SCALE_Z']) -> None:
        ...
    @property
    ...
    def use_bone_object_action(self, value: bool) -> None:
        ...
    @property
    ...
    def eval_time(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @eval_time.setter
    def eval_time(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_eval_time(self, value: bool) -> None:
        ...