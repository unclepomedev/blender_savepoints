...
https://docs.blender.org/api/current/bpy.types.FunctionNodeIntegerMath.html
"""
...
class FunctionNodeIntegerMath(FunctionNode):
    ...
    operation: Annotated[Literal['ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE', 'MULTIPLY_ADD', 'ABSOLUTE', 'NEGATE', 'POWER', 'MINIMUM', 'MAXIMUM', 'SIGN', 'DIVIDE_ROUND', 'DIVIDE_FLOOR', 'DIVIDE_CEIL', 'FLOORED_MODULO', 'MODULO', 'GCD', 'LCM'], "is_animatable=False"]
