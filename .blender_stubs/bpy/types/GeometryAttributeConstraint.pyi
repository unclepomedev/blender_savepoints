...
class GeometryAttributeConstraint(Constraint):
    ...
    def attribute_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def domain(self) -> Literal['POINT', 'EDGE', 'FACE', 'FACE_CORNER', 'CURVE', 'INSTANCE']:
        ...
        ...
    @domain.setter
    def domain(self, value: Literal['POINT', 'EDGE', 'FACE', 'FACE_CORNER', 'CURVE', 'INSTANCE']) -> None:
        ...
    @property
    ...
    def apply_target_transform(self, value: bool) -> None:
        ...
    @property
    def data_type(self) -> Literal['VECTOR', 'QUATERNION', 'FLOAT4X4']:
        ...
        ...
    @data_type.setter
    def data_type(self, value: Literal['VECTOR', 'QUATERNION', 'FLOAT4X4']) -> None:
        ...
    @property
    def sample_index(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @sample_index.setter
    def sample_index(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    def mix_loc(self) -> bool:
        ...
        ...
    @mix_loc.setter
    def mix_loc(self, value: bool) -> None:
        ...
    @property
    def mix_rot(self) -> bool:
        ...
        ...
    @mix_rot.setter
    def mix_rot(self, value: bool) -> None:
        ...
    @property
    def mix_scl(self) -> bool:
        ...
        ...
    @mix_scl.setter
    def mix_scl(self, value: bool) -> None:
        ...
    @property
    def mix_mode(self) -> Literal['REPLACE', 'BEFORE_FULL', 'BEFORE_SPLIT', 'AFTER_FULL', 'AFTER_SPLIT']:
        ...
        ...
    @mix_mode.setter
    def mix_mode(self, value: Literal['REPLACE', 'BEFORE_FULL', 'BEFORE_SPLIT', 'AFTER_FULL', 'AFTER_SPLIT']) -> None:
        ...