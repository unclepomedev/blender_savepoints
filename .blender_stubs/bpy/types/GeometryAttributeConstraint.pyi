...
class GeometryAttributeConstraint(Constraint):
    ...
    mix_scl: bool
    """Mix Scale"""
    mix_mode: Literal['REPLACE', 'BEFORE_FULL', 'BEFORE_SPLIT', 'AFTER_FULL', 'AFTER_SPLIT']
