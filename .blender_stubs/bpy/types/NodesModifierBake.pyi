...
class NodesModifierBake(bpy_struct):
    ...
    def use_custom_simulation_frame_range(self, value: bool) -> None:
        ...
    @property
    ...
    def use_custom_path(self, value: bool) -> None:
        ...
    @property
    def bake_target(self) -> Literal['INHERIT', 'PACKED', 'DISK']:
        ...
        ...
    @bake_target.setter
    def bake_target(self, value: Literal['INHERIT', 'PACKED', 'DISK']) -> None:
        ...
    @property
    def bake_mode(self) -> Literal['ANIMATION', 'STILL']:
        ...
        ...
    @bake_mode.setter
    def bake_mode(self, value: Literal['ANIMATION', 'STILL']) -> None:
        ...
    @property
