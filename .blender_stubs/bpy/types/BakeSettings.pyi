...
class BakeSettings(bpy_struct):
    ...
    def type(self) -> Annotated[Literal['NORMALS', 'DISPLACEMENT', 'VECTOR_DISPLACEMENT'], "is_animatable=False"]:
        ...
        ...
    @type.setter
    def type(self, value: Annotated[Literal['NORMALS', 'DISPLACEMENT', 'VECTOR_DISPLACEMENT'], "is_animatable=False"]) -> None:
        ...
    @property
    def cage_object(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @cage_object.setter
    def cage_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def width(self) -> Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]:
        ...
        ...
    @width.setter
    def width(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def height(self) -> Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]:
        ...
        ...
    @height.setter
    def height(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def margin_type(self) -> Annotated[Literal['ADJACENT_FACES', 'EXTEND'], "is_animatable=False"]:
        ...
        ...
    @margin_type.setter
    def margin_type(self, value: Annotated[Literal['ADJACENT_FACES', 'EXTEND'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def max_ray_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def cage_extrusion(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def normal_space(self) -> Annotated[Literal['OBJECT', 'TANGENT'], "is_animatable=False"]:
        ...
        ...
    @normal_space.setter
    def normal_space(self, value: Annotated[Literal['OBJECT', 'TANGENT'], "is_animatable=False"]) -> None:
        ...
    @property
    def normal_r(self) -> Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]:
        ...
        ...
    @normal_r.setter
    def normal_r(self, value: Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]) -> None:
        ...
    @property
    def normal_g(self) -> Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]:
        ...
        ...
    @normal_g.setter
    def normal_g(self, value: Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]) -> None:
        ...
    @property
    def normal_b(self) -> Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]:
        ...
        ...
    @normal_b.setter
    def normal_b(self, value: Annotated[Literal['POS_X', 'POS_Y', 'POS_Z', 'NEG_X', 'NEG_Y', 'NEG_Z'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def target(self) -> Annotated[Literal['IMAGE_TEXTURES', 'VERTEX_COLORS'], "is_animatable=False"]:
        ...
        ...
    @target.setter
    def target(self, value: Annotated[Literal['IMAGE_TEXTURES', 'VERTEX_COLORS'], "is_animatable=False"]) -> None:
        ...
    @property
    def save_mode(self) -> Annotated[Literal['INTERNAL', 'EXTERNAL'], "is_animatable=False"]:
        ...
        ...
    @save_mode.setter
    def save_mode(self, value: Annotated[Literal['INTERNAL', 'EXTERNAL'], "is_animatable=False"]) -> None:
        ...
    @property
    def view_from(self) -> Annotated[Literal['ABOVE_SURFACE', 'ACTIVE_CAMERA'], "is_animatable=False"]:
        ...
        ...
    @view_from.setter
    def view_from(self, value: Annotated[Literal['ABOVE_SURFACE', 'ACTIVE_CAMERA'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_selected_to_active(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def use_clear(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_clear.setter
    def use_clear(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_split_materials(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automatic_name(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def use_cage(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_cage.setter
    def use_cage(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_emit(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_direct(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_indirect(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_color(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_diffuse(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_glossy(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_pass_transmission(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_multires(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_multires.setter
    def use_multires(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_lores_mesh(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def displacement_space(self, value: Annotated[Literal['OBJECT', 'TANGENT'], "is_animatable=False"]) -> None:
        ...