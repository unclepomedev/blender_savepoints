...
class PreferencesEdit(bpy_struct):
    ...
    def material_link(self, value: Literal['OBDATA', 'OBJECT']):
        ...
    @property
    def object_align(self) -> Literal['WORLD', 'VIEW', 'CURSOR']:
        ...
        ...
    @object_align.setter
    def object_align(self, value: Literal['WORLD', 'VIEW', 'CURSOR']):
        ...
    @property
    ...
    def use_enter_edit_mode(self, value: bool):
        ...
    @property
    ...
    def collection_instance_empty_size(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def use_text_edit_auto_close(self, value: bool):
        ...
    @property
    def undo_steps(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @undo_steps.setter
    def undo_steps(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def undo_memory_limit(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_global_undo(self, value: bool):
        ...
    @property
    ...
    def use_auto_keying(self, value: bool):
        ...
    @property
    ...
    def auto_keying_mode(self, value: Literal['ADD_REPLACE_KEYS', 'REPLACE_KEYS']):
        ...
    @property
    ...
    def use_keyframe_insert_available(self, value: bool):
        ...
    @property
    ...
    def use_auto_keying_warning(self, value: bool):
        ...
    @property
    ...
    def key_insert_channels(self, value: set[str]):
        ...
    @property
    ...
    def use_auto_keyframe_insert_needed(self, value: bool):
        ...
    @property
    ...
    def use_keyframe_insert_needed(self, value: bool):
        ...
    @property
    ...
    def use_visual_keying(self, value: bool):
        ...
    @property
    ...
    def use_insertkey_xyz_to_rgb(self, value: bool):
        ...
    @property
    ...
    def use_anim_channel_group_colors(self, value: bool):
        ...
    @property
    ...
    def fcurve_new_auto_smoothing(self, value: Literal['NONE', 'CONT_ACCEL']):
        ...
    @property
    ...
    def keyframe_new_interpolation_type(self, value: Literal['CONSTANT', 'LINEAR', 'BEZIER', 'SINE', 'QUAD', 'CUBIC', 'QUART', 'QUINT', 'EXPO', 'CIRC', 'BACK', 'BOUNCE', 'ELASTIC']):
        ...
    @property
    ...
    def keyframe_new_handle_type(self, value: Literal['FREE', 'ALIGNED', 'VECTOR', 'AUTO', 'AUTO_CLAMPED']):
        ...
    @property
    ...
    def use_negative_frames(self, value: bool):
        ...
    @property
    ...
    def fcurve_unselected_alpha(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def show_only_selected_curve_keyframes(self, value: bool):
        ...
    @property
    ...
    def use_fcurve_high_quality_drawing(self, value: bool):
        ...
    @property
    ...
    def grease_pencil_manhattan_distance(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def grease_pencil_euclidean_distance(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def grease_pencil_eraser_radius(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def grease_pencil_default_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def sculpt_paint_overlay_color(self, value: Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def connect_strips_by_default(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_mesh(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_surface(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_curve(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_lattice(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_text(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_metaball(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_armature(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_camera(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_speaker(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_light(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_material(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_action(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_particle(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_lightprobe(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_grease_pencil(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_curves(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_pointcloud(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_volume(self, value: bool):
        ...
    @property
    ...
    def use_duplicate_node_tree(self, value: bool):
        ...
    @property
    ...
    def node_use_insert_offset(self, value: bool):
        ...
    @property
    def node_margin(self) -> Annotated[int, "subtype='PIXEL'", "step=1"]:
        ...
        ...
    @node_margin.setter
    def node_margin(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def node_preview_resolution(self, value: Annotated[int, "subtype='PIXEL'", "step=1"]):
        ...
    @property
    ...
    def use_cursor_lock_adjust(self, value: bool):
        ...
    @property
    ...
    def use_mouse_depth_cursor(self, value: bool):
        ...