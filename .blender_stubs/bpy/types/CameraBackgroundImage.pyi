...
class CameraBackgroundImage(bpy_struct):
    ...
    def source(self) -> Literal['IMAGE', 'MOVIE_CLIP']:
        ...
        ...
    @source.setter
    def source(self, value: Literal['IMAGE', 'MOVIE_CLIP']):
        ...
    @property
    ...
    def offset(self) -> Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]:
        ...
        ...
    @offset.setter
    def offset(self, value: Annotated[list[float], "subtype='XYZ'", "step=0.10000000149011612", "precision=5"]):
        ...
    @property
    def scale(self) -> Annotated[float, "step=0.10000000149011612", "precision=5"]:
        ...
        ...
    @scale.setter
    def scale(self, value: Annotated[float, "step=0.10000000149011612", "precision=5"]):
        ...
    @property
    ...
    def use_camera_clip(self, value: bool):
        ...
    @property
    ...
    def show_background_image(self, value: bool):
        ...
    @property
    ...
    def show_on_foreground(self, value: bool):
        ...
    @property
    ...
    def display_depth(self, value: Literal['BACK', 'FRONT']):
        ...
    @property
