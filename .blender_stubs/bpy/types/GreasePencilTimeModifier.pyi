...
class GreasePencilTimeModifier(Modifier):
    ...
    def segments(self) -> Annotated[bpy_prop_collection['GreasePencilTimeModifierSegment'], "is_animatable=False"]:
        ...
        ...
    segment_active_index: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]
    """Active index in the segment list"""
    mode: Literal['NORMAL', 'REVERSE', 'FIX', 'PINGPONG', 'CHAIN']

    offset: Annotated[int, "step=1"]
