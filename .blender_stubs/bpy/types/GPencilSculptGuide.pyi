...
class GPencilSculptGuide(bpy_struct):
    ...
    def use_snapping(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @use_snapping.setter
    def use_snapping(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def reference_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def reference_point(self, value: Annotated[Literal['CURSOR', 'CUSTOM', 'OBJECT'], "is_animatable=False"]) -> None:
        ...
    @property
    def type(self) -> Annotated[Literal['CIRCULAR', 'RADIAL', 'PARALLEL', 'GRID', 'ISO'], "is_animatable=False"]:
        ...
        ...
    @type.setter
    def type(self, value: Annotated[Literal['CIRCULAR', 'RADIAL', 'PARALLEL', 'GRID', 'ISO'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def angle_snap(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @angle_snap.setter
    def angle_snap(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def spacing(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @spacing.setter
    def spacing(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def location(self) -> Annotated[list[float], "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @location.setter
    def location(self, value: Annotated[list[float], "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...