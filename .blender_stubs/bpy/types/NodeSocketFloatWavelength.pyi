...
https://docs.blender.org/api/current/bpy.types.NodeSocketFloatWavelength.html
"""
...
class NodeSocketFloatWavelength(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[float, "subtype='WAVELENGTH'", "unit='WAVELENGTH'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[float, "subtype='WAVELENGTH'", "unit='WAVELENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
