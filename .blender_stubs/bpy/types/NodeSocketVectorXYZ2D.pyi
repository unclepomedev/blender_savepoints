...
https://docs.blender.org/api/current/bpy.types.NodeSocketVectorXYZ2D.html
"""
...
class NodeSocketVectorXYZ2D(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[list[float], "subtype='XYZ'", "step=10.0", "precision=3"]) -> None:
        ...
