...
class DataTransferModifier(Modifier):
    ...
    def use_object_transform(self, value: bool) -> None:
        ...
    @property
    ...
    def use_vert_data(self, value: bool) -> None:
        ...
    @property
    ...
    def use_edge_data(self, value: bool) -> None:
        ...
    @property
    ...
    def use_loop_data(self, value: bool) -> None:
        ...
    @property
    ...
    def use_poly_data(self, value: bool) -> None:
        ...
    @property
    ...
    def data_types_verts(self, value: set[str]) -> None:
        ...
    @property
    ...
    def data_types_edges(self, value: set[str]) -> None:
        ...
    @property
    ...
    def data_types_loops(self, value: set[str]) -> None:
        ...
    @property
    ...
    def data_types_polys(self, value: set[str]) -> None:
        ...
    @property
    def vert_mapping(self) -> Literal['TOPOLOGY', 'NEAREST', 'EDGE_NEAREST', 'EDGEINTERP_NEAREST', 'POLY_NEAREST', 'POLYINTERP_NEAREST', 'POLYINTERP_VNORPROJ']:
        ...
        ...
    @vert_mapping.setter
    def vert_mapping(self, value: Literal['TOPOLOGY', 'NEAREST', 'EDGE_NEAREST', 'EDGEINTERP_NEAREST', 'POLY_NEAREST', 'POLYINTERP_NEAREST', 'POLYINTERP_VNORPROJ']) -> None:
        ...
    @property
    def edge_mapping(self) -> Literal['TOPOLOGY', 'VERT_NEAREST', 'NEAREST', 'POLY_NEAREST', 'EDGEINTERP_VNORPROJ']:
        ...
        ...
    @edge_mapping.setter
    def edge_mapping(self, value: Literal['TOPOLOGY', 'VERT_NEAREST', 'NEAREST', 'POLY_NEAREST', 'EDGEINTERP_VNORPROJ']) -> None:
        ...
    @property
    def loop_mapping(self) -> Literal['TOPOLOGY', 'NEAREST_NORMAL', 'NEAREST_POLYNOR', 'NEAREST_POLY', 'POLYINTERP_NEAREST', 'POLYINTERP_LNORPROJ']:
        ...
        ...
    @loop_mapping.setter
    def loop_mapping(self, value: Literal['TOPOLOGY', 'NEAREST_NORMAL', 'NEAREST_POLYNOR', 'NEAREST_POLY', 'POLYINTERP_NEAREST', 'POLYINTERP_LNORPROJ']) -> None:
        ...
    @property
    def poly_mapping(self) -> Literal['TOPOLOGY', 'NEAREST', 'NORMAL', 'POLYINTERP_PNORPROJ']:
        ...
        ...
    @poly_mapping.setter
    def poly_mapping(self, value: Literal['TOPOLOGY', 'NEAREST', 'NORMAL', 'POLYINTERP_PNORPROJ']) -> None:
        ...
    @property
    ...
    def max_distance(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        ...
        ...
    @max_distance.setter
    def max_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    def ray_radius(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]:
        ...
        ...
    @ray_radius.setter
    def ray_radius(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def islands_precision(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def layers_vgroup_select_src(self, value: Literal['ACTIVE', 'ALL', 'BONE_SELECT', 'BONE_DEFORM']) -> None:
        ...
    @property
    ...
    def layers_vcol_vert_select_src(self, value: Literal['ACTIVE', 'ALL', 'BONE_SELECT', 'BONE_DEFORM']) -> None:
        ...
    @property
    ...
    def layers_vcol_loop_select_src(self, value: Literal['ACTIVE', 'ALL', 'BONE_SELECT', 'BONE_DEFORM']) -> None:
        ...
    @property
    ...
    def layers_uv_select_src(self, value: Literal['ACTIVE', 'ALL', 'BONE_SELECT', 'BONE_DEFORM']) -> None:
        ...
    @property
    ...
    def layers_vgroup_select_dst(self, value: Literal['ACTIVE', 'NAME', 'INDEX']) -> None:
        ...
    @property
    ...
    def layers_vcol_vert_select_dst(self, value: Literal['ACTIVE', 'NAME', 'INDEX']) -> None:
        ...
    @property
    ...
    def layers_vcol_loop_select_dst(self, value: Literal['ACTIVE', 'NAME', 'INDEX']) -> None:
        ...
    @property
    ...
    def layers_uv_select_dst(self, value: Literal['ACTIVE', 'NAME', 'INDEX']) -> None:
        ...
    @property
    def mix_mode(self) -> Literal['REPLACE', 'ABOVE_THRESHOLD', 'BELOW_THRESHOLD', 'MIX', 'ADD', 'SUB', 'MUL']:
        ...
        ...
    @mix_mode.setter
    def mix_mode(self, value: Literal['REPLACE', 'ABOVE_THRESHOLD', 'BELOW_THRESHOLD', 'MIX', 'ADD', 'SUB', 'MUL']) -> None:
        ...
    @property
    def mix_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @mix_factor.setter
    def mix_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=3"]) -> None:
        ...
    @property
