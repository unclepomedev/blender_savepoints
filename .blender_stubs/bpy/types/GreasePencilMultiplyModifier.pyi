...
class GreasePencilMultiplyModifier(Modifier):
    ...
    duplicates: Annotated[int, "step=1"]
    ...
    offset: Annotated[float, "step=0.009999999776482582", "precision=3"]
    """Offset of duplicates, -1 to 1 (inner to outer)"""
    fading_thickness: Annotated[float, "step=10.0", "precision=3"]
    """Fade influence of stroke's thickness"""
    fading_opacity: Annotated[float, "step=10.0", "precision=3"]
    """Fade influence of stroke's opacity"""
    fading_center: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Fade center"""