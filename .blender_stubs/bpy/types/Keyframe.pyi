...
class Keyframe(bpy_struct):
    ...
    def handle_left_type(self, value: Literal['FREE', 'ALIGNED', 'VECTOR', 'AUTO', 'AUTO_CLAMPED']):
        ...
    @property
    ...
    def handle_right_type(self, value: Literal['FREE', 'ALIGNED', 'VECTOR', 'AUTO', 'AUTO_CLAMPED']):
        ...
    @property
    ...
    def interpolation(self, value: Literal['CONSTANT', 'LINEAR', 'BEZIER', 'SINE', 'QUAD', 'CUBIC', 'QUART', 'QUINT', 'EXPO', 'CIRC', 'BACK', 'BOUNCE', 'ELASTIC']):
        ...
    @property
    def type(self) -> Literal['KEYFRAME', 'BREAKDOWN', 'MOVING_HOLD', 'EXTREME', 'JITTER', 'GENERATED']:
        ...
        ...
    @type.setter
    def type(self, value: Literal['KEYFRAME', 'BREAKDOWN', 'MOVING_HOLD', 'EXTREME', 'JITTER', 'GENERATED']):
        ...
    @property
    def easing(self) -> Literal['AUTO', 'EASE_IN', 'EASE_OUT', 'EASE_IN_OUT']:
        ...
        ...
    @easing.setter
    def easing(self, value: Literal['AUTO', 'EASE_IN', 'EASE_OUT', 'EASE_IN_OUT']):
        ...
    @property
    def back(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @back.setter
    def back(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def handle_left(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        ...
        ...
    @handle_left.setter
    def handle_left(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def co_ui(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        ...
        ...
    @co_ui.setter
    def co_ui(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]):
        ...
    @property
    def handle_right(self) -> Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]:
        ...
        ...
    @handle_right.setter
    def handle_right(self, value: Annotated[list[float], "subtype='COORDINATES'", "step=10.0", "precision=3"]):
        ...