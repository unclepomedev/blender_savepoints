...
class ExplodeModifier(Modifier):
    ...
    def protect(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @protect.setter
    def protect(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def use_edge_cut(self) -> bool:
        ...
        ...
    @use_edge_cut.setter
    def use_edge_cut(self, value: bool):
        ...
    @property
    ...
    def particle_uv(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @particle_uv.setter
    def particle_uv(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
