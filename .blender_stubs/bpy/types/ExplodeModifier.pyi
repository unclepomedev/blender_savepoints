...
class ExplodeModifier(Modifier):
    ...
    def vertex_group(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def protect(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Clean vertex group edges"""
        ...
    @protect.setter
    def protect(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def use_edge_cut(self) -> bool:
        """Cut face edges for nicer shrapnel"""
        ...
    @use_edge_cut.setter
    def use_edge_cut(self, value: bool) -> None:
        ...
    @property
    ...
    def use_size(self, value: bool) -> None:
        ...
    @property
    def particle_uv(self) -> Annotated[str, "is_animatable=False"]:
        """UV map to change with particle age"""
        ...
    @particle_uv.setter
    def particle_uv(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
