...
class ParticleTarget(bpy_struct):
    ...
    def system(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1"]:
        ...
        ...
    @system.setter
    def system(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]) -> None:
        ...
    @property
    def time(self) -> Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]:
        ...
        ...
    @time.setter
    def time(self, value: Annotated[float, "subtype='TIME'", "unit='TIME'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def duration(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @duration.setter
    def duration(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def alliance(self) -> Annotated[Literal['FRIEND', 'NEUTRAL', 'ENEMY'], "is_animatable=False"]:
        ...
        ...
    @alliance.setter
    def alliance(self, value: Annotated[Literal['FRIEND', 'NEUTRAL', 'ENEMY'], "is_animatable=False"]) -> None:
        ...