...
https://docs.blender.org/api/current/bpy.types.GreasePencilMirrorModifier.html
"""
...
class GreasePencilMirrorModifier(Modifier):
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_axis_x(self) -> bool:
        """Mirror the X axis"""
        ...
    @use_axis_x.setter
    def use_axis_x(self, value: bool) -> None:
        ...
    @property
    def use_axis_y(self) -> bool:
        """Mirror the Y axis"""
        ...
    @use_axis_y.setter
    def use_axis_y(self, value: bool) -> None:
        ...
    @property
    def use_axis_z(self) -> bool:
        """Mirror the Z axis"""
        ...
    @use_axis_z.setter
    def use_axis_z(self, value: bool) -> None:
        ...