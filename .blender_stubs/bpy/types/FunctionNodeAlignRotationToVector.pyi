...
class FunctionNodeAlignRotationToVector(FunctionNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def axis(self) -> Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]:
        """Axis to align to the vector"""
        ...
    @axis.setter
    def axis(self, value: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]) -> None:
        ...
    @property
    def pivot_axis(self) -> Annotated[Literal['AUTO', 'X', 'Y', 'Z'], "is_animatable=False"]:
        """Axis to rotate around"""
        ...
    @pivot_axis.setter
    def pivot_axis(self, value: Annotated[Literal['AUTO', 'X', 'Y', 'Z'], "is_animatable=False"]) -> None:
        ...
