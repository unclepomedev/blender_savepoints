...
https://docs.blender.org/api/current/bpy.types.FunctionNodeAlignRotationToVector.html
"""
...
class FunctionNodeAlignRotationToVector(FunctionNode):
    ...
    axis: Annotated[Literal['X', 'Y', 'Z'], "is_animatable=False"]
    """Axis to align to the vector"""
    pivot_axis: Annotated[Literal['AUTO', 'X', 'Y', 'Z'], "is_animatable=False"]
