...
class CameraStereoData(bpy_struct):
    ...
    def convergence_mode(self, value: Literal['OFFAXIS', 'PARALLEL', 'TOE']):
        ...
    @property
    def pivot(self) -> Literal['LEFT', 'RIGHT', 'CENTER']:
        ...
        ...
    @pivot.setter
    def pivot(self, value: Literal['LEFT', 'RIGHT', 'CENTER']):
        ...
    @property
    ...
    def interocular_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def convergence_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=3"]):
        ...
    @property
    ...
    def use_spherical_stereo(self, value: bool):
        ...
    @property
    ...
    def use_pole_merge(self, value: bool):
        ...
    @property
    ...
    def pole_merge_angle_from(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def pole_merge_angle_to(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...