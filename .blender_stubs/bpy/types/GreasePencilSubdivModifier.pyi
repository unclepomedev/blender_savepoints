...
https://docs.blender.org/api/current/bpy.types.GreasePencilSubdivModifier.html
"""
...
class GreasePencilSubdivModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool):
        ...
    @property
    def level(self) -> Annotated[int, "step=1"]:
        """Level of subdivision"""
        ...
    @level.setter
    def level(self, value: Annotated[int, "step=1"]):
        ...
    @property
