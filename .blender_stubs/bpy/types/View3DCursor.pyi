...
class View3DCursor(bpy_struct):
    ...
    def location(self) -> Annotated[list[float], "subtype='XYZ_LENGTH'", "unit='LENGTH'", "step=10.0", "precision=4", "is_animatable=False"]:
        ...
        ...
    @location.setter
    def location(self, value: Annotated[list[float], "subtype='XYZ_LENGTH'", "unit='LENGTH'", "step=10.0", "precision=4", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def rotation_quaternion(self, value: Annotated[list[float], "subtype='QUATERNION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def rotation_axis_angle(self, value: Annotated[list[float], "subtype='AXISANGLE'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def rotation_euler(self, value: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=100.0", "precision=5", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def rotation_mode(self, value: Annotated[Literal['QUATERNION', 'XYZ', 'XZY', 'YXZ', 'YZX', 'ZXY', 'ZYX', 'AXIS_ANGLE'], "is_animatable=False"]) -> None:
        ...
    @property
    def matrix(self) -> Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @matrix.setter
    def matrix(self, value: Annotated[list[float], "subtype='MATRIX'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...