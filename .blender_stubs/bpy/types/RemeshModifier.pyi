...
class RemeshModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    mode: Literal['BLOCKS', 'SMOOTH', 'SHARP', 'VOXEL']

    scale: Annotated[float, "step=0.009999999776482582", "precision=3"]
    """The ratio of the largest dimension of the model over the size of the grid"""
    threshold: Annotated[float, "step=0.10000000149011612", "precision=3"]
    ...
    octree_depth: Annotated[int, "step=1"]
    """Resolution of the octree; higher values give finer details"""
    sharpness: Annotated[float, "step=0.10000000149011612", "precision=3"]
    """Tolerance for outliers; lower values filter noise while higher values will reproduce edges closer to the input"""
    voxel_size: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]
    """Size of the voxel in object space used for volume evaluation. Lower values preserve finer details."""
    adaptivity: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]
