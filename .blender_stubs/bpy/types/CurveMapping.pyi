...
class CurveMapping(bpy_struct):
    ...
    def tone(self) -> Literal['STANDARD', 'FILMLIKE']:
        ...
        ...
    @tone.setter
    def tone(self, value: Literal['STANDARD', 'FILMLIKE']):
        ...
    @property
    ...
    def clip_min_x(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @clip_min_x.setter
    def clip_min_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def clip_min_y(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @clip_min_y.setter
    def clip_min_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def clip_max_x(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @clip_max_x.setter
    def clip_max_x(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def clip_max_y(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @clip_max_y.setter
    def clip_max_y(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def extend(self) -> Literal['HORIZONTAL', 'EXTRAPOLATED']:
        ...
        ...
    @extend.setter
    def extend(self, value: Literal['HORIZONTAL', 'EXTRAPOLATED']):
        ...
    @property
    ...
    def black_level(self) -> Annotated[list[float], "subtype='COLOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @black_level.setter
    def black_level(self, value: Annotated[list[float], "subtype='COLOR'", "step=1.0", "precision=3"]):
        ...
    @property
    def white_level(self) -> Annotated[list[float], "subtype='COLOR'", "step=1.0", "precision=3"]:
        ...
        ...
    @white_level.setter
    def white_level(self, value: Annotated[list[float], "subtype='COLOR'", "step=1.0", "precision=3"]):
        ...
