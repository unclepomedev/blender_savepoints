...
class CameraDOFSettings(bpy_struct):
    ...
    def focus_object(self) -> Annotated[Optional['Object'], "is_animatable=False"]:
        ...
        ...
    @focus_object.setter
    def focus_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    ...
    def focus_subtarget(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def focus_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=4"]):
        ...
    @property
    ...
    def aperture_fstop(self, value: Annotated[float, "step=10.0", "precision=1"]):
        ...
    @property
    ...
    def aperture_blades(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def aperture_rotation(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def aperture_ratio(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...