...
class Mask(ID):
    ...
    def preview(self) -> Annotated[Optional['ImagePreview'], "is_animatable=False"]:
        ...
        ...
    @property
    def layers(self) -> Annotated['MaskLayers', "is_animatable=False"]:
        """Collection of layers which defines this mask"""
        ...
    @property
    def active_layer_index(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        """Index of active layer in list of all mask's layers"""
        ...
    @active_layer_index.setter
    def active_layer_index(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
