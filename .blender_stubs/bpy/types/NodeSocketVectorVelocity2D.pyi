...
https://docs.blender.org/api/current/bpy.types.NodeSocketVectorVelocity2D.html
"""
...
class NodeSocketVectorVelocity2D(NodeSocketStandard):
    ...
    def bl_subtype_label(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    def default_value(self) -> Annotated[list[float], "subtype='VELOCITY'", "unit='VELOCITY'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[list[float], "subtype='VELOCITY'", "unit='VELOCITY'", "step=10.0", "precision=3"]) -> None:
        ...
