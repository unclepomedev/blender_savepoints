...
class GreasePencilLengthModifier(Modifier):
    ...
    def open_random_panel(self, value: bool):
        ...
    @property
    ...
    def open_curvature_panel(self, value: bool):
        ...
    @property
    ...
    def start_factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @start_factor.setter
    def start_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def end_factor(self) -> Annotated[float, "step=0.10000000149011612", "precision=2"]:
        ...
        ...
    @end_factor.setter
    def end_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def start_length(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @start_length.setter
    def start_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    def end_length(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]:
        ...
        ...
    @end_length.setter
    def end_length(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def random_start_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=1"]):
        ...
    @property
    ...
    def random_end_factor(self, value: Annotated[float, "step=0.10000000149011612", "precision=1"]):
        ...
    @property
    ...
    def random_offset(self, value: Annotated[float, "step=0.10000000149011612", "precision=3"]):
        ...
    @property
    ...
    def overshoot_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def mode(self) -> Literal['RELATIVE', 'ABSOLUTE']:
        ...
        ...
    @mode.setter
    def mode(self, value: Literal['RELATIVE', 'ABSOLUTE']):
        ...
    @property
    ...
    def use_curvature(self, value: bool):
        ...
    @property
    ...
    def invert_curvature(self, value: bool):
        ...
    @property
    ...
    def point_density(self, value: Annotated[float, "step=1.0", "precision=1"]):
        ...
    @property
    ...
    def segment_influence(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=2"]):
        ...
    @property
    def max_angle(self) -> Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]:
        ...
        ...
    @max_angle.setter
    def max_angle(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=1"]):
        ...