...
class FModifierFunctionGenerator(FModifier):
    ...
    def phase_multiplier(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def phase_offset(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @phase_offset.setter
    def phase_offset(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def value_offset(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @value_offset.setter
    def value_offset(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def function_type(self, value: Literal['SIN', 'COS', 'TAN', 'SQRT', 'LN', 'SINC']) -> None:
        ...