...
class FunctionNodeCompare(FunctionNode):
    ...
    def operation(self) -> Annotated[Literal['LESS_THAN', 'LESS_EQUAL', 'GREATER_THAN', 'GREATER_EQUAL', 'EQUAL', 'NOT_EQUAL', 'BRIGHTER', 'DARKER'], "is_animatable=False"]:
        ...
        ...
    @operation.setter
    def operation(self, value: Annotated[Literal['LESS_THAN', 'LESS_EQUAL', 'GREATER_THAN', 'GREATER_EQUAL', 'EQUAL', 'NOT_EQUAL', 'BRIGHTER', 'DARKER'], "is_animatable=False"]):
        ...
    @property
    ...
    def mode(self) -> Annotated[Literal['ELEMENT', 'LENGTH', 'AVERAGE', 'DOT_PRODUCT', 'DIRECTION'], "is_animatable=False"]:
        ...
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['ELEMENT', 'LENGTH', 'AVERAGE', 'DOT_PRODUCT', 'DIRECTION'], "is_animatable=False"]):
        ...
