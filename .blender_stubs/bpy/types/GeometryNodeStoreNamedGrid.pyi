...
https://docs.blender.org/api/current/bpy.types.GeometryNodeStoreNamedGrid.html
"""
...
class GeometryNodeStoreNamedGrid(GeometryNode):
    ...
    data_type: Annotated[Literal['BOOLEAN', 'FLOAT', 'DOUBLE', 'INT', 'INT64', 'MASK', 'VECTOR_FLOAT', 'VECTOR_DOUBLE', 'VECTOR_INT', 'POINTS', 'UNKNOWN'], "is_animatable=False"]
    """Type of grid data"""
