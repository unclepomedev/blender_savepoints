...
https://docs.blender.org/api/current/bpy.types.GeometryNodeSampleCurve.html
"""
...
class GeometryNodeSampleCurve(GeometryNode):
    ...
    mode: Annotated[Literal['FACTOR', 'LENGTH'], "is_animatable=False"]
    """Method for sampling input"""
    use_all_curves: Annotated[bool, "is_animatable=False"]
