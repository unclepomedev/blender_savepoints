...
class GeometryNodeSampleCurve(GeometryNode):
    ...
    def bl_height_max(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def mode(self) -> Annotated[Literal['FACTOR', 'LENGTH'], "is_animatable=False"]:
        """Method for sampling input"""
        ...
    @mode.setter
    def mode(self, value: Annotated[Literal['FACTOR', 'LENGTH'], "is_animatable=False"]) -> None:
        ...
    @property
    def use_all_curves(self) -> Annotated[bool, "is_animatable=False"]:
    ...
    def use_all_curves(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
