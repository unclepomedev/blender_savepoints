...
class SunLight(Light):
    ...
    def energy(self) -> Annotated[float, "step=1.0", "precision=3"]:
        ...
        ...
    @energy.setter
    def energy(self, value: Annotated[float, "step=1.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shadow_cascade_max_distance(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shadow_cascade_count(self, value: Annotated[int, "step=1"]) -> None:
        ...
    @property
    ...
    def shadow_cascade_exponent(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def shadow_cascade_fade(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
