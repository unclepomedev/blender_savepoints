...
class FunctionNodeInputColor(FunctionNode):
    ...
    @property
    def value(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:

        ...
    @value.setter
    def value(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]) -> None:
        ...
