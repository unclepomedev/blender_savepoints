...
class DynamicPaintModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def canvas_settings(self) -> Annotated[Optional['DynamicPaintCanvasSettings'], "is_animatable=False"]:

        ...
    @property
    def brush_settings(self) -> Annotated[Optional['DynamicPaintBrushSettings'], "is_animatable=False"]:

        ...
    @property
    def ui_type(self) -> Annotated[Literal['CANVAS', 'BRUSH'], "is_animatable=False"]:

        ...
    @ui_type.setter
    def ui_type(self, value: Annotated[Literal['CANVAS', 'BRUSH'], "is_animatable=False"]) -> None:
        ...