...
class WireframeModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def thickness(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]:
        """Thickness factor"""
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]):
        ...
    @property
    ...
    def offset(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=4"]):
        ...
    @property
    def use_replace(self) -> bool:
        """Remove original geometry"""
        ...
    @use_replace.setter
    def use_replace(self, value: bool):
        ...
    @property
    def use_boundary(self) -> bool:
        ...
        ...
    @use_boundary.setter
    def use_boundary(self, value: bool):
        ...
    @property
    ...
    def use_crease(self, value: bool):
        ...
    @property
    def crease_weight(self) -> Annotated[float, "step=0.10000000149011612", "precision=1"]:
        """Crease weight (if active)"""
        ...
    @crease_weight.setter
    def crease_weight(self, value: Annotated[float, "step=0.10000000149011612", "precision=1"]):
        ...
    @property
