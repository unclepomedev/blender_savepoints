...
class WireframeModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    thickness: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]
    """Thickness factor"""
    ...
    crease_weight: Annotated[float, "step=0.10000000149011612", "precision=1"]
