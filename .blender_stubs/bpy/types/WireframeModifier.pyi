...
class WireframeModifier(Modifier):
    ...
    def thickness(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]:
        ...
        ...
    @thickness.setter
    def thickness(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=0.009999999776482582", "precision=4"]) -> None:
        ...
    @property
    ...
    def use_replace(self) -> bool:
        ...
        ...
    @use_replace.setter
    def use_replace(self, value: bool) -> None:
        ...
    @property
    def use_boundary(self) -> bool:
        ...
        ...
    @use_boundary.setter
    def use_boundary(self, value: bool) -> None:
        ...
    @property
    ...
    def crease_weight(self, value: Annotated[float, "step=0.10000000149011612", "precision=1"]) -> None:
        ...
    @property
