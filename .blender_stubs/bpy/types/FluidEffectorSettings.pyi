...
class FluidEffectorSettings(bpy_struct):
    ...
    def effector_type(self, value: Literal['COLLISION', 'GUIDE']):
        ...
    @property
    ...
    def guide_mode(self) -> Literal['MAXIMUM', 'MINIMUM', 'OVERRIDE', 'AVERAGED']:
        ...
        ...
    @guide_mode.setter
    def guide_mode(self, value: Literal['MAXIMUM', 'MINIMUM', 'OVERRIDE', 'AVERAGED']):
        ...
    @property
    def use_effector(self) -> bool:
        ...
        ...
    @use_effector.setter
    def use_effector(self, value: bool):
        ...
    @property
