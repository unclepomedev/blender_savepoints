...
class GreasePencilLayer(GreasePencilTreeNode):
    ...
    def opacity(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @opacity.setter
    def opacity(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def tint_color(self) -> Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @tint_color.setter
    def tint_color(self, value: Annotated[list[float], "subtype='COLOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def tint_factor(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        ...
        ...
    @tint_factor.setter
    def tint_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def radius_offset(self, value: Annotated[float, "subtype='TRANSLATION'", "unit='LENGTH'", "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def rotation(self) -> Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=1.0", "precision=5"]:
        ...
        ...
    @rotation.setter
    def rotation(self, value: Annotated[list[float], "subtype='EULER'", "unit='ROTATION'", "step=1.0", "precision=5"]):
        ...
    @property
    ...
    def viewlayer_render(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def use_viewlayer_masks(self, value: bool):
        ...
    @property
    def blend_mode(self) -> Literal['REGULAR', 'HARDLIGHT', 'ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE']:
        ...
        ...
    @blend_mode.setter
    def blend_mode(self, value: Literal['REGULAR', 'HARDLIGHT', 'ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE']):
        ...
    @property
    ...
    def ignore_locked_materials(self, value: Annotated[bool, "is_animatable=False"]):
        ...
    @property
