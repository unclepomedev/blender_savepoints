...
class NodeEvaluateClosure(NodeInternal):
    ...
    def active_input_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def active_output_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]):
        ...
    @property
    ...
    def define_signature(self, value: Annotated[bool, "is_animatable=False"]):
        ...
