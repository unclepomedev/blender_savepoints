...
https://docs.blender.org/api/current/bpy.types.NodeEvaluateClosure.html
"""
...
class NodeEvaluateClosure(NodeInternal):
    ...
    @property
    def input_items(self) -> Annotated['NodeEvaluateClosureInputItems', "is_animatable=False"]:

        ...
    @property
    def output_items(self) -> Annotated['NodeEvaluateClosureOutputItems', "is_animatable=False"]:
    ...
    def active_input_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def active_output_index(self) -> Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]:
        """Index of the active item"""
        ...
    @active_output_index.setter
    def active_output_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def define_signature(self) -> Annotated[bool, "is_animatable=False"]:
        """This node defines a closure signature that should be used by other nodes"""
        ...
    @define_signature.setter
    def define_signature(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
