...
class ParticleHairKey(bpy_struct):
    ...
    def weight(self) -> Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]:
        ...
        ...
    @weight.setter
    def weight(self, value: Annotated[float, "subtype='UNSIGNED'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def co_local(self) -> Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @co_local.setter
    def co_local(self, value: Annotated[list[float], "subtype='TRANSLATION'", "unit='LENGTH'", "step=10.0", "precision=3"]) -> None:
        ...
