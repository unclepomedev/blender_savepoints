...
class VertexPaint(Paint):
    ...
    def unified_paint_settings(self) -> Annotated['UnifiedPaintSettings', "is_animatable=False"]:
        ...
        ...
    @property
    def use_group_restrict(self) -> Annotated[bool, "is_animatable=False"]:
        """Restrict painting to vertices in the group"""
        ...
    @use_group_restrict.setter
    def use_group_restrict(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...