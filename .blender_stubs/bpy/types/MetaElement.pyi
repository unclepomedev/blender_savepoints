...
class MetaElement(bpy_struct):
    ...
    def type(self) -> Literal['BALL', 'CAPSULE', 'PLANE', 'ELLIPSOID', 'CUBE']:
        ...
        ...
    @type.setter
    def type(self, value: Literal['BALL', 'CAPSULE', 'PLANE', 'ELLIPSOID', 'CUBE']):
        ...
    @property
    ...
    def radius(self) -> Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @radius.setter
    def radius(self, value: Annotated[float, "subtype=''", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    def size_x(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @size_x.setter
    def size_x(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    def size_y(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @size_y.setter
    def size_y(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    def size_z(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]:
        ...
        ...
    @size_z.setter
    def size_z(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=3"]):
        ...
    @property
    def stiffness(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @stiffness.setter
    def stiffness(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    def use_negative(self) -> bool:
        ...
        ...
    @use_negative.setter
    def use_negative(self, value: bool):
        ...
    @property
    ...
    def use_scale_stiffness(self, value: bool):
        ...
    @property
