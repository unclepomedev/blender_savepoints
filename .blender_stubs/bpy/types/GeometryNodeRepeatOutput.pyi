...
https://docs.blender.org/api/current/bpy.types.GeometryNodeRepeatOutput.html
"""
...
class GeometryNodeRepeatOutput(GeometryNode):
    ...
    @property
    def repeat_items(self) -> Annotated['NodeGeometryRepeatOutputItems', "is_animatable=False"]:
    ...
    """Index of the active item"""
    inspection_index: Annotated[int, "step=1"]
