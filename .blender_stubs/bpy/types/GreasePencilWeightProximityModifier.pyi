...
class GreasePencilWeightProximityModifier(Modifier):
    ...
    def use_multiply(self) -> bool:
        ...
        ...
    @use_multiply.setter
    def use_multiply(self, value: bool) -> None:
        ...
    @property
    ...
    def use_invert_output(self, value: bool) -> None:
        ...
    @property
    ...
    def distance_start(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]) -> None:
        ...
    @property
    ...
    def minimum_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    def distance_end(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]:
        ...
        ...
    @distance_end.setter
    def distance_end(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]) -> None:
        ...