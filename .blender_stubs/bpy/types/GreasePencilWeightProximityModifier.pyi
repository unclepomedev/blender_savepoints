...
https://docs.blender.org/api/current/bpy.types.GreasePencilWeightProximityModifier.html
"""
...
class GreasePencilWeightProximityModifier(Modifier):
    ...
    def open_influence_panel(self, value: bool):
        ...
    @property
    def use_multiply(self) -> bool:
        """Multiply the calculated weights with the existing values in the vertex group"""
        ...
    @use_multiply.setter
    def use_multiply(self, value: bool):
        ...
    @property
    def use_invert_output(self) -> bool:
        """Invert output weight values"""
        ...
    @use_invert_output.setter
    def use_invert_output(self, value: bool):
        ...
    @property
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]):
        ...
    @property
    def distance_start(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]:
        """Distance mapping to 0.0 weight"""
        ...
    @distance_start.setter
    def distance_start(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]):
        ...
    @property
    def minimum_weight(self) -> Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]:
        """Minimum value for vertex weight"""
        ...
    @minimum_weight.setter
    def minimum_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]):
        ...
    @property
    def distance_end(self) -> Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]:
        """Distance mapping to 1.0 weight"""
        ...
    @distance_end.setter
    def distance_end(self, value: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]):
        ...