...
class GreasePencilWeightProximityModifier(Modifier):
    ...
    distance_start: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]
    """Distance mapping to 0.0 weight"""
    minimum_weight: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
    """Minimum value for vertex weight"""
    distance_end: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=1.0", "precision=2"]
