...
https://docs.blender.org/api/current/bpy.types.NodeGeometryViewerItem.html
"""
...
class NodeGeometryViewerItem(bpy_struct):
    ...
    def color(self) -> Annotated[list[float], "subtype='COLOR_GAMMA'", "step=10.0", "precision=3"]:
        ...
        ...
    @property
    def auto_remove(self) -> Annotated[bool, "is_animatable=False"]:
        """Remove the item automatically when it is unlinked"""
        ...
    @auto_remove.setter
    def auto_remove(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...