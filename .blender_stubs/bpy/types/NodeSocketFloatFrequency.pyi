...
https://docs.blender.org/api/current/bpy.types.NodeSocketFloatFrequency.html
"""
...
class NodeSocketFloatFrequency(NodeSocketStandard):
    ...
    @property
    def default_value(self) -> Annotated[float, "subtype='FREQUENCY'", "unit='FREQUENCY'", "step=10.0", "precision=3"]:
        """Input value used for unconnected socket"""
        ...
    @default_value.setter
    def default_value(self, value: Annotated[float, "subtype='FREQUENCY'", "unit='FREQUENCY'", "step=10.0", "precision=3"]) -> None:
        ...
