...
class MaterialLineArt(bpy_struct):
    ...
    def mat_occlusion(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def intersection_priority(self, value: Annotated[int, "step=1"]):
        ...
    @property
    ...
    def use_intersection_priority_override(self, value: bool):
        ...