...
https://docs.blender.org/api/current/bpy.types.VolumeToMeshModifier.html
"""
...
class VolumeToMeshModifier(Modifier):
    ...
    def object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...
    @property
    def threshold(self) -> Annotated[float, "step=0.10000000149011612", "precision=5"]:
        """Voxels with a larger value are inside the generated mesh"""
        ...
    @threshold.setter
    def threshold(self, value: Annotated[float, "step=0.10000000149011612", "precision=5"]) -> None:
        ...
    @property
    def adaptivity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        """Reduces the final face count by simplifying geometry where detail is not needed"""
        ...
    @adaptivity.setter
    def adaptivity(self, value: Annotated[float, "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def use_smooth_shade(self, value: bool) -> None:
        ...
    @property
    def grid_name(self) -> Annotated[str, "is_animatable=False"]:
        """Grid in the volume object that is converted to a mesh"""
        ...
    @grid_name.setter
    def grid_name(self, value: Annotated[str, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def resolution_mode(self, value: Literal['GRID', 'VOXEL_AMOUNT', 'VOXEL_SIZE']) -> None:
        ...
    @property
    def voxel_size(self) -> Annotated[float, "step=0.009999999776482582", "precision=4"]:
        """Smaller values result in a higher resolution output"""
        ...
    @voxel_size.setter
    def voxel_size(self, value: Annotated[float, "step=0.009999999776482582", "precision=4"]) -> None:
        ...
    @property
    def voxel_amount(self) -> Annotated[int, "step=1"]:
        """Approximate number of voxels along one axis"""
        ...
    @voxel_amount.setter
    def voxel_amount(self, value: Annotated[int, "step=1"]) -> None:
        ...