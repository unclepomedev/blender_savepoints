...
class VolumeToMeshModifier(Modifier):
    ...
    def threshold(self) -> Annotated[float, "step=0.10000000149011612", "precision=5"]:
        ...
        ...
    @threshold.setter
    def threshold(self, value: Annotated[float, "step=0.10000000149011612", "precision=5"]):
        ...
    @property
    def adaptivity(self) -> Annotated[float, "step=10.0", "precision=3"]:
        ...
        ...
    @adaptivity.setter
    def adaptivity(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def grid_name(self) -> Annotated[str, "is_animatable=False"]:
        ...
        ...
    @grid_name.setter
    def grid_name(self, value: Annotated[str, "is_animatable=False"]):
        ...
    @property
    ...
    def voxel_size(self) -> Annotated[float, "step=0.009999999776482582", "precision=4"]:
        ...
        ...
    @voxel_size.setter
    def voxel_size(self, value: Annotated[float, "step=0.009999999776482582", "precision=4"]):
        ...
    @property
    def voxel_amount(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @voxel_amount.setter
    def voxel_amount(self, value: Annotated[int, "step=1"]):
        ...