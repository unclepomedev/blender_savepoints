...
class VolumeToMeshModifier(Modifier):
    ...
    """Object"""
    threshold: Annotated[float, "step=0.10000000149011612", "precision=5"]
    """Voxels with a larger value are inside the generated mesh"""
    adaptivity: Annotated[float, "step=10.0", "precision=3"]
    """Reduces the final face count by simplifying geometry where detail is not needed"""
    use_smooth_shade: bool
    """Output faces with smooth shading rather than flat shaded"""
    grid_name: Annotated[str, "is_animatable=False"]
    """Grid in the volume object that is converted to a mesh"""
    resolution_mode: Literal['GRID', 'VOXEL_AMOUNT', 'VOXEL_SIZE']
    """Mode for how the desired voxel size is specified"""
    voxel_size: Annotated[float, "step=0.009999999776482582", "precision=4"]
    """Smaller values result in a higher resolution output"""
    voxel_amount: Annotated[int, "step=1"]
