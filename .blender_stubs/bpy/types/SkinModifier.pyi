...
class SkinModifier(Modifier):
    ...
    def branch_smoothing(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=-1"]):
        ...
    @property
    ...
    def use_x_symmetry(self, value: bool):
        ...
    @property
    ...
    def use_y_symmetry(self, value: bool):
        ...
    @property
    ...
    def use_z_symmetry(self, value: bool):
        ...