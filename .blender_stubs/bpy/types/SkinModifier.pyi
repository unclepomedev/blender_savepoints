...
class SkinModifier(Modifier):
    ...
    def persistent_uid(self) -> Annotated[int, "step=1"]:
        ...
        ...
    @property
    def branch_smoothing(self) -> Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=-1"]:
        """Smooth complex geometry around branches"""
        ...
    @branch_smoothing.setter
    def branch_smoothing(self, value: Annotated[float, "subtype='FACTOR'", "step=1.0", "precision=-1"]) -> None:
        ...
    @property
    ...
    def use_smooth_shade(self, value: bool) -> None:
        ...
    @property
    def use_x_symmetry(self) -> bool:
        """Avoid making unsymmetrical quads across the X axis"""
        ...
    @use_x_symmetry.setter
    def use_x_symmetry(self, value: bool) -> None:
        ...
    @property
    def use_y_symmetry(self) -> bool:
        """Avoid making unsymmetrical quads across the Y axis"""
        ...
    @use_y_symmetry.setter
    def use_y_symmetry(self, value: bool) -> None:
        ...
    @property
    def use_z_symmetry(self) -> bool:
        """Avoid making unsymmetrical quads across the Z axis"""
        ...
    @use_z_symmetry.setter
    def use_z_symmetry(self, value: bool) -> None:
        ...