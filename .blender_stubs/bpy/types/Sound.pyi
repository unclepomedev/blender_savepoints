...
class Sound(ID):
    ...
    @property
    def samplerate(self) -> Annotated[int, "step=1"]:
        """Sample rate of the audio in Hz"""
        ...
    @property
    def channels(self) -> Literal['INVALID', 'MONO', 'STEREO', 'STEREO_LFE', 'CHANNELS_4', 'CHANNELS_5', 'SURROUND_51', 'SURROUND_61', 'SURROUND_71']:
