...
class ShaderNodeTexSky(ShaderNode):
    ...
    def color_mapping(self) -> Annotated['ColorMapping', "is_animatable=False"]:
        ...
        ...
    sky_type: Literal['SINGLE_SCATTERING', 'MULTIPLE_SCATTERING', 'PREETHAM', 'HOSEK_WILKIE']
    """Which sky model should be used"""
    sun_disc: bool
    """Include the sun itself in the output"""
    sun_size: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]
    """Size of sun disc"""
    sun_intensity: Annotated[float, "step=10.0", "precision=3"]
    """Strength of Sun"""
    sun_elevation: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]
    """Sun angle from horizon"""
    sun_rotation: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3"]
    """Rotation of sun around zenith"""
    altitude: Annotated[float, "subtype='DISTANCE'", "unit='LENGTH'", "step=10.0", "precision=1"]
    """Height from sea level"""
    air_density: Annotated[float, "step=10.0", "precision=3"]
    """Density of air molecules.
0 means no air, 1 means urban city air"""
    aerosol_density: Annotated[float, "step=10.0", "precision=3"]
    """Density of dust, pollution and water droplets.
0 means no aerosols, 1 means urban city aerosols"""
    ozone_density: Annotated[float, "step=10.0", "precision=3"]
    """Density of ozone layer.
0 means no ozone, 1 means urban city ozone"""
    sun_direction: Annotated[list[float], "subtype='DIRECTION'", "step=10.0", "precision=3"]
    """Direction from where the sun is shining"""
    turbidity: Annotated[float, "step=10.0", "precision=3"]
    """Atmospheric turbidity"""
    ground_albedo: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]
