...
https://docs.blender.org/api/current/bpy.types.GreasePencilDashModifierData.html
"""
...
class GreasePencilDashModifierData(Modifier):
    ...
    def open_influence_panel(self, value: bool) -> None:
        ...
    @property
    def segments(self) -> Annotated[bpy_prop_collection['GreasePencilDashModifierSegment'], "is_animatable=False"]:
    ...
    def segment_active_index(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def dash_offset(self) -> Annotated[int, "step=1"]:
        """Offset into each stroke before the beginning of the dashed segment generation"""
        ...
    @dash_offset.setter
    def dash_offset(self, value: Annotated[int, "step=1"]) -> None:
        ...