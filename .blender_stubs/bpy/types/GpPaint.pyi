...
class GpPaint(Paint):
    ...
    def unified_paint_settings(self) -> Annotated['UnifiedPaintSettings', "is_animatable=False"]:
        ...
        ...
    @property
    def color_mode(self) -> Annotated[Literal['MATERIAL', 'VERTEXCOLOR'], "is_animatable=False"]:
        """Paint Mode"""
        ...
    @color_mode.setter
    def color_mode(self, value: Annotated[Literal['MATERIAL', 'VERTEXCOLOR'], "is_animatable=False"]) -> None:
        ...