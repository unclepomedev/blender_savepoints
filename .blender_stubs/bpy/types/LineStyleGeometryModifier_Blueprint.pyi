...
class LineStyleGeometryModifier_Blueprint(LineStyleGeometryModifier):
    ...
    def shape(self) -> Literal['CIRCLES', 'ELLIPSES', 'SQUARES']:
        ...
        ...
    @shape.setter
    def shape(self, value: Literal['CIRCLES', 'ELLIPSES', 'SQUARES']):
        ...
    @property
    ...
    def backbone_length(self, value: Annotated[float, "step=10.0", "precision=3"]):
        ...
    @property
    ...
    def random_radius(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def random_center(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...
    @property
    ...
    def random_backbone(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1"]):
        ...