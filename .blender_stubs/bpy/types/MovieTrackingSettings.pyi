...
class MovieTrackingSettings(bpy_struct):
    ...
    def speed(self) -> Annotated[Literal['FASTEST', 'DOUBLE', 'REALTIME', 'HALF', 'QUARTER'], "is_animatable=False"]:
        ...
        ...
    @speed.setter
    def speed(self, value: Annotated[Literal['FASTEST', 'DOUBLE', 'REALTIME', 'HALF', 'QUARTER'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_keyframe_selection(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def refine_intrinsics_focal_length(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def refine_intrinsics_principal_point(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def refine_intrinsics_radial_distortion(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def refine_intrinsics_tangential_distortion(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def distance(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @distance.setter
    def distance(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def clean_frames(self) -> Annotated[int, "step=1", "is_animatable=False"]:
        ...
        ...
    @clean_frames.setter
    def clean_frames(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    def clean_error(self) -> Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]:
        ...
        ...
    @clean_error.setter
    def clean_error(self, value: Annotated[float, "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    def clean_action(self) -> Annotated[Literal['SELECT', 'DELETE_TRACK', 'DELETE_SEGMENTS'], "is_animatable=False"]:
        ...
        ...
    @clean_action.setter
    def clean_action(self, value: Annotated[Literal['SELECT', 'DELETE_TRACK', 'DELETE_SEGMENTS'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_tripod_solver(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_frames_limit(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_pattern_match(self, value: Annotated[Literal['KEYFRAME', 'PREV_FRAME'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_margin(self, value: Annotated[int, "subtype='PIXEL'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_motion_model(self, value: Annotated[Literal['Perspective', 'Affine', 'LocRotScale', 'LocScale', 'LocRot', 'Loc'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_default_brute(self, value: bool) -> None:
        ...
    @property
    ...
    def use_default_mask(self, value: bool) -> None:
        ...
    @property
    ...
    def use_default_normalization(self, value: bool) -> None:
        ...
    @property
    ...
    def default_correlation_min(self, value: Annotated[float, "step=0.05000000074505806", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_pattern_size(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def default_search_size(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_default_red_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def use_default_green_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def use_default_blue_channel(self, value: bool) -> None:
        ...
    @property
    ...
    def default_weight(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3"]) -> None:
        ...
    @property
    ...
    def object_distance(self, value: Annotated[float, "step=1.0", "precision=3", "is_animatable=False"]) -> None:
        ...