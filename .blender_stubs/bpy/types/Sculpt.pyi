...
class Sculpt(Paint):
    ...
    def lock_x(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @lock_x.setter
    def lock_x(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def lock_y(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @lock_y.setter
    def lock_y(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def lock_z(self) -> Annotated[bool, "is_animatable=False"]:
        ...
        ...
    @lock_z.setter
    def lock_z(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_deform_only(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    def detail_size(self) -> Annotated[float, "subtype='PIXEL'", "step=0.10000000149011612", "precision=2", "is_animatable=False"]:
        ...
        ...
    @detail_size.setter
    def detail_size(self, value: Annotated[float, "subtype='PIXEL'", "step=0.10000000149011612", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def detail_percent(self, value: Annotated[float, "subtype='PERCENTAGE'", "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def constant_detail_resolution(self, value: Annotated[float, "step=10.0", "precision=2", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_topology(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_face_sets(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_boundary_edges(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_boundary_face_sets(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_cavity(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_cavity_inverted(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_custom_cavity_curve(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_boundary_edges_propagation_steps(self, value: Annotated[int, "subtype='UNSIGNED'", "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_cavity_factor(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_cavity_blur_steps(self, value: Annotated[int, "step=1", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_start_normal(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_view_normal(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def use_automasking_view_occlusion(self, value: Annotated[bool, "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_start_normal_limit(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_start_normal_falloff(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_view_normal_limit(self, value: Annotated[float, "subtype='ANGLE'", "unit='ROTATION'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def automasking_view_normal_falloff(self, value: Annotated[float, "subtype='FACTOR'", "step=10.0", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def symmetrize_direction(self, value: Annotated[Literal['NEGATIVE_X', 'POSITIVE_X', 'NEGATIVE_Y', 'POSITIVE_Y', 'NEGATIVE_Z', 'POSITIVE_Z'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def detail_refine_method(self, value: Annotated[Literal['SUBDIVIDE', 'COLLAPSE', 'SUBDIVIDE_COLLAPSE'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def detail_type_method(self, value: Annotated[Literal['RELATIVE', 'CONSTANT', 'BRUSH', 'MANUAL'], "is_animatable=False"]) -> None:
        ...
    @property
    def gravity(self) -> Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3", "is_animatable=False"]:
        ...
        ...
    @gravity.setter
    def gravity(self, value: Annotated[float, "subtype='FACTOR'", "step=0.10000000149011612", "precision=3", "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def transform_mode(self, value: Annotated[Literal['ALL_VERTICES', 'RADIUS_ELASTIC'], "is_animatable=False"]) -> None:
        ...
    @property
    ...
    def gravity_object(self, value: Annotated[Optional['Object'], "is_animatable=False"]) -> None:
        ...